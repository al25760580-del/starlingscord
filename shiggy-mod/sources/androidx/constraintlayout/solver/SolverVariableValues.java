...
public class SolverVariableValues implements ArrayRow.ArrayRowVariables {
    ...
    public String toString() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            SolverVariable variable = getVariable(i2);
            if (variable != null) {
                String str4 = str3 + variable + " = " + getVariableValue(i2) + ServerSentEventKt.SPACE;
                int iIndexOf = indexOf(variable);
                String str5 = str4 + "[p: ";
                if (this.previous[iIndexOf] != -1) {
                    str = str5 + this.mCache.mIndexedVariables[this.variables[this.previous[iIndexOf]]];
                } else {
                    str = str5 + "none";
                }
                String str6 = str + ", n: ";
                if (this.next[iIndexOf] != -1) {
                    str2 = str6 + this.mCache.mIndexedVariables[this.variables[this.next[iIndexOf]]];
                } else {
                    str2 = str6 + "none";
                }
                str3 = str2 + "]";
    ...
    private void displayHash() {
        for (int i = 0; i < this.HASH_SIZE; i++) {
            if (this.keys[i] != -1) {
                ...
                boolean z = false;
                while (!z) {
                    str = str + ServerSentEventKt.SPACE + this.variables[i2];
