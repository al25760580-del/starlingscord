...
public class DependencyNode implements Dependency {
    ...
    public String toString() {
        return this.run.widget.getDebugName() + ServerSentEventKt.COLON + this.type + "(" + (this.resolved ? Integer.valueOf(this.value) : "unresolved") + ") <t=" + this.targets.size() + ":d=" + this.dependencies.size() + ">";
    }
    ...
    public String name() {
        ...
        return str + ServerSentEventKt.COLON + this.type.name();
    }
