...
public class ConstraintWidget {
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + ServerSentEventKt.SPACE : "") + (this.mDebugName != null ? "id: " + this.mDebugName + ServerSentEventKt.SPACE : "") + "(" + this.mX + ", " + this.mY + ") - (" + this.mWidth + " x " + this.mHeight + ")";
    }
