...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f13 = (f4 - f5) * f2;
        float f14 = f13 / 2.0f;
        this.x = (int) ((f8 + (f11 * f10)) - f14);
        float f15 = (f6 - f7) * f3;
        float f16 = f15 / 2.0f;
        this.y = (int) ((f9 + (f12 * f10)) - f16);
        ...
        this.y = (int) (((motionPaths.y + (f11 * f18)) + (f12 * f10)) - f16);
    ...
    void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        if (Float.isNaN(f14)) {
            ...
            view.setRotation((float) (((double) (Float.isNaN(Float.NaN) ? 0.0f : Float.NaN)) + ((double) f14) + Math.toDegrees(Math.atan2(f10 + (f11 / 2.0f), f8 + (f9 / 2.0f)))));
        }
        float f16 = f15 + 0.5f;
        int i5 = (int) f16;
        float f17 = f4 + 0.5f;
