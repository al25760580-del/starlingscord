...
public class MotionController {
    ...
    void buildPath(float[] fArr, int i) {
        ...
        while (i3 < i) {
            ...
            if (easing != null) {
                ...
                float f8 = f7 - f5;
                d = (((float) easing.get((f3 - f5) / f8)) * f8) + f5;
            }
    ...
    void buildBounds(float[] fArr, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            ...
            if (easing != null) {
                ...
                float f7 = f6 - f4;
                d = (((float) easing.get((f2 - f4) / f7)) * f7) + f4;
            }
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        double[][] dArr3 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, i4, this.mInterpolateVariables.length);
        double[] dArr4 = new double[i4];
        for (int i13 = 0; i13 < i4; i13++) {
            motionPathsArr[i13].fillStandard(dArr3[i13], this.mInterpolateVariables);
            dArr4[i13] = motionPathsArr[i13].time;
        }
        int i14 = 0;
        while (true) {
        ...
        while (true) {
            ...
            while (i17 < i4) {
                if (motionPathsArr[i17].hasCustomData(str10)) {
                    if (dArr6 == null) {
                        int[] iArr4 = new int[2];
                        iArr4[c] = motionPathsArr[i17].getCustomDataCount(str10);
                        iArr4[0] = i4;
                        dArr2 = new double[i4];
                        dArr6 = (double[][]) Array.newInstance((Class<?>) Double.TYPE, iArr4);
                    }
                    i3 = i17;
                    dArr2[i18] = motionPathsArr[i17].time;
                    motionPathsArr[i3].getCustomData(str10, dArr6[i18], 0);
                    i18++;
                } else {
                    dArr2 = dArr5;
                    dArr2 = dArr2;
            ...
            dArr2 = dArr5;
            i16++;
            this.mSpline[i16] = CurveFit.get(this.mCurveFitType, Arrays.copyOf(dArr2, i18), (double[][]) Arrays.copyOf(dArr6, i18));
            c = c;
        }
        char c2 = c;
        this.mSpline[0] = CurveFit.get(this.mCurveFitType, dArr4, dArr3);
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i19 = 0; i19 < i4; i19++) {
                ...
                dArr8[i19][c2] = motionPathsArr[i19].y;
            }
    ...
    boolean interpolate(View view, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            view2 = view;
            f2 = f4;
            float f5 = this.mStartMotionPath.x + ((this.mEndMotionPath.x - this.mStartMotionPath.x) * f2);
            float f6 = this.mStartMotionPath.y + ((this.mEndMotionPath.y - this.mStartMotionPath.y) * f2);
            float f7 = f5 + 0.5f;
            int i3 = (int) f7;
            float f8 = f6 + 0.5f;
            int i4 = (int) f8;
