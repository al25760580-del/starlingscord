...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setupMotionViews() {
        ...
        if (staggered != 0.0f) {
            ...
            while (i < childCount) {
                ...
                motionController6.mStaggerOffset = fAbs - (((f2 - fMin2) * fAbs) / (fMax2 - fMin2));
                i++;
            }
        }
    }
    ...
    public void touchAnimateTo(int i, float f, float f2) {
        ...
        if (i == 0 || i == 1 || i == 2) {
            ...
            float f4 = f3;
            this.mStopLogic.config(this.mTransitionLastPosition, f4, f2, duration, this.mScene.getMaxAcceleration(), this.mScene.getMaxVelocity());
            int i2 = this.mCurrentState;
