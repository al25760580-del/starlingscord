...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    private final void adjustStorage() {
        if (this._capacity > 8 && Long.compare(ULong.m630constructorimpl(ULong.m630constructorimpl(this._size) * 32) ^ Long.MIN_VALUE, ULong.m630constructorimpl(ULong.m630constructorimpl(this._capacity) * 25) ^ Long.MIN_VALUE) <= 0) {
