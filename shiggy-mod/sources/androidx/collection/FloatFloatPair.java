...
public final class FloatFloatPair {
    ...
    public static final /* synthetic */ FloatFloatPair m53boximpl(long j) {
    ...
    public static int m62hashCodeimpl(long j) {
    ...
    public int hashCode() {
        return m62hashCodeimpl(this.packedValue);
    }
    ...
    public static String m63toStringimpl(long j) {
        return "(" + Float.intBitsToFloat((int) (j >> 32)) + ", " + Float.intBitsToFloat((int) (j & 4294967295L)) + ')';
    }

    public String toString() {
        return m63toStringimpl(this.packedValue);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m56constructorimpl(float f, float f2) {
        return m57constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (Float.floatToRawIntBits(f) << 32));
    }

    /* JADX INFO: renamed from: getFirst-impl, reason: not valid java name */
    public static final float m60getFirstimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* JADX INFO: renamed from: getSecond-impl, reason: not valid java name */
    public static final float m61getSecondimpl(long j) {
