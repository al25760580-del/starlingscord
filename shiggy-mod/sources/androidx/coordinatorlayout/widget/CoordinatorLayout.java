...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i18 < size3) {
            View view2 = coordinatorLayout.mDependencySortedChildren.get(i18);
            ...
            if (view2.getVisibility() == 8) {
                ...
                if (layoutParams.keyline < 0 || mode == 0) {
                    ...
                    if ((absoluteGravity == 3 && !z) || (absoluteGravity == 5 && z)) {
                        ...
                        if ((absoluteGravity == 5 && !z) || (absoluteGravity == 3 && z)) {
                        ...
                        if (behavior != null) {
                            ...
                            zOnMeasureChild = behavior.onMeasureChild(this, view, i13, i5, i21, 0);
                            i7 = i5;
                            i6 = i21;
                            if (zOnMeasureChild) {
                                coordinatorLayout = this;
                            }
                            suggestedMinimumWidth = Math.max(i12, i16 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                            int iMax2 = Math.max(i9, i17 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                            iCombineMeasuredStates = View.combineMeasuredStates(i15, view.getMeasuredState());
                            suggestedMinimumHeight = iMax2;
                        } else {
                            int i22 = i5;
                            i6 = iMakeMeasureSpec2;
                            i7 = i22;
                            int i23 = i3;
                            i8 = layoutDirection;
                            i9 = i23;
                        ...
                        View view3 = view;
                        coordinatorLayout = this;
                        coordinatorLayout.onMeasureChild(view3, i24, i25, i6, 0);
                        view = view3;
                        suggestedMinimumWidth = Math.max(i12, i16 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                        int iMax3 = Math.max(i9, i17 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                        iCombineMeasuredStates = View.combineMeasuredStates(i15, view.getMeasuredState());
                    ...
                    if (behavior != null) {
                        ...
                        zOnMeasureChild = behavior.onMeasureChild(this, view, i13, i5, i28, 0);
                        i7 = i5;
                        i6 = i28;
                        if (zOnMeasureChild) {
                            coordinatorLayout = this;
                        ...
                        suggestedMinimumWidth = Math.max(i12, i16 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                        int iMax4 = Math.max(i9, i17 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                        iCombineMeasuredStates = View.combineMeasuredStates(i15, view.getMeasuredState());
                    ...
                    View view4 = view;
                    coordinatorLayout = this;
                    coordinatorLayout.onMeasureChild(view4, i211, i212, i6, 0);
                    view = view4;
                    suggestedMinimumWidth = Math.max(i12, i16 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                    int iMax5 = Math.max(i9, i17 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i15, view.getMeasuredState());
                ...
                if (behavior != null) {
                    ...
                    i14 = paddingRight;
                    i15 = iCombineMeasuredStates;
                    int i214 = iMakeMeasureSpec2;
                    zOnMeasureChild = behavior.onMeasureChild(this, view, i13, i5, i214, 0);
                    i7 = i5;
                    i6 = i214;
                    if (zOnMeasureChild) {
                        coordinatorLayout = this;
                    ...
                    suggestedMinimumWidth = Math.max(i12, i16 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                    int iMax6 = Math.max(i9, i17 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                    iCombineMeasuredStates = View.combineMeasuredStates(i15, view.getMeasuredState());
                ...
                View view5 = view;
                coordinatorLayout = this;
                coordinatorLayout.onMeasureChild(view5, i217, i218, i6, 0);
                view = view5;
                suggestedMinimumWidth = Math.max(i12, i16 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                int iMax7 = Math.max(i9, i17 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                iCombineMeasuredStates = View.combineMeasuredStates(i15, view.getMeasuredState());
