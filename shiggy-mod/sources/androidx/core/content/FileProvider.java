    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            ...
            try {
                ...
                return new Uri.Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode(entry.getKey()) + FileSystemKt.UnixPathSeparator + Uri.encode(strSubstring, "/")).build();
        ...
        private boolean belongsToRoot(String str, String str2) {
            return FileProvider.removeTrailingSlash(str).startsWith(FileProvider.removeTrailingSlash(str2) + FileSystemKt.UnixPathSeparator);
        }
    }
