...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) throws XmlPullParserException, IOException {
        ...
        if (string != null && string2 != null) {
            ...
            while (xmlPullParser.next() != 3) {
                if (xmlPullParser.getEventType() == 2) {
                    if (xmlPullParser.getName().equals("fallback")) {
                        arrayList.add(readFallback(xmlPullParser, resources, string, string2, certs));
                    } else {
                        skip(xmlPullParser);
                    }
                }
            ...
            if (string3 != null) {
                arrayList.add(new FontRequest(string, string2, string3, certs, null, null));
                if (string4 != null) {
                    arrayList.add(new FontRequest(string, string2, string4, certs, null, null));
                }
                return new ProviderResourceEntry(arrayList, integer, integer2, string5);
            }
    ...
    private static FontRequest readFallback(XmlPullParser xmlPullParser, Resources resources, String str, String str2, List<List<byte[]>> list) throws Exception {
        ...
        try {
            ...
            if (typedArrayObtainAttributes != null) {
                UByte$$ExternalSyntheticBackport0.m524m((Object) typedArrayObtainAttributes);
            }
            return fontRequest;
        } catch (Throwable th) {
            if (typedArrayObtainAttributes == null) {
