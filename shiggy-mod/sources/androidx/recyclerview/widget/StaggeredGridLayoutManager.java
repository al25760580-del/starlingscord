...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        while (layoutState.hasMore(state) && (r1.mLayoutState.mInfinite || !r1.mRemainingSpans.isEmpty())) {
            View next = layoutState.next(recycler);
            LayoutParams layoutParams = (LayoutParams) next.getLayoutParams();
            int viewLayoutPosition = layoutParams.getViewLayoutPosition();
            int span = r1.mLazySpanLookup.getSpan(viewLayoutPosition);
            ?? r5 = span == -1 ? 1 : r8;
            if (r5 != 0) {
                nextSpan = layoutParams.mFullSpan ? r1.mSpans[r8] : r1.getNextSpan(layoutState);
                r1.mLazySpanLookup.setSpan(viewLayoutPosition, nextSpan);
            } else {
                nextSpan = r1.mSpans[span];
            }
            Span span2 = nextSpan;
            ...
            r1.measureChildWithDecorationsAndMargin(next, layoutParams, r8);
            if (layoutState.mLayoutDirection == 1) {
                decoratedMeasurement = layoutParams.mFullSpan ? r1.getMaxEnd(i3) : span2.getEndLine(i3);
                minStart = r1.mPrimaryOrientation.getDecoratedMeasurement(next) + decoratedMeasurement;
                if (r5 != 0 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromEnd = r1.createFullSpanItemFromEnd(decoratedMeasurement);
                    fullSpanItemCreateFullSpanItemFromEnd.mGapDir = -1;
                    fullSpanItemCreateFullSpanItemFromEnd.mPosition = viewLayoutPosition;
                    r1.mLazySpanLookup.addFullSpanItem(fullSpanItemCreateFullSpanItemFromEnd);
                }
            } else {
                minStart = layoutParams.mFullSpan ? r1.getMinStart(i3) : span2.getStartLine(i3);
                decoratedMeasurement = minStart - r1.mPrimaryOrientation.getDecoratedMeasurement(next);
                if (r5 != 0 && layoutParams.mFullSpan) {
                    LazySpanLookup.FullSpanItem fullSpanItemCreateFullSpanItemFromStart = r1.createFullSpanItemFromStart(minStart);
                    fullSpanItemCreateFullSpanItemFromStart.mGapDir = 1;
                    fullSpanItemCreateFullSpanItemFromStart.mPosition = viewLayoutPosition;
                    r1.mLazySpanLookup.addFullSpanItem(fullSpanItemCreateFullSpanItemFromStart);
                }
            }
            if (layoutParams.mFullSpan && layoutState.mItemDirection == -1) {
                if (r5 != 0) {
                    r1.mLaidOutInvalidFullSpan = true;
                } else {
                    if (layoutState.mLayoutDirection == 1) {
                        zAreAllStartsEqual = r1.areAllEndsEqual();
                    } else {
                        zAreAllStartsEqual = r1.areAllStartsEqual();
                    }
                    if (!zAreAllStartsEqual) {
                        LazySpanLookup.FullSpanItem fullSpanItem = r1.mLazySpanLookup.getFullSpanItem(viewLayoutPosition);
            ...
            r1.attachViewToSpans(next, layoutParams, layoutState);
            if (r1.isLayoutRTL() && r1.mOrientation == 1) {
                decoratedMeasurement2 = layoutParams.mFullSpan ? r1.mSecondaryOrientation.getEndAfterPadding() : r1.mSecondaryOrientation.getEndAfterPadding() - (((r1.mSpanCount - 1) - span2.mIndex) * r1.mSizePerSpan);
                startAfterPadding2 = decoratedMeasurement2 - r1.mSecondaryOrientation.getDecoratedMeasurement(next);
            } else {
                startAfterPadding2 = layoutParams.mFullSpan ? r1.mSecondaryOrientation.getStartAfterPadding() : (span2.mIndex * r1.mSizePerSpan) + r1.mSecondaryOrientation.getStartAfterPadding();
                decoratedMeasurement2 = r1.mSecondaryOrientation.getDecoratedMeasurement(next) + startAfterPadding2;
            }
            int i4 = decoratedMeasurement2;
            int i5 = startAfterPadding2;
            if (r1.mOrientation == 1) {
                r1.layoutDecoratedWithMargins(next, i5, decoratedMeasurement, i4, minStart);
                r0 = this;
            } else {
                r1.layoutDecoratedWithMargins(next, decoratedMeasurement, i5, minStart, i4);
                r0 = r1;
            }
            if (layoutParams.mFullSpan) {
        ...
        if (!z) {
            r1.recycle(recycler, r1.mLayoutState);
        }
        if (r1.mLayoutState.mLayoutDirection == -1) {
            maxEnd = r1.mPrimaryOrientation.getStartAfterPadding() - r1.getMinStart(r1.mPrimaryOrientation.getStartAfterPadding());
        } else {
            maxEnd = r1.getMaxEnd(r1.mPrimaryOrientation.getEndAfterPadding()) - r1.mPrimaryOrientation.getEndAfterPadding();
        }
        if (maxEnd > 0) {
