...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    /* JADX WARN: Code duplicated, block: B:47:0x00de A[PHI: r1
        ...
        if (actionMasked == 0) {
            ...
            if (actionMasked == 1) {
                ...
                if (this.mScrollState == 1) {
                    ...
                    if (scrollByInternal(zCanScrollHorizontally ? i2 : 0, zCanScrollVertically ? i3 : 0, motionEvent)) {
                        getParent().requestDisallowInterceptTouchEvent(true);
                    }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    int i7 = RecyclerView.this.mReusableIntPair[1];
                    i4 -= i6;
                    i5 -= i7;
                ...
                recyclerView3.dispatchNestedScroll(i, i2, i8, i9, null, 1, recyclerView3.mReusableIntPair);
                int i10 = i8 - RecyclerView.this.mReusableIntPair[0];
                int i11 = i9 - RecyclerView.this.mReusableIntPair[1];
                if (i != 0 || i2 != 0) {
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Code duplicated, block: B:105:0x0223 A[ADDED_TO_REGION] */
