                    ...
                    if (z8 && i31 != 1073741824) {
                        for (int i40 = 0; i40 < i3; i40++) {
                            ...
                            if (virtualChildAt4 != null && virtualChildAt4.getVisibility() != 8 && ((LayoutParams) virtualChildAt4.getLayoutParams()).weight > 0.0f) {
                                virtualChildAt4.measure(View.MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredWidth(), BasicMeasure.EXACTLY), View.MeasureSpec.makeMeasureSpec(i27, BasicMeasure.EXACTLY));
                            }
                        }
                    }
                }
            ...
            if (virtualChildAt == null) {
                ...
                if (virtualChildAt.getVisibility() == 8) {
                    ...
                    if (mode == i15 && layoutParams.width == 0 && layoutParams.weight > 0.0f) {
                        ...
                        int i18 = f3 == 0.0f ? this.mTotalLength : 0;
                        ...
                        if (z5) {
                            ...
                            this.mTotalLength = Math.max(i20, i20 + measuredWidth + layoutParams.leftMargin + layoutParams.rightMargin + getNextLocationOffset(view));
                        }
                        if (z) {
                    ...
                    int i21 = layoutParams.topMargin + layoutParams.bottomMargin;
                    int measuredHeight = view.getMeasuredHeight() + i21;
                    iCombineMeasuredStates = View.combineMeasuredStates(iCombineMeasuredStates, view.getMeasuredState());
                    if (z10 && (baseline2 = view.getBaseline()) != -1) {
                        int i22 = ((((layoutParams.gravity < 0 ? this.mGravity : layoutParams.gravity) & 112) >> 4) & (-2)) >> 1;
                    ...
                    if (f5 > 0.0f) {
                        ...
                        if (layoutParams3.width == 0) {
                            ...
                            if (i5 == 1073741824) {
                                ...
                                virtualChildAt3.measure(View.MeasureSpec.makeMeasureSpec(i30, BasicMeasure.EXACTLY), childMeasureSpec);
                            }
