...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    /* JADX WARN: Code duplicated, block: B:101:0x0288  */
    /* JADX WARN: Code duplicated, block: B:104:0x029c A[LOOP:0: B:103:0x029a->B:104:0x029c, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:107:0x02ba A[LOOP:1: B:106:0x02b8->B:107:0x02ba, LOOP_END] */
    /* JADX WARN: Code duplicated, block: B:111:0x02e2 A[DONT_INVERT] */
    /* JADX WARN: Code duplicated, block: B:112:0x02e4  */
    /* JADX WARN: Code duplicated, block: B:113:0x02e8  */
    /* JADX WARN: Code duplicated, block: B:116:0x02f1 A[LOOP:2: B:115:0x02ef->B:116:0x02f1, LOOP_END] */
    ...
    /* JADX WARN: Code duplicated, block: B:48:0x0126 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:58:0x014c A[ADDED_TO_REGION] */
    ...
    /* JADX WARN: Code duplicated, block: B:90:0x0222 A[DONT_INVERT] */
    ...
    /* JADX WARN: Code duplicated, block: B:99:0x0285  */
    @Override // android.view.ViewGroup, android.view.View
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (shouldLayout(this.mNavButtonView)) {
            ...
            if (zShouldLayout) {
                ...
                measuredHeight = layoutParams3.bottomMargin + layoutParams3.topMargin + this.mTitleTextView.getMeasuredHeight();
            } else {
                measuredHeight = 0;
            }
            if (zShouldLayout2) {
            ...
            if (!zShouldLayout || zShouldLayout2) {
                ...
                if (i6 == 48) {
                    ...
                    if (iMax2 < layoutParams.topMargin + this.mTitleMarginTop) {
                        ...
                        if (i15 < layoutParams.bottomMargin + this.mTitleMarginBottom) {
                            iMax2 = Math.max(0, iMax2 - ((layoutParams2.bottomMargin + this.mTitleMarginBottom) - i15));
                        }
                    }
                    paddingTop = paddingTop2 + iMax2;
                } else {
                    paddingTop = (((height - paddingBottom) - layoutParams2.bottomMargin) - this.mTitleMarginBottom) - i5;
                }
                if (z3) {
                    if (z2) {
            ...
            for (i16 = i9; i16 < size; i16++) {
                iLayoutChildLeft2 = layoutChildLeft(this.mTempViews.get(i16), iLayoutChildLeft2, iArr, iMin2);
            }
            addCustomViewsWithGravity(this.mTempViews, 5);
            size2 = this.mTempViews.size();
            for (i17 = i9; i17 < size2; i17++) {
                iMin = layoutChildRight(this.mTempViews.get(i17), iMin, iArr, iMin2);
            }
        ...
        if (zShouldLayout) {
            ...
            measuredHeight = layoutParams9.bottomMargin + layoutParams9.topMargin + this.mTitleTextView.getMeasuredHeight();
        } else {
            measuredHeight = 0;
        }
        if (zShouldLayout2) {
        ...
        if (zShouldLayout) {
            ...
            if (z3) {
                ...
                i9 = 0;
                int i210 = i8 - iArr[0];
                iMax = i7 + Math.max(0, i210);
                iArr[0] = Math.max(0, -i210);
                if (zShouldLayout) {
