...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    private void onMeasureExactFormat(int i, int i2) {
            ...
            while (i21 < childCount) {
                ...
                if ((j3 & j4) == 0) {
                    ...
                    if (!z7 || !layoutParams3.preventEdgeOffset) {
                        ...
                        z = true;
                        childAt2.setPadding(i22 + i16, 0, i22, 0);
                    } else {
                        z = true;
                    }
        ...
        if (i7 <= 0 || j2 == 0 || (i7 >= i11 - 1 && !z8 && iMax2 <= 1)) {
            ...
            if (z8) {
                ...
                if ((j2 & ((long) (1 << i23))) != 0 && !((LayoutParams) getChildAt(i23).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            int i24 = fBitCount > 0.0f ? (int) ((i7 * i16) / fBitCount) : i3;
            boolean z9 = z5;
            for (int i25 = i3; i25 < childCount; i25++) {
                if ((j2 & ((long) (1 << i25))) != 0) {
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(View.MeasureSpec.makeMeasureSpec(i * i5, BasicMeasure.EXACTLY), iMakeMeasureSpec);
        return i5;
    }
