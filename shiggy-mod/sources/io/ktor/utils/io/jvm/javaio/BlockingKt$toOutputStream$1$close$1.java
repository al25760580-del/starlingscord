...
@DebugMetadata(c = "io.ktor.utils.io.jvm.javaio.BlockingKt$toOutputStream$1$close$1", f = "Blocking.kt", i = {}, l = {71}, m = "invokeSuspend", n = {}, s = {}, v = 1)
final class BlockingKt$toOutputStream$1$close$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    BlockingKt$toOutputStream$1$close$1(ByteWriteChannel byteWriteChannel, Continuation<? super BlockingKt$toOutputStream$1$close$1> continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((BlockingKt$toOutputStream$1$close$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
