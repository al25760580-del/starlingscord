...
public final class OutputStreamContent extends OutgoingContent.WriteChannelContent {
    ...
    @DebugMetadata(c = "io.ktor.http.content.OutputStreamContent$writeTo$2", f = "OutputStreamContent.kt", i = {0, 0}, l = {30}, m = "invokeSuspend", n = {"stream", "$i$a$-use-OutputStreamContent$writeTo$2$1"}, s = {"L$1", "I$0"}, v = 1)
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                try {
                    ...
                    this.L$1 = SpillingKt.nullOutSpilledVariable(outputStream2);
                    this.I$0 = 0;
                    this.label = 1;
                    if (function2.invoke(outputStream2, this) == coroutine_suspended) {
