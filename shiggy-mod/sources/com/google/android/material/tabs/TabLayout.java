...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        try {
            ...
            if (i3 != -1) {
                TypedArray typedArrayObtainStyledAttributes3 = context2.obtainStyledAttributes(i3, androidx.appcompat.R.styleable.TextAppearance);
                try {
    ...
    public final class TabView extends LinearLayout {
        ...
        private void updateTextAndIcon(TextView textView, ImageView imageView, boolean z) {
            ...
            if (textView != null) {
                if (!zIsEmpty) {
                    z2 = this.tab.labelVisibilityMode == 1;
                }
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int i, float f, int i2) {
            ...
            if (tabLayout != null) {
                ...
                tabLayout.setScrollPosition(i, f, z, z, false);
            }
        }
