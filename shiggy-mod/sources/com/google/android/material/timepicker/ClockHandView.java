...
class ClockHandView extends View {
    ...
    public void setHandRotation(float f, boolean z) {
        ...
        this.rotationAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.timepicker.ClockHandView$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                this.f$0.m213xb17f7076(valueAnimator2);
            }
        });
    ...
    /* synthetic */ void m213xb17f7076(ValueAnimator valueAnimator) {
    ...
    private void drawSelector(Canvas canvas) {
        ...
        float f = width;
        float f2 = leveledCircleRadius;
        float fCos = (((float) Math.cos(this.degRad)) * f2) + f;
        float f3 = height;
        float fSin = (f2 * ((float) Math.sin(this.degRad))) + f3;
        ...
        canvas.drawLine(f, f3, width + ((int) (dCos * d)), height + ((int) (d * dSin)), this.paint);
