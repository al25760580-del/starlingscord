    ...
    public final int read(char[] buffer, int bufferOffset, int count) {
        ...
        while (i < count && !exhausted()) {
            ...
            if (iNextCodePoint <= 65535) {
                ...
                char c = (char) ((iNextCodePoint >>> 10) + _Utf8Kt.HIGH_SURROGATE_HEADER);
                char c2 = (char) ((iNextCodePoint & 1023) + _Utf8Kt.LOG_SURROGATE_HEADER);
