...
public final class JsonBuilder {
    ...
    public final JsonConfiguration build$kotlinx_serialization_json() {
        if (this.useArrayPolymorphism) {
            if (!Intrinsics.areEqual(this.classDiscriminator, LinkHeader.Parameters.Type)) {
