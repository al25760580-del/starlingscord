...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m2105JsonPrimitive7apg3OU(byte b) {
        return m2106JsonPrimitiveVKZWuLQ(ULong.m630constructorimpl(((long) b) & 255));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-xj2QHRw, reason: not valid java name */
    public static final JsonPrimitive m2108JsonPrimitivexj2QHRw(short s) {
        return m2106JsonPrimitiveVKZWuLQ(ULong.m630constructorimpl(((long) s) & 65535));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-WZ4Q5Ns, reason: not valid java name */
    public static final JsonPrimitive m2107JsonPrimitiveWZ4Q5Ns(int i) {
        return m2106JsonPrimitiveVKZWuLQ(ULong.m630constructorimpl(((long) i) & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* JADX INFO: renamed from: JsonPrimitive-VKZWuLQ, reason: not valid java name */
    public static final JsonPrimitive m2106JsonPrimitiveVKZWuLQ(long j) {
