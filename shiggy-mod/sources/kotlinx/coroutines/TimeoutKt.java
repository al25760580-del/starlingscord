...
public final class TimeoutKt {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.TimeoutKt", f = "Timeout.kt", i = {0, 0, 0}, l = {LocationRequestCompat.QUALITY_BALANCED_POWER_ACCURACY}, m = "withTimeoutOrNull", n = {"block", "coroutine", "timeMillis"}, s = {"L$0", "L$1", "J$0"})
    ...
    public static final <T> Object m1961withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1952toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final <T> Object m1962withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1952toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    public static final TimeoutCancellationException TimeoutCancellationException(long j, Delay delay, Job job) {
        String strM1953timeoutMessageLRDsOJo;
        ...
        if (delayWithTimeoutDiagnostics != null) {
            ...
            strM1953timeoutMessageLRDsOJo = delayWithTimeoutDiagnostics.m1953timeoutMessageLRDsOJo(DurationKt.toDuration(j, DurationUnit.MILLISECONDS));
            if (strM1953timeoutMessageLRDsOJo == null) {
                strM1953timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
            }
        } else {
            strM1953timeoutMessageLRDsOJo = "Timed out waiting for " + j + " ms";
        }
        return new TimeoutCancellationException(strM1953timeoutMessageLRDsOJo, job);
    }
}
