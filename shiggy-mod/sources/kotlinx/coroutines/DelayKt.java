...
public final class DelayKt {
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2031scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1951delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1952toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1952toDelayMillisLRDsOJo(long j) {
        boolean zM1835isPositiveimpl = Duration.m1835isPositiveimpl(j);
        if (zM1835isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m1819getInWholeMillisecondsimpl(Duration.m1837plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM1835isPositiveimpl) {
