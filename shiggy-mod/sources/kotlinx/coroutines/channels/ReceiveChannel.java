...
public interface ReceiveChannel<E> {
    ...
    Object mo1970receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1971tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1971tryReceivePtdJZtk = receiveChannel.mo1971tryReceivePtdJZtk();
            if (ChannelResult.m1988isSuccessimpl(objMo1971tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1984getOrThrowimpl(objMo1971tryReceivePtdJZtk);
            }
            Throwable thM1982exceptionOrNullimpl = ChannelResult.m1982exceptionOrNullimpl(objMo1971tryReceivePtdJZtk);
            if (thM1982exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1982exceptionOrNullimpl);
        }
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            Object objMo1970receiveCatchingJP2dKIU;
            ...
            if (i == 0) {
                ...
                objMo1970receiveCatchingJP2dKIU = receiveChannel.mo1970receiveCatchingJP2dKIU(anonymousClass1);
                if (objMo1970receiveCatchingJP2dKIU == coroutine_suspended) {
                ...
                ResultKt.throwOnFailure(obj);
                objMo1970receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
            }
            return ChannelResult.m1983getOrNullimpl(objMo1970receiveCatchingJP2dKIU);
        }
