...
public interface SendChannel<E> {
    ...
    Object mo359trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1988isSuccessimpl(objMo359trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1982exceptionOrNullimpl = ChannelResult.m1982exceptionOrNullimpl(objMo359trySendJP2dKIU);
