...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo359trySendJP2dKIU(getValue());
                }
    ...
    public Object mo359trySendJP2dKIU(E element) {
        ...
        try {
            ...
            if (!(list instanceof Collection) || !list.isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (((BufferedChannel) it.next()).shouldSendSuspend$kotlinx_coroutines_core()) {
                        Object objM1992failurePtdJZtk = ChannelResult.INSTANCE.m1992failurePtdJZtk();
                        reentrantLock.unlock();
                        return objM1992failurePtdJZtk;
                    }
                }
            }
            if (this.capacity == -1) {
            ...
            while (it2.hasNext()) {
                ((BufferedChannel) it2.next()).mo359trySendJP2dKIU(element);
            }
            Object objM1993successJP2dKIU = ChannelResult.INSTANCE.m1993successJP2dKIU(Unit.INSTANCE);
            reentrantLock.unlock();
            return objM1993successJP2dKIU;
        } catch (Throwable th) {
            reentrantLock.unlock();
            throw th;
        }
