...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM1997trySendImplMj0NB7M = conflatedBufferedChannel.m1997trySendImplMj0NB7M(e, true);
        if (objM1997trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m1982exceptionOrNullimpl(objM1997trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM1997trySendImplMj0NB7M = conflatedBufferedChannel.m1997trySendImplMj0NB7M(e, true);
        if (!(objM1997trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo359trySendJP2dKIU(E element) {
        return m1997trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m1997trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m1996trySendDropLatestMj0NB7M(element, isSendOp) : m1972trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m1996trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo359trySendJP2dKIU = super.mo359trySendJP2dKIU(element);
        if (ChannelResult.m1988isSuccessimpl(objMo359trySendJP2dKIU) || ChannelResult.m1986isClosedimpl(objMo359trySendJP2dKIU)) {
            return objMo359trySendJP2dKIU;
        }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo359trySendJP2dKIU = mo359trySendJP2dKIU(element);
        if (!(objMo359trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo359trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m1982exceptionOrNullimpl(objMo359trySendJP2dKIU);
