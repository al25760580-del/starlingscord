...
final /* synthetic */ class FlowKt__EmittersKt {
    ...
    public static final class AnonymousClass1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public static final class C00081<T> implements FlowCollector {
            ...
            /* JADX WARN: Multi-variable type inference failed */
            public C00081(Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function3, FlowCollector<? super R> flowCollector) {
                this.$transform = function3;
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                C00081 c00081 = new C00081(this.$transform, flowCollector);
                this.label = 1;
                if (flow.collect(c00081, this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            FlowCollector flowCollector = (FlowCollector) this.L$0;
            this.$this_transform.collect(new C00081(this.$transform, flowCollector), this);
            return Unit.INSTANCE;
        }
    }
