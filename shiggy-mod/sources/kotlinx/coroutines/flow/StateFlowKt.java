...
public final class StateFlowKt {
    ...
    public static final <T> T updateAndGet(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        T tInvoke;
        do {
            main$$ExternalSyntheticLambda3 = (Object) mutableStateFlow.getValue();
            tInvoke = function1.invoke(main$$ExternalSyntheticLambda3);
        } while (!mutableStateFlow.compareAndSet(main$$ExternalSyntheticLambda3, tInvoke));
        return tInvoke;
    }
    ...
    public static final <T> void update(MutableStateFlow<T> mutableStateFlow, Function1<? super T, ? extends T> function1) {
        ...
        do {
            main$$ExternalSyntheticLambda3 = (Object) mutableStateFlow.getValue();
        } while (!mutableStateFlow.compareAndSet(main$$ExternalSyntheticLambda3, function1.invoke(main$$ExternalSyntheticLambda3)));
    }
