...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM453constructorimpl = Result.m453constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m456exceptionOrNullimpl(objM453constructorimpl) == null) {
            obj2 = objM453constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM453constructorimpl2 = Result.m453constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM453constructorimpl2 = Result.m453constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m456exceptionOrNullimpl(objM453constructorimpl2) == null) {
            obj = objM453constructorimpl2;
        }
