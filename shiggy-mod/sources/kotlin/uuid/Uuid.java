...
public final class Uuid implements Comparable<Uuid>, Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m624boximpl(ULong.m630constructorimpl(getMostSignificantBits())), ULong.m624boximpl(ULong.m630constructorimpl(getLeastSignificantBits())));
    }
    ...
    public final byte[] m1945toUByteArrayTcUX1vc() {
        return UByteArray.m527constructorimpl(toByteArray());
    }
    ...
    public int compareTo(Uuid other) {
        ...
        return j != other.mostSignificantBits ? Long.compare(ULong.m630constructorimpl(j) ^ Long.MIN_VALUE, ULong.m630constructorimpl(other.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m630constructorimpl(this.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m630constructorimpl(other.leastSignificantBits) ^ Long.MIN_VALUE);
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1947fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
        ...
        public final Uuid m1946fromUByteArrayGBYM_sE(byte[] ubyteArray) {
