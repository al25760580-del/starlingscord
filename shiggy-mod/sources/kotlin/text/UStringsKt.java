...
public final class UStringsKt {
    ...
    public static final String m1795toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1797toStringolVBNx4(short s, int i) {
    ...
    public static final String m1796toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1794toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m551constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m465boximpl(UByte.m471constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compare(data ^ Integer.MIN_VALUE, UInt.m551constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m731boximpl(UShort.m737constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM551constructorimpl = UInt.m551constructorimpl(i);
        int iM = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                if (iM == 119304647) {
                    iM = UByte$$ExternalSyntheticBackport0.m(-1, iM551constructorimpl);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, iM ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int iM551constructorimpl2 = UInt.m551constructorimpl(i3 * iM551constructorimpl);
            int iM551constructorimpl3 = UInt.m551constructorimpl(UInt.m551constructorimpl(iDigitOf) + iM551constructorimpl2);
            if (Integer.compare(iM551constructorimpl3 ^ Integer.MIN_VALUE, iM551constructorimpl2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = iM551constructorimpl3;
        }
        return UInt.m545boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM630constructorimpl = ULong.m630constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                if (jM$1 == 512409557603043100L) {
                    jM$1 = UByte$$ExternalSyntheticBackport0.m$1(-1L, jM630constructorimpl);
                    if (Long.compare(j ^ Long.MIN_VALUE, jM$1 ^ Long.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            long jM630constructorimpl2 = ULong.m630constructorimpl(j * jM630constructorimpl);
            long jM630constructorimpl3 = ULong.m630constructorimpl(ULong.m630constructorimpl(((long) UInt.m551constructorimpl(iDigitOf)) & 4294967295L) + jM630constructorimpl2);
            if (Long.compare(jM630constructorimpl3 ^ Long.MIN_VALUE, jM630constructorimpl2 ^ Long.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            j = jM630constructorimpl3;
        }
        return ULong.m624boximpl(j);
    }
}
