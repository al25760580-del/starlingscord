...
public final class HexExtensionsKt {
    ...
    private static final int checkFormatLength(long j) {
        if (0 > j || j > 2147483647L) {
            throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m676toStringimpl(ULong.m630constructorimpl(j))));
        }
        return (int) j;
    }
    ...
    /* JADX WARN: Code duplicated, block: B:66:0x013a A[SYNTHETIC] */
