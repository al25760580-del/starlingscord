...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m1922boximpl(m1916markNowz9LOYto());
    }
    ...
    public long m1916markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m1925constructorimpl(read());
    }

    /* JADX INFO: renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m1915elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m1914differenceBetweenfRLX17w(long one, long another) {
    ...
    public final long m1913adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m1925constructorimpl(LongSaturatedMathKt.m1911saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
