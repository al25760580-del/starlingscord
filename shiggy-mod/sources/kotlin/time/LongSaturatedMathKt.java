...
public final class LongSaturatedMathKt {
    ...
    public static final long m1911saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM1847toLongimpl = Duration.m1847toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m1910checkInfiniteSumDefinedPjuGub4(j, j2, jM1847toLongimpl);
        }
        if (((jM1847toLongimpl - 1) | 1) == Long.MAX_VALUE) {
            return m1912saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM1847toLongimpl;
        if (((j ^ j3) & (jM1847toLongimpl ^ j3)) < 0) {
    ...
    private static final long m1910checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m1833isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m1912saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM1811divUwyO8pc = Duration.m1811divUwyO8pc(j2, 2);
        long jM1847toLongimpl = Duration.m1847toLongimpl(jM1811divUwyO8pc, durationUnit);
        return (1 | (jM1847toLongimpl - 1)) == Long.MAX_VALUE ? jM1847toLongimpl : m1911saturatingAddNuflL3o(m1911saturatingAddNuflL3o(j, durationUnit, jM1811divUwyO8pc), durationUnit, Duration.m1836minusLRDsOJo(j2, jM1811divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m1898getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m1897getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m1852unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m1837plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m1852unaryMinusUwyO8pc(infinityOfSign(j3));
        }
