...
public abstract class d {
    ...
    public static final ThreadLocal f3270a = new ThreadLocal();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final ThreadLocal f3271b = new ThreadLocal();

    public static void a(TextInputLayout textInputLayout, View view, Rect rect) {
        rect.set(0, 0, view.getWidth(), view.getHeight());
        ThreadLocal threadLocal = f3270a;
        ...
        ThreadLocal threadLocal2 = f3271b;
