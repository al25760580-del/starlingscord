...
public final class RiveFont extends NativeObject {
    ...
    public static final class Companion {
        ...
        private final native long cppMakeFont(byte[] bytes, int rendererTypeIdx);

        public static /* synthetic */ RiveFont make$default(Companion companion, byte[] bArr, RendererType rendererType, int i7, Object obj) {
            if ((i7 & 2) != 0) {
