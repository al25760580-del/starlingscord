...
@d(c = "app.rive.core.CommandQueue$loadFile-xVnc2tA$$inlined$suspendNativeRequest$1", f = "CommandQueue.kt", l = {2668}, m = "invokeSuspend")
@SourceDebugExtension({"SMAP\nCommandQueue.kt\nKotlin\n*S Kotlin\n*F\n+ 1 CommandQueue.kt\napp/rive/core/CommandQueue$suspendNativeRequest$2\n+ 2 CancellableContinuation.kt\nkotlinx/coroutines/CancellableContinuationKt\n+ 3 CommandQueue.kt\napp/rive/core/CommandQueue\n*L\n1#1,2667:1\n318#2,9:2668\n327#2,2:2679\n621#3,2:2677\n*S KotlinDebug\n*F\n+ 1 CommandQueue.kt\napp/rive/core/CommandQueue$suspendNativeRequest$2\n*L\n2509#1:2668,9\n2509#1:2679,2\n*E\n"})
public final class CommandQueue$loadFilexVnc2tA$$inlined$suspendNativeRequest$1 extends h implements Function2<CoroutineScope, Continuation, Object> {
    ...
    public CommandQueue$loadFilexVnc2tA$$inlined$suspendNativeRequest$1(CommandQueue commandQueue, Continuation continuation, CommandQueue commandQueue2, byte[] bArr) {
    ...
    public final Continuation create(Object obj, @NotNull Continuation continuation) {
        return new CommandQueue$loadFilexVnc2tA$$inlined$suspendNativeRequest$1(this.this$0$inline_fun, continuation, this.this$0, this.$bytes$inlined);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        kVar.v(new Function1<Throwable, Unit>() { // from class: app.rive.core.CommandQueue$loadFile-xVnc2tA$$inlined$suspendNativeRequest$1.1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        try {
            this.this$0.bridge.cppLoadFile(this.this$0.cppPointer.getPointer(), andIncrement, this.$bytes$inlined);
            Object objR = kVar.r();
            if (objR == aVar) {
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, Continuation continuation) {
        return ((CommandQueue$loadFilexVnc2tA$$inlined$suspendNativeRequest$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f14616a);
    }
}
