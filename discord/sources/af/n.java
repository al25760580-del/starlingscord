...
public abstract class n {
    ...
    public static final SimpleArrayMap f466a = new SimpleArrayMap(0);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static Locale f467b;

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            Context context2 = hf.c.a(context).f10726a;
    ...
    public static String b(Context context, int i7) {
        ...
        if (i7 == 2) {
            return ff.c.d(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i7 == 3) {
    ...
    public static String e(Context context, String str) {
        ...
        SimpleArrayMap simpleArrayMap = f466a;
        synchronized (simpleArrayMap) {
            try {
                Locale locale = context.getResources().getConfiguration().getLocales().get(0);
                if (!locale.equals(f467b)) {
                ...
                AtomicBoolean atomicBoolean = xe.i.f22925a;
                try {
