...
public class RtpReceiver {
    ...
    public interface Observer {
        ...
        @CalledByNative("Observer")
        default void onFirstPacketReceivedAfterReceptiveChange(MediaStreamTrack.MediaType mediaType) {
        }
    }
    ...
    private static native void nativeSetFrameDecryptor(long j, long j5);

    private static native long nativeSetObserver(long j, Observer observer);

    private static native void nativeUnsetObserver(long j, long j5);
