...
public class FileVideoCapturer implements VideoCapturer {
    ...
    public static class VideoReaderY4M implements VideoReader {
        ...
        public VideoReaderY4M(String str) throws IOException {
            ...
            while (true) {
                int i7 = this.mediaFile.read();
                if (i7 == -1) {
                    throw new RuntimeException(a3.e.l("Found end of file before end of header for file: ", str));
                }
                if (i7 == 10) {
                    ...
                    Logging.d(TAG, s0.g.c(i10, "frame dim: (", i11, ", ", ")"));
                    return;
                }
                sb2.append((char) i7);
            }
        ...
        public VideoFrame getNextFrame() {
            ...
            try {
                int i7 = FRAME_DELIMETER_LENGTH;
                ByteBuffer byteBufferAllocate = ByteBuffer.allocate(i7);
                if (this.mediaFileChannel.read(byteBufferAllocate) < i7) {
