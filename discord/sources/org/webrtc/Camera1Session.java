...
class Camera1Session implements CameraSession {
    ...
    /* JADX INFO: renamed from: org.webrtc.Camera1Session$2, reason: invalid class name */
    public class AnonymousClass2 implements Camera.PreviewCallback {
        ...
        public /* synthetic */ void lambda$onPreviewFrame$1(byte[] bArr) {
            Camera1Session.this.cameraThreadHandler.post(new c(this, bArr, 1));
        }
        ...
        public void onPreviewFrame(byte[] bArr, Camera camera) {
            ...
            VideoFrame videoFrame = new VideoFrame(new NV21Buffer(bArr, Camera1Session.this.captureFormat.width, Camera1Session.this.captureFormat.height, new c(this, bArr, 0)), Camera1Session.this.getFrameOrientation(), nanos);
    ...
    private Camera1Session(CameraSession.Events events, boolean z5, Context context, SurfaceTextureHelper surfaceTextureHelper, int i7, Camera camera, Camera.CameraInfo cameraInfo, CameraEnumerationAndroid.CaptureFormat captureFormat, long j) {
    ...
    public static void create(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, boolean z5, Context context, SurfaceTextureHelper surfaceTextureHelper, String str, int i7, int i10, int i11) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        CameraEnumerationAndroid.CaptureFormat captureFormatFindClosestCaptureFormat = findClosestCaptureFormat(parameters, i7, i10, i11);
                        updateCameraParameters(cameraOpen, parameters, captureFormatFindClosestCaptureFormat, findClosestPictureSize(parameters, i7, i10), z5);
                        if (!z5) {
                        ...
                        try {
                            ...
                            createSessionCallback.onDone(new Camera1Session(events, z5, context, surfaceTextureHelper, cameraIndex, cameraOpen, cameraInfo, captureFormatFindClosestCaptureFormat, jNanoTime));
    ...
    private static CameraEnumerationAndroid.CaptureFormat findClosestCaptureFormat(Camera.Parameters parameters, int i7, int i10, int i11) {
        ...
        Logging.d(TAG, "Available fps ranges: ".concat(String.valueOf(listConvertFramerates)));
        ...
        Size closestSupportedSize = CameraEnumerationAndroid.getClosestSupportedSize(Camera1Enumerator.convertSizes(parameters.getSupportedPreviewSizes()), i7, i10);
        CameraEnumerationAndroid.reportCameraResolution(camera1ResolutionHistogram, closestSupportedSize);
        return new CameraEnumerationAndroid.CaptureFormat(closestSupportedSize.width, closestSupportedSize.height, closestSupportedFramerateRange);
    }

    private static Size findClosestPictureSize(Camera.Parameters parameters, int i7, int i10) {
        return CameraEnumerationAndroid.getClosestSupportedSize(Camera1Enumerator.convertSizes(parameters.getSupportedPictureSizes()), i7, i10);
    }
    ...
    private void listenForTextureFrames() {
        this.surfaceTextureHelper.startListening(new b(0, this));
    }
    ...
    private void startCapturing() {
        ...
        this.camera.setErrorCallback(new Camera.ErrorCallback() { // from class: org.webrtc.Camera1Session.1
            ...
            public void onError(int i7, Camera camera) {
                String strH = i7 == 100 ? "Camera server died!" : kk.b.h(i7, "Camera error: ");
                Logging.e(Camera1Session.TAG, strH);
                Camera1Session.this.stopInternal();
                if (i7 == 2) {
                    Camera1Session.this.events.onCameraDisconnected(Camera1Session.this);
                } else {
                    Camera1Session.this.events.onCameraError(Camera1Session.this, strH);
                }
            }
        });
    ...
    private static void updateCameraParameters(Camera camera, Camera.Parameters parameters, CameraEnumerationAndroid.CaptureFormat captureFormat, Size size, boolean z5) {
    ...
    public void stop() {
        kk.b.v(this.cameraId, "Stop camera1 session on camera ", TAG);
        checkIsOnCameraThread();
