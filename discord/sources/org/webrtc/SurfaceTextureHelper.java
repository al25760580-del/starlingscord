...
public class SurfaceTextureHelper {
    ...
    public /* synthetic */ SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z5, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor, int i7) {
        this(context, handler, z5, yuvConverter, frameRefMonitor);
    }

    public static SurfaceTextureHelper create(final String str, final EglBase.Context context, final boolean z5, final YuvConverter yuvConverter, final FrameRefMonitor frameRefMonitor) {
        ...
        return (SurfaceTextureHelper) ThreadUtils.invokeAtFrontUninterruptibly(handler, new Callable<SurfaceTextureHelper>() { // from class: org.webrtc.SurfaceTextureHelper.1
            ...
            public SurfaceTextureHelper call() {
                try {
                    return new SurfaceTextureHelper(context, handler, z5, yuvConverter, frameRefMonitor, 0);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setFrameRotation$4(int i7) {
        this.frameRotation = i7;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setTextureSize$2(int i7, int i10) {
    ...
    public void setFrameRotation(int i7) {
        this.handler.post(new k(i7, 1, this));
    }

    public void setTextureSize(int i7, int i10) {
        if (i7 <= 0) {
            throw new IllegalArgumentException(kk.b.h(i7, "Texture width must be positive, but was "));
        }
        if (i10 <= 0) {
            throw new IllegalArgumentException(kk.b.h(i10, "Texture height must be positive, but was "));
        }
        this.surfaceTexture.setDefaultBufferSize(i7, i10);
        this.handler.post(new com.swmansion.reanimated.keyboard.c(this, i7, i10, 2));
    }
    ...
    private SurfaceTextureHelper(EglBase.Context context, Handler handler, boolean z5, YuvConverter yuvConverter, FrameRefMonitor frameRefMonitor) {
        ...
        try {
            ...
            surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.webrtc.r
                @Override // android.graphics.SurfaceTexture.OnFrameAvailableListener
                public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                    this.f17703d.lambda$new$0(surfaceTexture2);
                }
            }, handler);
        } catch (RuntimeException e10) {
            this.eglBase.release();
