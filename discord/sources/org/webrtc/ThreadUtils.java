        ...
        handler.post(new Runnable() { // from class: org.webrtc.ThreadUtils.3
            ...
            public void run() {
                try {
                    ...
                    c1CaughtException.f17657e = e11;
                }
                countDownLatch.countDown();
            }
        });
        awaitUninterruptibly(countDownLatch);
        if (c1CaughtException.f17657e == null) {
            return c1Result.value;
        }
        RuntimeException runtimeException = new RuntimeException(c1CaughtException.f17657e);
        runtimeException.setStackTrace(concatStackTraces(c1CaughtException.f17657e.getStackTrace(), runtimeException.getStackTrace()));
