...
public class EglRenderer implements VideoSink {
    ...
    public class EglSurfaceCreation implements Runnable {
        ...
        public /* synthetic */ EglSurfaceCreation(EglRenderer eglRenderer, int i7) {
            this();
        }
    ...
    public static class FrameListenerAndParams {
        ...
        public FrameListenerAndParams(FrameListener frameListener, float f2, RendererCommon.GlDrawer glDrawer, boolean z5) {
            this.listener = frameListener;
            this.scale = f2;
            this.drawer = glDrawer;
            this.applyFpsReduction = z5;
        }
    }
    ...
    private String averageTimeAsString(long j, int i7) {
        if (i7 <= 0) {
            return "NA";
        }
        return TimeUnit.NANOSECONDS.toMicros(j / ((long) i7)) + " us";
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: clearSurfaceOnRenderThread, reason: merged with bridge method [inline-methods] */
    public void lambda$clearImage$5(float f2, float f7, float f10, float f11) {
        ...
        GLES20.glClearColor(f2, f7, f10, f11);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$addFrameListener$1(RendererCommon.GlDrawer glDrawer, FrameListener frameListener, float f2, boolean z5) {
        if (glDrawer == null) {
            glDrawer = this.drawer;
        }
        this.frameListeners.add(new FrameListenerAndParams(frameListener, f2, glDrawer, z5));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$swapBuffersOnRenderThread$6(VideoFrame videoFrame, long j, boolean z5) {
        if (!z5) {
            EglBase eglBase = this.eglBase;
            if (eglBase == null || !eglBase.hasSurface()) {
                return;
    ...
    private void notifyCallbacks(VideoFrame videoFrame, boolean z5) {
                            ...
                            if (j != LongCompanionObject.MAX_VALUE) {
                                if (j > 0) {
                                    ...
                                    if (jNanoTime < j5) {
                                        ...
                                        long j7 = j5 + this.minRenderPeriodNs;
                                        this.nextFrameTimeNs = j7;
                                        this.nextFrameTimeNs = Math.max(j7, jNanoTime);
                                    }
                                }
                                z5 = true;
                            } else {
    ...
    private void swapBuffersOnRenderThread(final VideoFrame videoFrame, final long j) {
        synchronized (this.threadLock) {
            try {
                ...
                EglThread.RenderUpdate renderUpdate = new EglThread.RenderUpdate() { // from class: org.webrtc.g
                    @Override // org.webrtc.EglThread.RenderUpdate
                    public final void update(boolean z5) {
                        this.f17680a.lambda$swapBuffersOnRenderThread$6(videoFrame, j, z5);
                    }
                };
                if (this.f17650id.equals(EMPTY_UUID)) {
                    this.eglThread.scheduleRenderUpdate(renderUpdate);
                } else {
                    this.eglThread.scheduleRenderUpdate(this.f17650id, renderUpdate);
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public void init(EglThread eglThread, RendererCommon.GlDrawer glDrawer, boolean z5) {
        synchronized (this.threadLock) {
            try {
                if (this.eglThread != null) {
                ...
                this.drawer = glDrawer;
                this.usePresentationTimeStamp = z5;
            ...
            try {
                ...
                synchronized (this.frameLock) {
                    try {
                        ...
                        videoFrame.retain();
                        this.eglThread.getHandler().post(new d(2, this));
                    } catch (Throwable th2) {
                        throw th2;
                    }
                }
    ...
    public void release() {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                this.eglThread.getHandler().postAtFrontOfQueue(new s(2, this, countDownLatch));
        ...
        synchronized (this.threadLock) {
            try {
                ...
                if (eglThread == null) {
                    ...
                    this.eglThread.getHandler().postAtFrontOfQueue(new s(1, this, runnable));
                }
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public void removeFrameListener(FrameListener frameListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new h(this, countDownLatch, frameListener, 0));
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public void removeRenderListener(RenderListener renderListener) {
        ...
        synchronized (this.threadLock) {
            try {
                ...
                postToRenderThread(new h(this, countDownLatch, renderListener, 1));
                ThreadUtils.awaitUninterruptibly(countDownLatch);
            } catch (Throwable th2) {
                throw th2;
            }
    ...
    public void setMirror(boolean z5) {
        synchronized (this.layoutLock) {
            this.mirrorHorizontally = z5;
        }
    }

    public void setMirrorVertically(boolean z5) {
        synchronized (this.layoutLock) {
            this.mirrorVertically = z5;
        }
    }

    public EglRenderer(String str, VideoFrameDrawer videoFrameDrawer) {
        this.f17650id = EMPTY_UUID;
    ...
    public void clearImage(final float f2, final float f7, final float f10, final float f11) {
        synchronized (this.threadLock) {
            try {
                EglThread eglThread = this.eglThread;
                if (eglThread == null) {
                ...
                eglThread.getHandler().postAtFrontOfQueue(new Runnable() { // from class: org.webrtc.f
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f17675d.lambda$clearImage$5(f2, f7, f10, f11);
                    }
                });
            } catch (Throwable th2) {
                throw th2;
    ...
    public void addFrameListener(final FrameListener frameListener, final float f2, final RendererCommon.GlDrawer glDrawer, final boolean z5) {
        postToRenderThread(new Runnable() { // from class: org.webrtc.e
            @Override // java.lang.Runnable
            public final void run() {
                this.f17670d.lambda$addFrameListener$1(glDrawer, frameListener, f2, z5);
            }
        });
    }

    public void init(EglThread eglThread, RendererCommon.GlDrawer glDrawer, boolean z5, boolean z6) {
        if (z6) {
            this.f17650id = UUID.randomUUID();
        }
        init(eglThread, glDrawer, z5);
    }

    public void init(EglBase.Context context, int[] iArr, RendererCommon.GlDrawer glDrawer, boolean z5) {
        init(EglThread.create(null, context, iArr), glDrawer, z5);
    }
