...
public class ScreenCapturerAndroid implements VideoCapturer, VideoSink {
    ...
    public synchronized void changeCaptureFormat(int i7, int i10, int i11) {
        checkNotDisposed();
        this.width = i7;
        this.height = i10;
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.surfaceTextureHelper.getHandler(), new d(5, this));
    }
    ...
    @Override // org.webrtc.VideoCapturer
    public synchronized void startCapture(int i7, int i10, int i11) {
        checkNotDisposed();
        this.width = i7;
        this.height = i10;
