...
public class VideoSource extends MediaSource {
    ...
    public static class AspectRatio {
        ...
        public AspectRatio(int i7, int i10) {
            this.width = i7;
            this.height = i10;
        }
    }
    ...
    public VideoSource(long j) {
        ...
        this.capturerObserver = new CapturerObserver() { // from class: org.webrtc.VideoSource.1
            ...
            public void onCapturerStarted(boolean z5) {
                VideoSource.this.nativeAndroidVideoTrackSource.setState(z5);
                synchronized (VideoSource.this.videoProcessorLock) {
                    try {
                        VideoSource.this.isCapturerRunning = z5;
                        if (VideoSource.this.videoProcessor != null) {
                            VideoSource.this.videoProcessor.onCapturerStarted(z5);
                        }
                    } catch (Throwable th2) {
                        throw th2;
                    }
    ...
    public /* synthetic */ void lambda$setVideoProcessor$1(VideoFrame videoFrame) {
        runWithReference(new s(5, this, videoFrame));
    }

    public void adaptOutputFormat(int i7, int i10, int i11) {
        int iMax = Math.max(i7, i10);
        int iMin = Math.min(i7, i10);
        adaptOutputFormat(iMax, iMin, iMin, iMax, i11);
    }
    ...
    public void setIsScreencast(boolean z5) {
        this.nativeAndroidVideoTrackSource.setIsScreencast(z5);
    }
        ...
        synchronized (this.videoProcessorLock) {
            try {
                ...
                if (videoProcessor != null) {
                    videoProcessor.setSink(new b(2, this));
                    if (this.isCapturerRunning) {
    ...
    public void adaptOutputFormat(int i7, int i10, int i11, int i12, int i13) {
        adaptOutputFormat(new AspectRatio(i7, i10), Integer.valueOf(i7 * i10), new AspectRatio(i11, i12), Integer.valueOf(i11 * i12), Integer.valueOf(i13));
    }
