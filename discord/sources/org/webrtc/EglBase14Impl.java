...
public class EglBase14Impl implements EglBase14 {
    ...
    private static final AtomicInteger liveContextCount = new AtomicInteger(0);
    ...
    public static class EglConnection implements EglBase14.EglConnection {
        ...
        public /* synthetic */ EglConnection(int i7) {
            this();
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void lambda$new$0() {
            kk.b.v(EglBase14Impl.liveContextCount.get(), "Destroying EGLContext, liveContexts=", EglBase14Impl.TAG);
            ...
            kk.b.v(EglBase14Impl.liveContextCount.decrementAndGet(), "Destroyed EGLContext, liveContexts=", EglBase14Impl.TAG);
        }
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            kk.b.v(openGlesVersionFromConfig, "Using OpenGL ES version ", EglBase14Impl.TAG);
            this.eglContext = EglBase14Impl.createEglContext(eGLContext, eglDisplay, eglConfig, openGlesVersionFromConfig);
            this.refCountDelegate = new RefCountDelegate(new d(1, this));
        }
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new bc.a(13));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static EGLContext createEglContext(EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i7) {
        ...
        AtomicInteger atomicInteger = liveContextCount;
        kk.b.v(atomicInteger.get(), "Creating EGLContext, liveContexts=", TAG);
        synchronized (EglBase.lock) {
        ...
        if (eGLContextEglCreateContext != EGL14.EGL_NO_CONTEXT) {
            kk.b.v(atomicInteger.incrementAndGet(), "Created EGLContext, liveContexts=", TAG);
            return eGLContextEglCreateContext;
        }
        int iEglGetError = EGL14.eglGetError();
        throw new GLException(iEglGetError, a3.e.l("Failed to create EGL context: 0x", Integer.toHexString(iEglGetError)));
    }
    ...
    private void createSurfaceInternal(Object obj) {
        ...
        if (eGLSurfaceEglCreateWindowSurface == EGL14.EGL_NO_SURFACE) {
            throw new GLException(EGL14.eglGetError(), a3.e.l("Failed to create window surface: 0x", Integer.toHexString(EGL14.eglGetError())));
        }
    }
    ...
    public static EGLConfig getEglConfig(EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!EGL14.eglChooseConfig(eGLDisplay, iArr, 0, eGLConfigArr, 0, 1, iArr2, 0)) {
            throw new GLException(EGL14.eglGetError(), a3.e.l("eglChooseConfig failed: 0x", Integer.toHexString(EGL14.eglGetError())));
        }
        if (iArr2[0] <= 0) {
    ...
    public static EGLDisplay getEglDisplay() {
        ...
        if (eGLDisplayEglGetDisplay == EGL14.EGL_NO_DISPLAY) {
            throw new GLException(EGL14.eglGetError(), a3.e.l("Unable to get EGL14 display: 0x", Integer.toHexString(EGL14.eglGetError())));
        }
        int[] iArr = new int[2];
        if (EGL14.eglInitialize(eGLDisplayEglGetDisplay, iArr, 0, iArr, 1)) {
            return eGLDisplayEglGetDisplay;
        }
        throw new GLException(EGL14.eglGetError(), a3.e.l("Unable to initialize EGL14: 0x", Integer.toHexString(EGL14.eglGetError())));
    }
    ...
    @Override // org.webrtc.EglBase
    public void createPbufferSurface(int i7, int i10) {
        checkIsNotReleased();
        if (this.eglSurface != EGL14.EGL_NO_SURFACE) {
            throw new RuntimeException("Already has an EGLSurface");
        }
        EGLSurface eGLSurfaceEglCreatePbufferSurface = EGL14.eglCreatePbufferSurface(this.eglConnection.getDisplay(), this.eglConnection.getConfig(), new int[]{12375, i7, 12374, i10, 12344}, 0);
        ...
        StringBuilder sbR = a3.e.r(i7, "Failed to create pixel buffer surface with size ", i10, "x", ": 0x");
        sbR.append(hexString);
        throw new GLException(iEglGetError, sbR.toString());
    }
