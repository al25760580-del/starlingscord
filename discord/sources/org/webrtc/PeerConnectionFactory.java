...
public class PeerConnectionFactory {
    ...
    public static class Builder {
        ...
        private AudioFrameProcessor audioFrameProcessor;
        private AudioProcessingFactory audioProcessingFactory;
        private final Environment.Builder envBuilder;
        ...
        public PeerConnectionFactory createPeerConnectionFactory() throws Throwable {
            Environment environment;
            long jCreateNative;
            PeerConnectionFactory.checkInitializeHasBeenCalled();
            Environment environmentBuild = this.envBuilder.build();
            try {
                ...
                long jRef = environmentBuild.ref();
                long j = this.audioDeviceModule.getNative(environmentBuild.ref());
                ...
                if (audioProcessingFactory == null) {
                    ...
                    environment = environmentBuild;
                    try {
                        jCreateNative = audioProcessingFactory.createNative(environment.ref());
                    } catch (Throwable th2) {
                        th = th2;
                        Throwable th3 = th;
                        if (environment == null) {
                ...
                long jCreateNativeNetEqFactory = netEqFactoryFactory == null ? 0L : netEqFactoryFactory.createNativeNetEqFactory();
                AudioFrameProcessor audioFrameProcessor = this.audioFrameProcessor;
                PeerConnectionFactory peerConnectionFactoryNativeCreatePeerConnectionFactory = PeerConnectionFactory.nativeCreatePeerConnectionFactory(applicationContext, options, jRef, j, jCreateNativeAudioEncoderFactory, jCreateNativeAudioDecoderFactory, videoEncoderFactory, videoDecoderFactory, jCreateNative, jCreateNative2, jCreateNativeNetworkControllerFactory, jCreateNativeNetworkStatePredictorFactory, jCreateNativeNetEqFactory, audioFrameProcessor != null ? audioFrameProcessor.getNativeAudioFrameProcessor() : 0L);
                environment.close();
                return peerConnectionFactoryNativeCreatePeerConnectionFactory;
            } catch (Throwable th5) {
                th = th5;
                environment = environmentBuild;
            }
    ...
    public static class InitializationOptions {
        ...
        public /* synthetic */ InitializationOptions(Context context, String str, boolean z5, NativeLibraryLoader nativeLibraryLoader, String str2, Loggable loggable, Logging.Severity severity, int i7) {
            this(context, str, z5, nativeLibraryLoader, str2, loggable, severity);
        }
        ...
        private InitializationOptions(Context context, String str, boolean z5, NativeLibraryLoader nativeLibraryLoader, String str2, Loggable loggable, Logging.Severity severity) {
            this.applicationContext = context;
            this.fieldTrials = str;
            this.enableInternalTracer = z5;
            this.nativeLibraryLoader = nativeLibraryLoader;
    ...
    public static class ThreadInfo {
        ...
        private ThreadInfo(Thread thread, int i7) {
            this.thread = thread;
            this.tid = i7;
        }
    ...
    private static native long nativeCreateAudioTrack(long j, String str, long j5);

    private static native long nativeCreateLocalMediaStream(long j, String str);

    private static native long nativeCreatePeerConnection(long j, PeerConnection.RTCConfiguration rTCConfiguration, MediaConstraints mediaConstraints, long j5, SSLCertificateVerifier sSLCertificateVerifier);

    /* JADX INFO: Access modifiers changed from: private */
    public static native PeerConnectionFactory nativeCreatePeerConnectionFactory(Context context, Options options, long j, long j5, long j7, long j10, VideoEncoderFactory videoEncoderFactory, VideoDecoderFactory videoDecoderFactory, long j11, long j12, long j13, long j14, long j15, long j16);

    private static native long nativeCreateVideoSource(long j, boolean z5, boolean z6);

    private static native long nativeCreateVideoTrack(long j, String str, long j5);
    ...
    private static native void nativePrintStackTrace(int i7);

    private static native void nativeShutdownInternalTracer();

    private static native boolean nativeStartAecDump(long j, int i7, int i10);
    ...
    private static void printStackTrace(ThreadInfo threadInfo, boolean z5) {
        if (threadInfo == null) {
            return;
        }
        ...
        if (z5) {
            Logging.w(TAG, "*** *** *** *** *** *** *** *** *** *** *** *** *** *** *** ***");
            StringBuilder sbR = a3.e.r(Process.myPid(), "pid: ", threadInfo.tid, ", tid: ", ", name: ");
            sbR.append(name);
            sbR.append("  >>> WebRTC <<<");
            Logging.w(TAG, sbR.toString());
    ...
    public VideoSource createVideoSource(boolean z5, boolean z6) {
        checkPeerConnectionFactoryExists();
        return new VideoSource(nativeCreateVideoSource(this.nativeFactory, z5, z6));
    }
    ...
    public void printInternalStackTraces(boolean z5) {
        printStackTrace(this.signalingThread, z5);
        printStackTrace(this.workerThread, z5);
        printStackTrace(this.networkThread, z5);
    }

    public boolean startAecDump(int i7, int i10) {
        checkPeerConnectionFactoryExists();
        return nativeStartAecDump(this.nativeFactory, i7, i10);
    }
    ...
    public VideoSource createVideoSource(boolean z5) {
        return createVideoSource(z5, true);
    }
