...
class GlGenericDrawer implements RendererCommon.GlDrawer {
    ...
    public interface ShaderCallbacks {
        ...
        void onPrepareShader(GlShader glShader, float[] fArr, int i7, int i10, int i11, int i12);
    }
    ...
    private void prepareShader(ShaderType shaderType, float[] fArr, int i7, int i10, int i11, int i12) {
        GlShader glShader;
        if (shaderType.equals(this.currentShaderType)) {
            ...
            GlShader glShaderCreateShader = createShader(shaderType);
        ...
        this.shaderCallbacks.onPrepareShader(glShader, fArr, i7, i10, i11, i12);
    ...
    public void drawOes(int i7, float[] fArr, int i10, int i11, int i12, int i13, int i14, int i15) {
        prepareShader(ShaderType.OES, fArr, i10, i11, i14, i15);
    ...
    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawRgb(int i7, float[] fArr, int i10, int i11, int i12, int i13, int i14, int i15) {
        prepareShader(ShaderType.RGB, fArr, i10, i11, i14, i15);
        GLES20.glActiveTexture(33984);
    ...
    @Override // org.webrtc.RendererCommon.GlDrawer
    public void drawYuv(int[] iArr, float[] fArr, int i7, int i10, int i11, int i12, int i13, int i14) {
        prepareShader(ShaderType.YUV, fArr, i7, i10, i13, i14);
