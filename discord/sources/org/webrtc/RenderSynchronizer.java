...
public final class RenderSynchronizer {
    ...
    public RenderSynchronizer(float f2) {
        this.lock = new Object();
        this.listeners = new CopyOnWriteArrayList();
        this.targetFrameIntervalNanos = Math.round(TimeUnit.SECONDS.toNanos(1L) / f2);
    ...
    public /* synthetic */ void lambda$registerListener$1() {
        this.choreographer.postFrameCallback(new p(this));
    }
    ...
    public void onDisplayRefreshCycleBegin(long j) {
        synchronized (this.lock) {
            try {
                ...
                this.choreographer.postFrameCallback(new p(this));
                long j5 = j - this.lastOpenedTimeNanos;
                long j7 = j - this.lastRefreshTimeNanos;
                this.lastRefreshTimeNanos = j;
                if (Math.abs(j5 - this.targetFrameIntervalNanos) < Math.abs((j5 - this.targetFrameIntervalNanos) + j7)) {
        ...
        synchronized (this.lock) {
            try {
                if (!this.isListening) {
                    ...
                    this.mainThreadHandler.post(new o(this, 0));
                }
            } catch (Throwable th2) {
                throw th2;
            }
