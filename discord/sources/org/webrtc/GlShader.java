...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        if (iGlCreateProgram == 0) {
            throw new RuntimeException(kk.b.h(GLES20.glGetError(), "glCreateProgram() failed. GLES20 error: "));
        }
    ...
    private static int compileShader(int i7, String str) {
        ...
        if (iGlCreateShader == 0) {
            throw new RuntimeException(kk.b.h(GLES20.glGetError(), "glCreateShader() failed. GLES20 error: "));
        }
    ...
    public int getAttribLocation(String str) {
        ...
        throw new RuntimeException(s0.g.e("Could not locate '", str, "' in program"));
    }
    ...
    public int getUniformLocation(String str) {
        ...
        int iGlGetUniformLocation = GLES20.glGetUniformLocation(i7, str);
        if (iGlGetUniformLocation >= 0) {
            return iGlGetUniformLocation;
        }
        throw new RuntimeException(s0.g.e("Could not locate uniform '", str, "' in program"));
    }
    ...
    public void setVertexAttribArray(String str, int i7, int i10, FloatBuffer floatBuffer) {
        if (this.program == -1) {
            throw new RuntimeException("The program has been released");
        }
