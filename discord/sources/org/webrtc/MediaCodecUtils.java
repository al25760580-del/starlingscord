...
class MediaCodecUtils {
    ...
    public static Map<String, String> getCodecProperties(VideoCodecMimeType videoCodecMimeType, boolean z5) {
        int i7 = AnonymousClass1.$SwitchMap$org$webrtc$VideoCodecMimeType[videoCodecMimeType.ordinal()];
        if (i7 == 1 || i7 == 2 || i7 == 3 || i7 == 4) {
            return new HashMap();
        }
        if (i7 == 5) {
            return H264Utils.getDefaultH264Params(z5);
        }
