...
public class MediaStreamTrack {
    ...
    public enum MediaType {
        ...
        public static MediaType fromNativeIndex(int i7) {
            for (MediaType mediaType : values()) {
                if (mediaType.getNative() == i7) {
                    return mediaType;
                }
            }
            throw new IllegalArgumentException(kk.b.h(i7, "Unknown native media type: "));
        }
    ...
    private static native boolean nativeSetEnabled(long j, boolean z5);
    ...
    public boolean setEnabled(boolean z5) {
        checkMediaStreamTrackExists();
        return nativeSetEnabled(this.nativeTrack, z5);
    }
