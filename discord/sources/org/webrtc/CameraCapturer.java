...
abstract class CameraCapturer implements CameraVideoCapturer {
    ...
    public CameraCapturer(String str, CameraVideoCapturer.CameraEventsHandler cameraEventsHandler, CameraEnumerator cameraEnumerator) {
        ...
        if (!listAsList.contains(this.cameraName)) {
            throw new IllegalArgumentException(s0.g.e("Camera name ", this.cameraName, " does not match any known camera device."));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void createSessionInternal(int i7) {
        this.uiThreadHandler.postDelayed(this.openCameraTimeoutRunnable, i7 + OPEN_CAMERA_TIMEOUT);
    ...
    public void switchCameraInternal(CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler, String str) {
        ...
        if (!Arrays.asList(this.cameraEnumerator.getDeviceNames()).contains(str)) {
            reportCameraSwitchError(a3.e.l("Attempted to switch to unknown camera device ", str), cameraSwitchHandler);
            return;
        }
        synchronized (this.stateLock) {
            try {
                ...
                boolean z5 = this.sessionOpening;
                if (!z5 && this.currentSession == null) {
    ...
    public void changeCaptureFormat(int i7, int i10, int i11) {
        StringBuilder sbR = a3.e.r(i7, "changeCaptureFormat: ", i10, "x", "@");
        sbR.append(i11);
        Logging.d(TAG, sbR.toString());
        synchronized (this.stateLock) {
            stopCapture();
            startCapture(i7, i10, i11);
        }
    }

    public abstract void createCameraSession(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, SurfaceTextureHelper surfaceTextureHelper, String str, int i7, int i10, int i11);
    ...
    @Override // org.webrtc.VideoCapturer
    public void startCapture(int i7, int i10, int i11) {
        StringBuilder sbR = a3.e.r(i7, "startCapture: ", i10, "x", "@");
        sbR.append(i11);
        Logging.d(TAG, sbR.toString());
    ...
    public void switchCamera(final CameraVideoCapturer.CameraSwitchHandler cameraSwitchHandler) {
        ...
        this.cameraThreadHandler.post(new Runnable(this) { // from class: org.webrtc.CameraCapturer.7
            final /* synthetic */ CameraCapturer this$0;
            ...
            public void run() {
                ...
                if (listAsList.size() < 2) {
                    this.this$0.reportCameraSwitchError("No camera to switch to.", cameraSwitchHandler);
                } else {
                    this.this$0.switchCameraInternal(cameraSwitchHandler, (String) listAsList.get((listAsList.indexOf(this.this$0.cameraName) + 1) % listAsList.size()));
                }
            }
        });
    }
