...
public class PeerConnection {
    ...
    public enum AdapterType {
        ...
        ADAPTER_TYPE_ANY(32),
        CELLULAR_2G(64),
        CELLULAR_3G(Integer.valueOf(IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT)),
        CELLULAR_4G(Integer.valueOf(IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER)),
        CELLULAR_5G(Integer.valueOf(IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING));
        ...
        public static AdapterType fromNativeIndex(int i7) {
            return BY_BITMASK.get(Integer.valueOf(i7));
        }
    }
    ...
    public enum IceConnectionState {
        ...
        public static IceConnectionState fromNativeIndex(int i7) {
            return values()[i7];
        }
    }
    ...
    public enum IceGatheringState {
        ...
        public static IceGatheringState fromNativeIndex(int i7) {
            return values()[i7];
        }
    }
    ...
    public static class IceServer {
        ...
        public static class Builder {
            ...
            public /* synthetic */ Builder(int i7, List list) {
                this(list);
            }
        ...
        public /* synthetic */ IceServer(String str, List list, String str2, String str3, TlsCertPolicy tlsCertPolicy, String str4, List list2, List list3, int i7) {
        ...
        public String toString() {
            String strValueOf = String.valueOf(this.urls);
            String str = this.username;
            String str2 = this.password;
            String strValueOf2 = String.valueOf(this.tlsCertPolicy);
            String str3 = this.hostname;
            String strValueOf3 = String.valueOf(this.tlsAlpnProtocols);
            String strValueOf4 = String.valueOf(this.tlsEllipticCurves);
            ...
            sb2.append(":");
            sb2.append(str2);
            a3.e.A(sb2, "] [", strValueOf2, "] [", str3);
            a3.e.A(sb2, "] [", strValueOf3, "] [", strValueOf4);
            sb2.append("]");
            return sb2.toString();
        }
    ...
    public interface Observer {
        ...
        @CalledByNative("Observer")
        void onIceConnectionReceivingChange(boolean z5);
    ...
    public enum PeerConnectionState {
        ...
        public static PeerConnectionState fromNativeIndex(int i7) {
            return values()[i7];
        }
    }
    ...
    public static class RTCConfiguration {
        ...
        public int audioJitterBufferMaxPackets = h0.DEFAULT_DRAG_ANIMATION_DURATION;
    ...
    public enum SignalingState {
        ...
        public static SignalingState fromNativeIndex(int i7) {
            return values()[i7];
        }
    }
    ...
    private native void nativeAddIceCandidateWithObserver(String str, int i7, String str2, AddIceObserver addIceObserver);
    ...
    private native void nativeSetAudioPlayout(boolean z5);

    private native void nativeSetAudioRecording(boolean z5);
    ...
    private native boolean nativeStartRtcEventLog(int i7, int i10);
    ...
    public void setAudioPlayout(boolean z5) {
        nativeSetAudioPlayout(z5);
    }

    public void setAudioRecording(boolean z5) {
        nativeSetAudioRecording(z5);
    }
    ...
    public boolean startRtcEventLog(int i7, int i10) {
        return nativeStartRtcEventLog(i7, i10);
    }
