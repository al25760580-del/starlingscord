...
public class EglBase10Impl implements EglBase10 {
    ...
    public static class EglConnection implements EglBase10.EglConnection {
        ...
        public EglConnection(EGLContext eGLContext, int[] iArr) {
            ...
            kk.b.v(openGlesVersionFromConfig, "Using OpenGL ES version ", EglBase10Impl.TAG);
            this.eglContext = EglBase10Impl.createEglContext(egl10, eGLContext, eglDisplay, eglConfig, openGlesVersionFromConfig);
            this.refCountDelegate = new RefCountDelegate(new d(0, this));
        }
        ...
        private EglConnection() {
            ...
            this.eglConfig = null;
            this.refCountDelegate = new RefCountDelegate(new bc.a(12));
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static EGLContext createEglContext(EGL10 egl10, EGLContext eGLContext, EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i7) {
        EGLContext eGLContextEglCreateContext;
        if (eGLContext != null && eGLContext == EGL10.EGL_NO_CONTEXT) {
            throw new RuntimeException("Invalid sharedContext");
        }
        int[] iArr = {EGL_CONTEXT_CLIENT_VERSION, i7, 12344};
        if (eGLContext == null) {
        ...
        throw new GLException(egl10.eglGetError(), a3.e.l("Failed to create EGL context: 0x", Integer.toHexString(egl10.eglGetError())));
    }
    ...
    private void createSurfaceInternal(Object obj) {
        ...
        if (eGLSurfaceEglCreateWindowSurface == eGLSurface2) {
            throw new GLException(egl.eglGetError(), a3.e.l("Failed to create window surface: 0x", Integer.toHexString(egl.eglGetError())));
        }
    }
    ...
    public static EGLConfig getEglConfig(EGL10 egl10, EGLDisplay eGLDisplay, int[] iArr) {
        ...
        if (!egl10.eglChooseConfig(eGLDisplay, iArr, eGLConfigArr, 1, iArr2)) {
            throw new GLException(egl10.eglGetError(), a3.e.l("eglChooseConfig failed: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        if (iArr2[0] <= 0) {
    ...
    public static EGLDisplay getEglDisplay(EGL10 egl10) {
        ...
        if (eGLDisplayEglGetDisplay == EGL10.EGL_NO_DISPLAY) {
            throw new GLException(egl10.eglGetError(), a3.e.l("Unable to get EGL10 display: 0x", Integer.toHexString(egl10.eglGetError())));
        }
        if (egl10.eglInitialize(eGLDisplayEglGetDisplay, new int[2])) {
            return eGLDisplayEglGetDisplay;
        }
        throw new GLException(egl10.eglGetError(), a3.e.l("Unable to initialize EGL10: 0x", Integer.toHexString(egl10.eglGetError())));
    }
    ...
    public void createPbufferSurface(int i7, int i10) {
        ...
        EGL10 egl = this.eglConnection.getEgl();
        EGLSurface eGLSurfaceEglCreatePbufferSurface = egl.eglCreatePbufferSurface(this.eglConnection.getDisplay(), this.eglConnection.getConfig(), new int[]{12375, i7, 12374, i10, 12344});
