...
public class MediaStream {
    ...
    private static native boolean nativeAddAudioTrackToNativeStream(long j, long j5);

    private static native boolean nativeAddVideoTrackToNativeStream(long j, long j5);

    private static native String nativeGetId(long j);

    private static native boolean nativeRemoveAudioTrack(long j, long j5);

    private static native boolean nativeRemoveVideoTrack(long j, long j5);
    ...
    public String toString() {
        ...
        return kk.b.l(a3.e.t("[", id2, ":A=", size, ":V="), this.videoTracks.size(), "]");
    }
