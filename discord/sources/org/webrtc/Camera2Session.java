...
class Camera2Session implements CameraSession {
    ...
    public static class CameraCaptureCallback extends CameraCaptureSession.CaptureCallback {
        public /* synthetic */ CameraCaptureCallback(int i7) {
            this();
        }

        @Override // android.hardware.camera2.CameraCaptureSession.CaptureCallback
        public void onCaptureFailed(CameraCaptureSession cameraCaptureSession, CaptureRequest captureRequest, CaptureFailure captureFailure) {
            Logging.d(Camera2Session.TAG, "Capture failed: ".concat(String.valueOf(captureFailure)));
        }
    ...
    public class CameraStateCallback extends CameraDevice.StateCallback {
        public /* synthetic */ CameraStateCallback(Camera2Session camera2Session, int i7) {
            this();
        }

        private String getErrorDescription(int i7) {
            if (i7 == 1) {
            ...
            if (i7 != 4) {
                return i7 != 5 ? kk.b.h(i7, "Unknown camera error: ") : "Camera service has encountered a fatal error.";
            }
        ...
        public void onDisconnected(CameraDevice cameraDevice) {
            Camera2Session.this.checkIsOnCameraThread();
            boolean z5 = Camera2Session.this.captureSession == null && Camera2Session.this.state != SessionState.STOPPED;
        ...
        public void onError(CameraDevice cameraDevice, int i7) {
            Camera2Session.this.checkIsOnCameraThread();
            Camera2Session.this.reportError(getErrorDescription(i7));
        }
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            try {
                ...
                Camera2Session.this.reportError("Failed to create capture session. ".concat(String.valueOf(e10)));
            }
        }
    ...
    public class CaptureSessionCallback extends CameraCaptureSession.StateCallback {
        public /* synthetic */ CaptureSessionCallback(Camera2Session camera2Session, int i7) {
            this();
        }

        private void chooseFocusMode(CaptureRequest.Builder builder) {
            for (int i7 : (int[]) Camera2Session.this.cameraCharacteristics.get(CameraCharacteristics.CONTROL_AF_AVAILABLE_MODES)) {
                if (i7 == 3) {
        ...
        public void onConfigured(CameraCaptureSession cameraCaptureSession) {
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new b(1, this));
                Logging.d(Camera2Session.TAG, "Camera device successfully started.");
                Camera2Session.this.callback.onDone(Camera2Session.this);
            } catch (CameraAccessException e10) {
                Camera2Session.this.reportError("Failed to start capture request. ".concat(String.valueOf(e10)));
            }
        }
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i7, int i10, int i11) {
    ...
    public static void create(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i7, int i10, int i11) {
        new Camera2Session(createSessionCallback, events, context, cameraManager, surfaceTextureHelper, str, i7, i10, i11);
    }
    ...
    private void findCaptureFormat() {
        ...
        Logging.d(TAG, "Available preview sizes: ".concat(String.valueOf(supportedSizes)));
        ...
        Logging.d(TAG, "Using capture format: ".concat(String.valueOf(captureFormat)));
    }
    ...
    private void openCamera() {
        ...
        try {
            ...
            reportError("Failed to open camera: ".concat(String.valueOf(e10)));
        }
    }
    ...
    public void reportError(String str) {
        ...
        boolean z5 = this.captureSession == null && this.state != SessionState.STOPPED;
    ...
    private void start() {
        ...
        try {
            ...
            reportError(a3.e.l("getCameraCharacteristics(): ", e10.getMessage()));
        }
    }
