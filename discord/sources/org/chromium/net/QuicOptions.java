...
public final class QuicOptions {
    ...
    public static class Builder {
        ...
        @Experimental
        public Builder closeSessionsOnIpChange(boolean z5) {
            this.mCloseSessionsOnIpChange = Boolean.valueOf(z5);
            return this;
        }

        @Experimental
        public Builder delayJobsWithAvailableSpdySession(boolean z5) {
            this.mDelayJobsWithAvailableSpdySession = Boolean.valueOf(z5);
            return this;
        }

        @Experimental
        public Builder enableTlsZeroRtt(boolean z5) {
            this.mEnableTlsZeroRtt = Boolean.valueOf(z5);
            return this;
        }

        @Experimental
        public Builder goawaySessionsOnIpChange(boolean z5) {
            this.mGoawaySessionsOnIpChange = Boolean.valueOf(z5);
            return this;
        }

        @Experimental
        public Builder increaseBrokenServicePeriodExponentially(boolean z5) {
            this.mIncreaseBrokenServicePeriodExponentially = Boolean.valueOf(z5);
            return this;
        }

        @Experimental
        public Builder retryWithoutAltSvcOnQuicErrors(boolean z5) {
            this.mRetryWithoutAltSvcOnQuicErrors = Boolean.valueOf(z5);
            return this;
        }
        ...
        public Builder setInMemoryServerConfigsCacheSize(int i7) {
            this.mInMemoryServerConfigsCacheSize = Integer.valueOf(i7);
            return this;
        }
