...
public class Snapshot {
    ...
    private View findTransformedView(View view) {
        ...
        while (true) {
            ...
            boolean z6 = !zEquals;
            if (!zEquals || view2.getClass().getSimpleName().equals(Screen.TAG)) {
                z5 = z6;
                break;
            }
            z5 = z6;
    ...
    public Snapshot(View view) {
        ...
        if (viewFindTransformedView != null) {
            ...
            for (int i7 = 0; i7 < 9; i7++) {
                this.transformMatrix.add(Float.valueOf(fArr[i7]));
            }
            ...
            int i10 = this.width;
            this.originX = (int) (f2 - ((i10 - (viewFindTransformedView.getScaleX() * i10)) / 2.0f));
            float f7 = this.originY;
            int i11 = this.height;
            this.originY = (int) (f7 - ((i11 - (viewFindTransformedView.getScaleY() * i11)) / 2.0f));
        }
