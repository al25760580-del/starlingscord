...
public final class ReactSurfaceImpl implements ReactSurface {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final ReactSurfaceImpl createWithView(@NotNull Context context, @NotNull String moduleName, Bundle initialProps) {
    ...
    public final void attach(@NotNull ReactHost host) {
        ...
        AtomicReference<ReactHostImpl> atomicReference = this.reactHostRef;
        while (!atomicReference.compareAndSet(null, host)) {
    ...
    public final void attachView(@NotNull ReactSurfaceView view) {
        ...
        AtomicReference<ReactSurfaceView> atomicReference = this.surfaceViewRef;
        while (!atomicReference.compareAndSet(null, view)) {
            if (atomicReference.get() != null) {
    ...
    public void clear() {
        UiThreadUtil.runOnUiThread(new am.c(24, this));
    }
