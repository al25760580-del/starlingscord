...
public final class ReactHostImplDevHelper implements ReactInstanceDevHelper, PerfMonitorDevHelper, TracingStateProvider {
    ...
    public void destroyRootView(@NotNull View rootView) {
        ReactSurfaceImpl surface;
        Intrinsics.checkNotNullParameter(rootView, "rootView");
        ReactSurfaceView reactSurfaceView = rootView instanceof ReactSurfaceView ? (ReactSurfaceView) rootView : null;
        if (reactSurfaceView == null || (surface = reactSurfaceView.getSurface()) == null) {
            return;
        }
        surface.stop();
        surface.detach();
