...
public final class CoreReactPackage extends BaseReactPackage {
    ...
    private final ReactModuleInfoProvider fallbackForMissingClass() {
        Class<?>[] clsArr = {AndroidInfoModule.class, DeviceInfoModule.class, SourceCodeModule.class, DevMenuModule.class, DevSettingsModule.class, DeviceEventManagerModule.class, LogBoxModule.class, ExceptionsManagerModule.class, HeadlessJsTaskSupportModule.class};
    ...
    public ReactModuleInfoProvider getReactModuleInfoProvider() throws Exception {
        ...
        try {
            Class<?> clsFindClass = ClassFinder.findClass(CoreReactPackage.class.getName().concat("$$ReactModuleInfoProvider"));
            ...
            if ((e10 instanceof InstantiationException) || (e10 instanceof IllegalAccessException)) {
                throw new RuntimeException(s0.g.e("No ReactModuleInfoProvider for ", CoreReactPackage.class.getName(), "$$ReactModuleInfoProvider"), e10);
            }
            throw e10;
        }
    }
