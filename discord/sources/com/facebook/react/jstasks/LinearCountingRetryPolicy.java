...
public final class LinearCountingRetryPolicy implements HeadlessJsTaskRetryPolicy {
    ...
    public LinearCountingRetryPolicy(int i7, int i10) {
        this.retryAttempts = i7;
        this.delayBetweenAttemptsInMs = i10;
        this.delay = i10;
    }
    ...
    public HeadlessJsTaskRetryPolicy update() {
        int i7 = this.retryAttempts - 1;
        return i7 > 0 ? new LinearCountingRetryPolicy(i7, this.delayBetweenAttemptsInMs) : NoRetryPolicy.INSTANCE;
    }
}
