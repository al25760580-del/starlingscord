...
public final class HeadlessJsTaskConfig {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public HeadlessJsTaskConfig(@NotNull String taskKey, @NotNull WritableMap data, long j, boolean z5) {
        this(taskKey, data, j, z5, null, 16, null);
        Intrinsics.checkNotNullParameter(taskKey, "taskKey");
        Intrinsics.checkNotNullParameter(data, "data");
    }

    public HeadlessJsTaskConfig(@NotNull String taskKey, @NotNull WritableMap data, long j, boolean z5, HeadlessJsTaskRetryPolicy headlessJsTaskRetryPolicy) {
        Intrinsics.checkNotNullParameter(taskKey, "taskKey");
        Intrinsics.checkNotNullParameter(data, "data");
        this.taskKey = taskKey;
        this.data = data;
        this.timeout = j;
        this.isAllowedInForeground = z5;
        this.retryPolicy = headlessJsTaskRetryPolicy;
    }

    public /* synthetic */ HeadlessJsTaskConfig(String str, WritableMap writableMap, long j, boolean z5, HeadlessJsTaskRetryPolicy headlessJsTaskRetryPolicy, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, writableMap, (i7 & 4) != 0 ? 0L : j, (i7 & 8) != 0 ? false : z5, (i7 & 16) != 0 ? NoRetryPolicy.INSTANCE : headlessJsTaskRetryPolicy);
    }
    ...
    public HeadlessJsTaskConfig(@NotNull HeadlessJsTaskConfig source) {
        ...
        boolean z5 = source.isAllowedInForeground;
        HeadlessJsTaskRetryPolicy headlessJsTaskRetryPolicy = source.retryPolicy;
        this(str, writableMapCopy, j, z5, headlessJsTaskRetryPolicy != null ? headlessJsTaskRetryPolicy.copy() : null);
    }
}
