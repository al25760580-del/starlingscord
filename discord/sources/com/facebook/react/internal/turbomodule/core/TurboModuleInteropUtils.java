...
public final class TurboModuleInteropUtils {
    ...
    public static final class MethodDescriptor {
        ...
        public MethodDescriptor(@NotNull String methodName, @NotNull String jniSignature, @NotNull String jsiReturnKind, int i7) {
    ...
    private final String convertClassToJniType(Class<?> cls) {
        ...
        if (canonicalName != null) {
            return g.e("L", x.m(canonicalName, '.', '/'), ";");
        }
    ...
    private final String convertParamClassToJniType(String moduleName, String methodName, Class<?> paramClass) {
        ...
        throw new ParsingException(moduleName, methodName, e.l("Unable to parse JNI signature. Detected unsupported parameter class: ", paramClass.getCanonicalName()));
    }
    ...
    private final String convertReturnClassToJniType(String moduleName, String methodName, Class<?> returnClass) {
        ...
        throw new ParsingException(moduleName, methodName, e.l("Unable to parse JNI signature. Detected unsupported return class: ", returnClass.getCanonicalName()));
    }

    private final String createJSIReturnKind(String moduleName, String methodName, Class<?>[] paramClasses, Class<?> returnClass) {
        for (int i7 = 0; i7 < paramClasses.length; i7++) {
            if (Intrinsics.areEqual(paramClasses[i7], Promise.class)) {
                if (i7 == paramClasses.length - 1) {
                    return "PromiseKind";
                }
        ...
        throw new ParsingException(moduleName, methodName, e.l("Unable to parse JSI return kind. Detected unsupported return class: ", returnClass.getCanonicalName()));
    }
        ...
        for (Method method : methodsFromModule) {
            ...
            if (reactMethod != null || Intrinsics.areEqual("getConstants", name2)) {
                if (hashSet.contains(name2)) {
                    throw new ParsingException(name, e.l("Module exports two methods to JavaScript with the same name: \"", name2));
                }
                ...
                if (Intrinsics.areEqual("getConstants", name2)) {
                    ...
                    Class cls = Void.TYPE;
                    if ((zIsBlockingSynchronousMethod && Intrinsics.areEqual(returnType, cls)) || (!reactMethod.isBlockingSynchronousMethod() && !Intrinsics.areEqual(returnType, cls))) {
    ...
    public static final class ParsingException extends RuntimeException {
        ...
        public ParsingException(@NotNull String moduleName, @NotNull String message) {
            super(e.o(new StringBuilder("Unable to parse @ReactMethod annotations from native module: "), moduleName, ". Details: ", message));
        ...
        public ParsingException(@NotNull String moduleName, @NotNull String methodName, @NotNull String message) {
            ...
            Intrinsics.checkNotNullParameter(methodName, "methodName");
            Intrinsics.checkNotNullParameter(message, "message");
            StringBuilder sb2 = new StringBuilder("Unable to parse @ReactMethod annotation from native module method: ");
            e.A(sb2, moduleName, ".", methodName, "(). Details: ");
            sb2.append(message);
            super(sb2.toString());
        }
    }
