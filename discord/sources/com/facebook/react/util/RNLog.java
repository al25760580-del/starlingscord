...
public final class RNLog {
    ...
    public static final void a(@NotNull String message) {
        ...
        a.v(ReactConstants.TAG, "(ADVICE)" + message);
    }

    public static final void e(ReactContext context, @NotNull String message) {
        Intrinsics.checkNotNullParameter(message, "message");
        INSTANCE.logInternal(context, message, 6);
        a.g(ReactConstants.TAG, message);
    }
    ...
    public static final void w(ReactContext context, @NotNull String message) {
        Intrinsics.checkNotNullParameter(message, "message");
        INSTANCE.logInternal(context, message, 5);
        a.v(ReactConstants.TAG, message);
    }
