...
public final class StateWrapperImpl extends HybridClassBase implements ReferenceStateWrapper {
    ...
    public ReadableNativeMap getStateData() {
        ...
        o8.a.g(TAG, "Race between StateWrapperImpl destruction and getState");
        return null;
    }
    ...
    public void updateState(@NotNull WritableMap map) {
        ...
        if (isValid()) {
            ...
            o8.a.g(TAG, "Race between StateWrapperImpl destruction and updateState");
        }
    }

    public final native void updateStateImpl(@NotNull NativeMap map);
}
