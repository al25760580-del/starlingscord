...
public final class DevToolsReactPerfLogger implements ReactMarker.FabricMarkerListener {
    ...
    public static final class FabricCommitPoint {
        ...
        public FabricCommitPoint(int i7) {
    ...
    public static final class FabricCommitPointData {
        ...
        public FabricCommitPointData(long j, int i7) {
            this.timeStamp = j;
            this.counter = i7;
        }
    ...
    public void logFabricMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey, long timestamp) {
    ...
    @Override // com.facebook.react.bridge.ReactMarker.FabricMarkerListener
    public void logFabricMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey, long timestamp, int counter) {
        Intrinsics.checkNotNullParameter(name, "name");
        if (Companion.isFabricCommitMarker(name)) {
            ...
            if ((name == ReactMarkerConstants.FABRIC_BATCH_EXECUTION_END || name == ReactMarkerConstants.FABRIC_UPDATE_UI_MAIN_THREAD_END) && timestamp > 0) {
