...
public final class FabricUIManagerBinding extends HybridClassBase {
    ...
    public final void register(@NotNull RuntimeExecutor runtimeExecutor, @NotNull RuntimeScheduler runtimeScheduler, @NotNull FabricUIManager fabricUIManager, @NotNull EventBeatManager eventBeatManager, @NotNull ComponentFactory componentFactory, @NotNull AnimationBackendChoreographer animationBackendChoreographer) {
        ...
        animationBackendChoreographer.setFrameCallback(new AnimationFrameCallback() { // from class: com.facebook.react.fabric.c
            @Override // com.facebook.react.fabric.AnimationFrameCallback
            public final void onAnimationFrame(double d6) {
                this.f5222a.driveAnimationBackend(d6);
            }
        });
    ...
    public final native void setAnimationBackendChoreographer(@NotNull AnimationBackendChoreographer animationBackendChoreographer);
    ...
    public final native void startSurface(int surfaceId, @NotNull String moduleName, NativeMap initialProps);

    public final native void startSurfaceWithConstraints(int surfaceId, @NotNull String moduleName, NativeMap initialProps, float minWidth, float maxWidth, float minHeight, float maxHeight, float offsetX, float offsetY, boolean isRTL, boolean doLeftAndRightSwapInRTL);
