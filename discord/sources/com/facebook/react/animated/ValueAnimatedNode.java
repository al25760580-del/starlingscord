...
public class ValueAnimatedNode extends AnimatedNode {
    ...
    public final void onValueUpdate() {
        ...
        if (animatedNodeValueListener != null) {
            ...
            animatedNodeValueListener.onValueUpdate(value - d6, d6);
        }
    }
    ...
    public /* synthetic */ ValueAnimatedNode(ReadableMap readableMap, int i7, DefaultConstructorMarker defaultConstructorMarker) {
