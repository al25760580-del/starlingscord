...
public final class DiffClampAnimatedNode extends ValueAnimatedNode {
    ...
    public String prettyPrint$ReactAndroid_release() {
        int i7 = this.tag;
        int i10 = this.inputNodeTag;
        double d6 = this.minValue;
        double d7 = this.maxValue;
        double d8 = this.lastValue;
        String strPrettyPrint$ReactAndroid_release = super.prettyPrint$ReactAndroid_release();
        StringBuilder sbR = e.r(i7, "DiffClampAnimatedNode[", i10, "]: InputNodeTag: ", " min: ");
        sbR.append(d6);
        sbR.append(" max: ");
        sbR.append(d7);
        sbR.append(" lastValue: ");
        sbR.append(d8);
        sbR.append(" super: ");
        sbR.append(strPrettyPrint$ReactAndroid_release);
        return sbR.toString();
    }
    ...
    public void update$ReactAndroid_release() {
        ...
        double d6 = inputNodeValue - this.lastValue;
        this.lastValue = inputNodeValue;
        this.nodeValue = Math.min(Math.max(this.nodeValue + d6, this.minValue), this.maxValue);
    }
}
