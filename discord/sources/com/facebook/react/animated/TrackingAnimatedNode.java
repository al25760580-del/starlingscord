...
public final class TrackingAnimatedNode extends AnimatedNode {
    ...
    public String prettyPrint$ReactAndroid_release() {
        int i7 = this.tag;
        int i10 = this.animationId;
        int i11 = this.toValueNode;
        int i12 = this.valueNode;
        JavaOnlyMap javaOnlyMap = this.animationConfig;
        StringBuilder sbR = e.r(i7, "TrackingAnimatedNode[", i10, "]: animationID: ", " toValueNode: ");
        e.z(sbR, i11, " valueNode: ", i12, " animationConfig: ");
