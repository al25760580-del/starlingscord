...
public abstract class AnimatedNode {
    ...
    public final String prettyPrintWithChildren$ReactAndroid_release() {
        ...
        String strO = list != null ? CollectionsKt.O(list, " ", null, null, null, 62) : null;
        return b.j(prettyPrint$ReactAndroid_release(), (strO == null || StringsKt.K(strO)) ? "" : " children: ".concat(strO));
    }
