...
public final class ColorAnimatedNode extends AnimatedNode implements AnimatedNodeWithUpdateableConfig {
    ...
    public String prettyPrint$ReactAndroid_release() {
        int i7 = this.tag;
        int i10 = this.rNodeId;
        int i11 = this.gNodeId;
        int i12 = this.bNodeId;
        int i13 = this.aNodeId;
        StringBuilder sbR = e.r(i7, "ColorAnimatedNode[", i10, "]: r: ", "  g: ");
        e.z(sbR, i11, " b: ", i12, " a: ");
        sbR.append(i13);
        return sbR.toString();
    }
