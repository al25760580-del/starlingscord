...
public class VirtualViewManagerDelegate<T extends View, U extends BaseViewManager<T, ? extends LayoutShadowNode> & VirtualViewManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
    ...
    public void kotlinCompat$setProperty(T t5, String str, Object obj) {
        ...
        switch (str) {
            case "renderState":
                ((VirtualViewManagerInterface) this.mViewManager).setRenderState(t5, obj != null ? ((Double) obj).intValue() : 0);
                break;
            case "initialHidden":
                ((VirtualViewManagerInterface) this.mViewManager).setInitialHidden(t5, obj != null ? ((Boolean) obj).booleanValue() : false);
                break;
            case "removeClippedSubviews":
                ((VirtualViewManagerInterface) this.mViewManager).setRemoveClippedSubviews(t5, obj != null ? ((Boolean) obj).booleanValue() : false);
                break;
            default:
