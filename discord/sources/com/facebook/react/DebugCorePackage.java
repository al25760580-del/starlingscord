...
public final class DebugCorePackage extends BaseReactPackage implements ViewManagerOnDemandReactPackage {
    ...
    @NotNull
    private final Lazy viewManagersMap = l.a(m.f19487i, new com.discord.sticker.sticker_types.c(6));
    ...
    public static final Map viewManagersMap_delegate$lambda$1() {
        return v0.b(new Pair(DebuggingOverlayManager.REACT_CLASS, ModuleSpec.INSTANCE.viewManagerSpec(new a(0))));
    }
    ...
    public List<ModuleSpec> getViewManagers(@NotNull ReactApplicationContext reactContext) {
        Intrinsics.checkNotNullParameter(reactContext, "reactContext");
        return CollectionsKt.i0(getViewManagersMap().values());
    }
}
