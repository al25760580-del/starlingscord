...
public final class WritableMapBuffer implements MapBuffer {
    ...
    public final class MapBufferEntry implements MapBuffer.Entry {
        ...
        public MapBufferEntry(int i7) {
            this.index = i7;
            this.key = WritableMapBuffer.this.values.keyAt(i7);
            Object objValueAt = WritableMapBuffer.this.values.valueAt(i7);
    ...
    public static final class AnonymousClass1 implements Iterator<MapBuffer.Entry>, KMappedMarker {
        ...
        public MapBuffer.Entry next() {
            ...
            int i7 = this.count;
            this.count = i7 + 1;
            return writableMapBuffer.new MapBufferEntry(i7);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final MapBuffer.DataType dataType(Object obj, int i7) {
        ...
        throw new IllegalStateException("Key " + i7 + " has value of unknown type: " + obj.getClass());
    }
    ...
    private final Object[] getValues() {
        ...
        for (int i7 = 0; i7 < size; i7++) {
            Object objValueAt = this.values.valueAt(i7);
            Intrinsics.checkNotNullExpressionValue(objValueAt, "valueAt(...)");
            objArr[i7] = objValueAt;
        }
        return objArr;
    }
    ...
    private final WritableMapBuffer putInternal(int key, Object value) {
        ...
        if (key > kEY_RANGE$ReactAndroid_release.f14689e || i7 > key) {
