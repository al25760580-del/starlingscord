...
public final class ShakeDetector implements SensorEventListener {
    ...
    public void onSensorChanged(@NotNull SensorEvent sensorEvent) {
        ...
        } else if (atLeastRequiredForce(f7) && this.accelerationY * f7 <= 0.0f) {
            recordShake(sensorEvent.timestamp);
            this.accelerationY = f7;
        } else if (atLeastRequiredForce(f10) && this.accelerationZ * f10 <= 0.0f) {
            recordShake(sensorEvent.timestamp);
            this.accelerationZ = f10;
        }
    ...
    public ShakeDetector(@NotNull ShakeListener shakeListener, int i7) {
        Intrinsics.checkNotNullParameter(shakeListener, "shakeListener");
        this.shakeListener = shakeListener;
        this.minNumShakes = i7;
    }

    public /* synthetic */ ShakeDetector(ShakeListener shakeListener, int i7, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(shakeListener, (i10 & 2) != 0 ? 1 : i7);
    }
}
