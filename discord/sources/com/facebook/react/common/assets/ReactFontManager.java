...
public final class ReactFontManager {
    ...
    @Metadata(d1 = {"\u0000<\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\b\u0010\f\u001a\u00020\u000bH\u0007J\"\u0010\u0015\u001a\u00020\u00102\u0006\u0010\u0016\u001a\u00020\u00062\u0006\u0010\u0017\u001a\u00020\u00182\b\u0010\u0019\u001a\u0004\u0018\u00010\u001aH\u0002R\u0016\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\u0007R\u0016\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005X\u0082\u0004¢\u0006\u0004\n\u0002\u0010\u0007R\u000e\u0010\t\u001a\u00020\u0006X\u0082T¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u0004¢\u0006\u0002\n\u0000R(\u0010\r\u001a\u0010\u0012\u0004\u0012\u00020\u000f\u0012\u0004\u0012\u00020\u0010\u0018\u00010\u000eX\u0086\u000e¢\u0006\u000e\n\u0000\u001a\u0004\b\u0011\u0010\u0012\"\u0004\b\u0013\u0010\u0014¨\u0006\u001b"}, d2 = {"Lcom/facebook/react/common/assets/ReactFontManager$Companion;", "", "<init>", "()V", "EXTENSIONS", "", "", "[Ljava/lang/String;", "FILE_EXTENSIONS", "FONTS_ASSET_PATH", "_instance", "Lcom/facebook/react/common/assets/ReactFontManager;", "getInstance", "createAssetTypefaceOverride", "Landroidx/arch/core/util/Function;", "Lcom/facebook/react/common/assets/CreateTypefaceObject;", "Landroid/graphics/Typeface;", "getCreateAssetTypefaceOverride", "()Landroidx/arch/core/util/Function;", "setCreateAssetTypefaceOverride", "(Landroidx/arch/core/util/Function;)V", "createAssetTypeface", "fontFamilyName", "style", "", "assetManager", "Landroid/content/res/AssetManager;", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
        ...
        public final Typeface createAssetTypeface(String fontFamilyName, int style, AssetManager assetManager) {
            if (assetManager != null) {
                ...
                if (createAssetTypefaceOverride != null) {
                    Object objApply = createAssetTypefaceOverride.apply(new CreateTypefaceObject(fontFamilyName, style, assetManager));
                    Intrinsics.checkNotNullExpressionValue(objApply, "apply(...)");
                    return (Typeface) objApply;
                }
                String str = ReactFontManager.EXTENSIONS[style];
                for (String str2 : ReactFontManager.FILE_EXTENSIONS) {
                    try {
                        Typeface typefaceCreateFromAsset = Typeface.createFromAsset(assetManager, e.m(ReactFontManager.FONTS_ASSET_PATH, fontFamilyName, str, str2));
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u0000 \u00102\u00020\u0001:\u0001\u0010B\u0019\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0004\b\u0006\u0010\u0007B\u001b\b\u0017\u0012\u0006\u0010\b\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0006\u0010\tJ\u0010\u0010\r\u001a\u00020\u000e2\b\u0010\u000f\u001a\u0004\u0018\u00010\u000eR\u000e\u0010\u0004\u001a\u00020\u0005X\u0082\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\n\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u000b\u0010\f¨\u0006\u0011"}, d2 = {"Lcom/facebook/react/common/assets/ReactFontManager$TypefaceStyle;", "", "weight", "", Fonts.Font.STYLE_ITALIC, "", "<init>", "(IZ)V", "style", "(II)V", "nearestStyle", "getNearestStyle", "()I", "apply", "Landroid/graphics/Typeface;", "typeface", "Companion", "ReactAndroid_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    public static final class TypefaceStyle {
        ...
        public TypefaceStyle(int i7, boolean z5) {
            this.italic = z5;
            this.weight = i7 == -1 ? NORMAL : i7;
        }

        public /* synthetic */ TypefaceStyle(int i7, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
            this(i7, (i11 & 2) != 0 ? -1 : i10);
        }

        public TypefaceStyle(int i7, int i10) {
            i7 = i7 == -1 ? 0 : i7;
            this.italic = (i7 & 2) != 0;
            this.weight = i10 == -1 ? (i7 & 1) != 0 ? BOLD : NORMAL : i10;
        }
    }
    ...
    public final void addCustomFont(@NotNull Context context, @NotNull String fontFamily, int fontId) {
        ...
        addCustomFont(fontFamily, context.isRestricted() ? null : n.a(context, fontId, new TypedValue(), 0, null, false, false));
    }

    @NotNull
    public final Set<String> getCustomFontFamilies() {
        return CollectionsKt.l0(this.customTypefaceCache.keySet());
    }

    @NotNull
    public final Typeface getTypeface(@NotNull String fontFamilyName, int style, AssetManager assetManager) {
        Intrinsics.checkNotNullParameter(fontFamilyName, "fontFamilyName");
        return getTypeface(fontFamilyName, new TypefaceStyle(style, 0, 2, null), assetManager);
    }

    public final void setTypeface(@NotNull String fontFamilyName, int style, Typeface typeface) {
        Intrinsics.checkNotNullParameter(fontFamilyName, "fontFamilyName");
        if (typeface != null) {
    ...
    @NotNull
    public final Typeface getTypeface(@NotNull String fontFamilyName, int weight, boolean italic, AssetManager assetManager) {
        Intrinsics.checkNotNullParameter(fontFamilyName, "fontFamilyName");
        return getTypeface(fontFamilyName, new TypefaceStyle(weight, italic), assetManager);
    }

    @NotNull
    public final Typeface getTypeface(@NotNull String fontFamilyName, int style, int weight, AssetManager assetManager) {
        Intrinsics.checkNotNullParameter(fontFamilyName, "fontFamilyName");
        return getTypeface(fontFamilyName, new TypefaceStyle(style, weight), assetManager);
    }

    @NotNull
    public final Typeface getTypeface(@NotNull String fontFamilyName, @NotNull TypefaceStyle typefaceStyle, AssetManager assetManager) {
        Intrinsics.checkNotNullParameter(fontFamilyName, "fontFamilyName");
    ...
    public final void addCustomFont(@NotNull String fontFamily, Typeface font) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        if (font != null) {
