...
public final class ReactSwitchManager extends BaseViewManager<ReactSwitch, LayoutShadowNode> implements AndroidSwitchManagerInterface<ReactSwitch> {
    ...
    public static final void ON_CHECKED_CHANGE_LISTENER$lambda$2(CompoundButton buttonView, boolean z5) {
        ...
        if (eventDispatcher != null) {
            eventDispatcher.dispatchEvent(new ReactSwitchEvent(UIManagerHelper.getSurfaceId(reactContext), id2, z5));
        }
    }
    ...
    public long measure(@NotNull Context context, ReadableMap localData, ReadableMap props, ReadableMap state, float width, @NotNull YogaMeasureMode widthMode, float height, @NotNull YogaMeasureMode heightMode, float[] attachmentsPositions) {
        ...
        return zs.a.I(PixelUtil.toDIPFromPixel(reactSwitch.getMeasuredWidth()), PixelUtil.toDIPFromPixel(reactSwitch.getMeasuredHeight()));
    }
    ...
    public void setThumbColor(@NotNull ReactSwitch view, Integer value) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public void setThumbTintColor(@NotNull ReactSwitch view, Integer value) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public void setTrackColorForFalse(@NotNull ReactSwitch view, Integer value) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public void setTrackColorForTrue(@NotNull ReactSwitch view, Integer value) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public void setTrackTintColor(@NotNull ReactSwitch view, Integer value) {
        Intrinsics.checkNotNullParameter(view, "view");
