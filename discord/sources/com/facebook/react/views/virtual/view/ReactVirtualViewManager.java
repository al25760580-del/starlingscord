...
public final class ReactVirtualViewManager extends ReactClippingViewManager<ReactVirtualView> implements VirtualViewManagerInterface<ReactVirtualView> {
    ...
    public /* bridge */ /* synthetic */ void setRemoveClippedSubviews(View view, boolean z5) {
        setRemoveClippedSubviews((ReactViewGroup) view, z5);
    }
    ...
    public void setNativeId(@NotNull ReactVirtualView view, String nativeId) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public void setRenderState(@NotNull ReactVirtualView view, int value) {
        ...
        Intrinsics.checkNotNullParameter(view, "view");
        if (value != 1) {
            virtualViewRenderState = value != 2 ? VirtualViewRenderState.Unknown : VirtualViewRenderState.None;
        } else {
