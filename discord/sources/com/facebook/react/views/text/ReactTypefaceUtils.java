...
public final class ReactTypefaceUtils {
    ...
    @NotNull
    public static final Typeface applyStyles(Typeface typeface, int style, int weight, String fontFamilyName, @NotNull AssetManager assetManager) {
    ...
    public static final int parseFontStyle(String fontStyleString) {
        if (Intrinsics.areEqual(fontStyleString, Fonts.Font.STYLE_ITALIC)) {
            return 2;
        }
    ...
    public static final String parseFontVariant(ReadableArray fontVariantArray) {
        ...
        for (int i7 = 0; i7 < size; i7++) {
            String string = fontVariantArray.getString(i7);
            if (string != null) {
        ...
        switch (fontWeightString.hashCode()) {
            ...
            case 49586:
                if (fontWeightString.equals("200")) {
                    return h0.DEFAULT_DRAG_ANIMATION_DURATION;
                }
                return -1;
            case 50547:
            ...
            case 54391:
                if (fontWeightString.equals("700")) {
                    return com.facebook.react.common.assets.ReactFontManager.TypefaceStyle.BOLD;
                }
                return -1;
            case 55352:
