...
public final class CustomStyleSpan extends MetricAffectingSpan implements ReactSpan {
    ...
    public CustomStyleSpan(int i7, int i10, String str, String str2, @NotNull AssetManager assetManager) {
        Intrinsics.checkNotNullParameter(assetManager, "assetManager");
        this.privateStyle = i7;
        this.privateWeight = i10;
    ...
    public final int getWeight() {
        int i7 = this.privateWeight;
        return i7 == -1 ? ReactFontManager.TypefaceStyle.NORMAL : i7;
    }

    @Override // android.text.style.CharacterStyle
    public void updateDrawState(@NotNull TextPaint ds2) {
        Intrinsics.checkNotNullParameter(ds2, "ds");
        INSTANCE.apply(ds2, this.privateStyle, this.privateWeight, this.fontFeatureSettings, this.fontFamily, this.assetManager);
    }
