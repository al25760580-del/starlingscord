...
public final class ReactLinkSpan extends ClickableSpan implements ReactSpan {
    ...
    public ReactLinkSpan(int i7) {
        this.fragmentIndex = i7;
    }
    ...
    public void onClick(@NotNull View view) {
        ...
        int i7 = preparedLayout.getReactTags()[this.fragmentIndex];
        EventDispatcher eventDispatcher = UIManagerHelper.getEventDispatcher(reactContext);
        if (eventDispatcher != null) {
            eventDispatcher.dispatchEvent(new ViewGroupClickEvent(UIManagerHelper.getSurfaceId(reactContext), i7));
        }
    }
