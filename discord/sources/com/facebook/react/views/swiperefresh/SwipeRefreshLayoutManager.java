...
public class SwipeRefreshLayoutManager extends ViewGroupManager<ReactSwipeRefreshLayout> implements AndroidSwipeRefreshLayoutManagerInterface<ReactSwipeRefreshLayout> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(w0.h(new Pair("topRefresh", w0.h(new Pair("registrationName", "onRefresh")))));
    ...
    public Map<String, Object> getExportedViewConstants() {
        return w0.h(new Pair("SIZE", w0.h(new Pair("DEFAULT", 1), new Pair("LARGE", 0))));
    }
    ...
    @Override // com.facebook.react.uimanager.BaseViewManager, com.facebook.react.uimanager.ViewManager
    public void addEventEmitters(@NotNull ThemedReactContext reactContext, @NotNull ReactSwipeRefreshLayout view) {
        Intrinsics.checkNotNullParameter(reactContext, "reactContext");
        Intrinsics.checkNotNullParameter(view, "view");
        view.setOnRefreshListener(new i(8, reactContext, view));
    }
    ...
    public void setColors(@NotNull ReactSwipeRefreshLayout view, ReadableArray value) {
        Intrinsics.checkNotNullParameter(view, "view");
        if (value == null) {
        ...
        for (int i7 = 0; i7 < size2; i7++) {
            if (value.getType(i7) == ReadableType.Map) {
                ReadableMap map = value.getMap(i7);
                Context context = view.getContext();
                Intrinsics.checkNotNullExpressionValue(context, "getContext(...)");
                iArr[i7] = ColorPropConverter.getColor(map, context, 0);
            } else {
                iArr[i7] = value.getInt(i7);
            }
        }
    ...
    public void setProgressBackgroundColor(@NotNull ReactSwipeRefreshLayout view, Integer value) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    @Override // com.facebook.react.viewmanagers.AndroidSwipeRefreshLayoutManagerInterface
    public void setSize(@NotNull ReactSwipeRefreshLayout view, String value) {
        Intrinsics.checkNotNullParameter(view, "view");
        if (value != null && !value.equals("default")) {
            ...
            throw new IllegalArgumentException("Size must be 'default' or 'large', received: ".concat(value));
        }
        view.setSize(1);
    }
