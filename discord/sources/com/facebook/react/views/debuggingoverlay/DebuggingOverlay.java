...
public final class DebuggingOverlay extends View {
    ...
    public static final void onDraw$lambda$1(DebuggingOverlay debuggingOverlay, int i7) {
        debuggingOverlay.traceUpdatesToDisplayMap.remove(Integer.valueOf(i7));
        debuggingOverlay.traceUpdateIdToCleanupRunnableMap.remove(Integer.valueOf(i7));
    ...
    public void onDraw(@NotNull Canvas canvas) {
        ...
        for (TraceUpdate traceUpdate : this.traceUpdatesToDisplayMap.values()) {
            ...
            int id2 = traceUpdate2.getId();
            l lVar = new l(id2, 5, this);
            if (!this.traceUpdateIdToCleanupRunnableMap.containsKey(Integer.valueOf(id2))) {
                this.traceUpdateIdToCleanupRunnableMap.put(Integer.valueOf(id2), lVar);
                UiThreadUtil.runOnUiThread(lVar, 2000L);
            }
        }
