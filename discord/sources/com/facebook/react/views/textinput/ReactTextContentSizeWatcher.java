...
public final class ReactTextContentSizeWatcher implements ContentSizeWatcher {
    ...
    public void onLayout() {
        ...
        if (this.editText.getLayout() != null) {
            width = this.editText.getCompoundPaddingRight() + this.editText.getLayout().getWidth() + this.editText.getCompoundPaddingLeft();
            height = this.editText.getCompoundPaddingBottom() + this.editText.getLayout().getHeight() + this.editText.getCompoundPaddingTop();
        }
