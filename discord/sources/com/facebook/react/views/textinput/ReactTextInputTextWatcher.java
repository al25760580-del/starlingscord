...
public final class ReactTextInputTextWatcher implements TextWatcher {
    ...
    public void onTextChanged(@NotNull CharSequence s2, int start, int before, int count) {
        ...
        String strSubstring = s2.toString().substring(start, start + count);
        ...
        if (eventDispatcher != null) {
            eventDispatcher.dispatchEvent(new ReactTextChangedEvent(this.surfaceId, this.editText.getId(), s2.toString(), this.editText.incrementAndGetEventCounter(), this.editText.getSelectionStart(), this.editText.getSelectionEnd()));
        }
    }
}
