...
public final class ReactScrollViewCommandHelper {
    ...
    public static final class Companion {
        ...
        public final Map<String, Integer> getCommandsMap() {
            return w0.f(new Pair("scrollTo", 1), new Pair("scrollToEnd", 2), new Pair("flashScrollIndicators", 3));
        }

        public final <T> void receiveCommand(@NotNull ScrollCommandHandler<T> viewManager, T scrollView, int commandType, ReadableArray args) {
        ...
        public final <T> void receiveCommand(@NotNull ScrollCommandHandler<T> viewManager, T scrollView, @NotNull String commandType, ReadableArray args) {
            Intrinsics.checkNotNullParameter(viewManager, "viewManager");
            ...
            if (scrollView != null) {
                ...
                throw new IllegalArgumentException(g.f("Unsupported command ", commandType, " received by ", viewManager.getClass().getSimpleName(), "."));
            }
            throw new IllegalStateException("Required value was null.");
        }
    }
    ...
    public static final class ScrollToCommandData {
        ...
        public ScrollToCommandData(int i7, int i10, boolean z5) {
            this.mDestX = i7;
            this.mDestY = i10;
            this.mAnimated = z5;
        }
    ...
    public static final class ScrollToEndCommandData {
        ...
        public ScrollToEndCommandData(boolean z5) {
            this.mAnimated = z5;
        }
    }
    ...
    public static final <T> void receiveCommand(@NotNull ScrollCommandHandler<T> scrollCommandHandler, T t5, int i7, ReadableArray readableArray) {
        INSTANCE.receiveCommand(scrollCommandHandler, t5, i7, readableArray);
    }

    public static final <T> void receiveCommand(@NotNull ScrollCommandHandler<T> scrollCommandHandler, T t5, @NotNull String str, ReadableArray readableArray) {
        INSTANCE.receiveCommand(scrollCommandHandler, t5, str, readableArray);
    }
}
