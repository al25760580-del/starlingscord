...
public class ReactViewManager extends ReactClippingViewManager<ReactViewGroup> {
    ...
    public static final void setFocusable$lambda$3(ReactViewGroup reactViewGroup, View view) {
    ...
    public Map<String, Integer> getCommandsMap() {
        return w0.h(new Pair(HOTSPOT_UPDATE_KEY, 1), new Pair("setPressed", 2));
    }
    ...
    public void setAccessibilityOrder(@NotNull ReactViewGroup view, ReadableArray nativeIds) {
        Intrinsics.checkNotNullParameter(view, "view");
        if (ReactNativeFeatureFlags.enableAccessibilityOrder()) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                String string = nativeIds.getString(i10);
                if (string != null) {
    ...
    public void setBackgroundImage(@NotNull ReactViewGroup view, ReadableArray backgroundImage) {
        Intrinsics.checkNotNullParameter(view, "view");
        ...
        for (int i7 = 0; i7 < size; i7++) {
            ReadableMap map = backgroundImage.getMap(i7);
    ...
    public void setBackgroundPosition(@NotNull ReactViewGroup view, ReadableArray backgroundPosition) {
        Intrinsics.checkNotNullParameter(view, "view");
        ...
        for (int i7 = 0; i7 < size; i7++) {
            BackgroundPosition backgroundPosition2 = BackgroundPosition.INSTANCE.parse(backgroundPosition.getMap(i7));
            if (backgroundPosition2 != null) {
                arrayList.add(backgroundPosition2);
            }
        }
        BackgroundStyleApplicator.setBackgroundPosition$ReactAndroid_release(view, arrayList.isEmpty() ? null : arrayList);
    }

    @ReactProp(customType = "BackgroundRepeat", name = ViewProps.BACKGROUND_REPEAT)
    public void setBackgroundRepeat(@NotNull ReactViewGroup view, ReadableArray backgroundRepeat) {
        Intrinsics.checkNotNullParameter(view, "view");
        ...
        for (int i7 = 0; i7 < size; i7++) {
            BackgroundRepeat backgroundRepeat2 = BackgroundRepeat.INSTANCE.parse(backgroundRepeat.getMap(i7));
            if (backgroundRepeat2 != null) {
                arrayList.add(backgroundRepeat2);
            }
        }
        BackgroundStyleApplicator.setBackgroundRepeat$ReactAndroid_release(view, arrayList.isEmpty() ? null : arrayList);
    }

    @ReactProp(customType = "BackgroundSize", name = ViewProps.BACKGROUND_SIZE)
    public void setBackgroundSize(@NotNull ReactViewGroup view, ReadableArray backgroundSize) {
        Intrinsics.checkNotNullParameter(view, "view");
        ...
        for (int i7 = 0; i7 < size; i7++) {
            BackgroundSize backgroundSize2 = BackgroundSize.INSTANCE.parse(backgroundSize.getDynamic(i7));
            if (backgroundSize2 != null) {
                arrayList.add(backgroundSize2);
            }
        }
        BackgroundStyleApplicator.setBackgroundSize$ReactAndroid_release(view, arrayList.isEmpty() ? null : arrayList);
    }
    ...
    public void setBorderColor(@NotNull ReactViewGroup view, int index, Integer color) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public void setBorderRadius(@NotNull ReactViewGroup view, int index, @NotNull Dynamic rawBorderRadius) {
        ...
        BackgroundStyleApplicator.setBorderRadius(view, BorderRadiusProp.values()[index], LengthPercentage.Companion.setFromDynamic$default(LengthPercentage.INSTANCE, rawBorderRadius, false, 2, null));
    }

    @ReactProp(name = "borderStyle")
    public void setBorderStyle(@NotNull ReactViewGroup view, String borderStyle) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public void setFocusable(@NotNull ReactViewGroup view, boolean focusable) {
        Intrinsics.checkNotNullParameter(view, "view");
        if (focusable) {
            view.setOnClickListener(new com.discord.chat.presentation.list.delegate.b(4, view));
    ...
    public void setHitSlop(@NotNull ReactViewGroup view, @NotNull Dynamic hitSlop) {
        ...
        int i7 = WhenMappings.$EnumSwitchMapping$0[hitSlop.getType().ordinal()];
        if (i7 == 1) {
        ...
        if (i7 == 2) {
            ...
            o8.a.v(ReactConstants.TAG, "Invalid type for 'hitSlop' value " + hitSlop.getType());
            view.setHitSlopRect(null);
        }
    }

    @ReactProp(name = "nativeBackgroundAndroid")
    public void setNativeBackground(@NotNull ReactViewGroup view, ReadableMap background) {
        Intrinsics.checkNotNullParameter(view, "view");
        view.applyNativeBackground$ReactAndroid_release(background);
    }

    @ReactProp(name = "nativeForegroundAndroid")
    public void setNativeForeground(@NotNull ReactViewGroup view, ReadableMap foreground) {
        Intrinsics.checkNotNullParameter(view, "view");
        view.applyNativeForeground$ReactAndroid_release(foreground);
    }
    ...
    public void setOverflow(@NotNull ReactViewGroup view, String overflow) {
        Intrinsics.checkNotNullParameter(view, "view");
        view.setOverflow(overflow);
    }

    @ReactProp(name = ViewProps.POINTER_EVENTS)
    public void setPointerEvents(@NotNull ReactViewGroup view, String pointerEventsStr) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public void setPreventClipping(@NotNull ReactViewGroup view, boolean preventClipping) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    @Override // com.facebook.react.uimanager.BaseViewManager
    public void setTransformProperty(@NotNull ReactViewGroup view, ReadableArray transforms, ReadableArray transformOrigin) {
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    @Override // com.facebook.react.uimanager.ViewManager
    @d
    public void receiveCommand(@NotNull ReactViewGroup root, int commandId, ReadableArray args) {
