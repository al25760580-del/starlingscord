...
public final class ColorUtil {
    ...
    private final int clamp255(double value) {
        return Math.max(0, Math.min(255, c.a(value)));
    }

    public static final int normalize(double r5, double g6, double b10, double a10) {
        ColorUtil colorUtil = INSTANCE;
        return (colorUtil.clamp255(r5) << 16) | (colorUtil.clamp255(a10 * ((double) 255)) << 24) | (colorUtil.clamp255(g6) << 8) | colorUtil.clamp255(b10);
    }
}
