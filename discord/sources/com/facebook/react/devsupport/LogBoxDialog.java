...
public final class LogBoxDialog extends Dialog {
    ...
    public static final WindowInsetsCompat onCreate$lambda$3$lambda$1(int i7, View view, WindowInsetsCompat windowInsets) {
        Intrinsics.checkNotNullParameter(view, "view");
        Intrinsics.checkNotNullParameter(windowInsets, "windowInsets");
        Insets insetsF = windowInsets.f1605a.f(i7);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final WindowInsetsCompat onCreate$lambda$3$lambda$2(Function2 function2, View p3, WindowInsetsCompat p5) {
        Intrinsics.checkNotNullParameter(p3, "p0");
        Intrinsics.checkNotNullParameter(p5, "p1");
        return (WindowInsetsCompat) function2.invoke(p3, p5);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (view != null) {
            final ar.s sVar = new ar.s(16);
            androidx.core.view.t tVar = new androidx.core.view.t() { // from class: com.facebook.react.devsupport.q
                @Override // androidx.core.view.t
                public final WindowInsetsCompat a(View view2, WindowInsetsCompat windowInsetsCompat) {
                    return LogBoxDialog.onCreate$lambda$3$lambda$2(sVar, view2, windowInsetsCompat);
                }
            };
