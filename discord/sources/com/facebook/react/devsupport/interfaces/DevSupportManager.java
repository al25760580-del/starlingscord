...
public interface DevSupportManager extends JSExceptionHandler {
    ...
    static /* synthetic */ void openDebugger$default(DevSupportManager devSupportManager, String str, int i7, Object obj) {
        if (obj != null) {
    ...
    boolean getIsDevSupportEnabled();
    ...
    default void setDevMenuEnabled(boolean z5) {
    }

    void setDevSupportEnabled(boolean z5);
    ...
    default void setKeyboardShortcutsEnabled(boolean z5) {
    }

    void setPackagerLocationCustomizer(@NotNull PackagerLocationCustomizer packagerLocationCustomizer);

    default void setShakeGestureEnabled(boolean z5) {
    }
    ...
    void showNewJavaError(String message, @NotNull Throwable e10);
