...
public interface RedBoxHandler {
    ...
    void handleRedbox(String title, @NotNull StackFrame[] stack, @NotNull ErrorType errorType);

    boolean isReportEnabled();

    void reportRedbox(@NotNull Context context, @NotNull String title, @NotNull StackFrame[] stack, @NotNull String sourceUrl, @NotNull ReportCompletedListener reportCompletedListener);
}
