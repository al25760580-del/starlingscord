...
public final class ChangeBundleLocationDialog {
    ...
    public final void show(@NotNull Context context, @NotNull DeveloperSettings devSettings, @NotNull ChangeBundleLocationDialogListener onClickListener) {
        ...
        int i7 = (int) (4 * context.getResources().getDisplayMetrics().density);
        ...
        final int i12 = 1;
        button2.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.react.devsupport.a
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                switch (i12) {
                    case 0:
        ...
        AlertDialog alertDialogCreate = new AlertDialog.Builder(context).setTitle(context.getString(R.string.catalyst_change_bundle_location)).setView(linearLayout).create();
        button3.setOnClickListener(new com.discord.chat.presentation.message.d(onClickListener, editText, alertDialogCreate, 6));
        button4.setOnClickListener(new b(0, alertDialogCreate));
