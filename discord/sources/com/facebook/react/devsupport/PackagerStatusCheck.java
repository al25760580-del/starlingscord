...
public final class PackagerStatusCheck {
    ...
    public static final class Companion {
        ...
        public final String createPackagerStatusURL(String host) {
            ...
            return a3.e.q(new Object[]{DevSupportHttpClient.INSTANCE.httpScheme$ReactAndroid_release(host), host}, 2, Locale.US, PackagerStatusCheck.PACKAGER_STATUS_URL_TEMPLATE, "format(...)");
        }
    ...
    public final void run(@NotNull String host, @NotNull final PackagerStatusCallback callback) {
        ...
        String strCreatePackagerStatusURL = Companion.createPackagerStatusURL(host);
        Request.Builder builder = new Request.Builder();
        builder.i(strCreatePackagerStatusURL);
        this.client.a(builder.b()).d(new cs.h() { // from class: com.facebook.react.devsupport.PackagerStatusCheck.run.1
            @Override // cs.h
            public void onFailure(Call call, IOException e10) {
                Intrinsics.checkNotNullParameter(call, "call");
                Intrinsics.checkNotNullParameter(e10, "e");
                o8.a.v(ReactConstants.TAG, "The packager does not seem to be running as we got an IOException requesting its status: " + e10.getMessage());
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (!response.g()) {
                    o8.a.g(ReactConstants.TAG, "Got non-success http code from packager when requesting status: " + response.f17382v);
                    callback.onPackagerStatusFetched(false);
                    return;
                }
                ResponseBody responseBody = response.f17385y;
                if (responseBody == null) {
                    o8.a.g(ReactConstants.TAG, "Got null body response from packager when requesting status");
                    callback.onPackagerStatusFetched(false);
                    return;
                }
                ...
                o8.a.g(ReactConstants.TAG, "Got unexpected response from packager when requesting status: " + strString);
                callback.onPackagerStatusFetched(false);
            }
        });
    }
