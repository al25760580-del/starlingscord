...
public final class PerfMonitorOverlayManager implements PerfMonitorUpdateListener {
    ...
    public final void handleRecordingButtonPress() {
        int i7 = WhenMappings.$EnumSwitchMapping$0[this.tracingState.ordinal()];
        if (i7 == 1) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void onPerfIssueAdded$lambda$7(PerfMonitorOverlayManager perfMonitorOverlayManager) {
        perfMonitorOverlayManager.perfIssueCount--;
        UiThreadUtil.runOnUiThread(new a(perfMonitorOverlayManager, 2));
    }
    ...
    public final void disable() {
        this.enabled = false;
        UiThreadUtil.runOnUiThread(new a(this, 3));
    }
    ...
    public final void enable() {
        ...
        this.enabled = true;
        UiThreadUtil.runOnUiThread(new a(this, 4));
    }
    ...
    public void onPerfIssueAdded(@NotNull String name) {
        ...
        this.perfIssueCount++;
        UiThreadUtil.runOnUiThread(new a(this, 0));
        this.handler.postDelayed(new a(this, 1), PERF_ISSUE_EXPIRY_MS);
    }

    @Override // com.facebook.react.devsupport.perfmonitor.PerfMonitorUpdateListener
    public void onRecordingStateChanged(@NotNull TracingState state) {
        ...
        UiThreadUtil.runOnUiThread(new k(21, this, state));
    }
