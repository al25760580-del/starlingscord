...
public final class PerfMonitorOverlayView {
    ...
    public PerfMonitorOverlayView(@NotNull Context context, @NotNull Function0<Unit> onButtonPress) {
    ...
    private final Dialog createAnchoredDialog(float offsetX, final float offsetY) {
        ...
        if (window4 != null && (decorView = window4.getDecorView()) != null) {
            t tVar = new t() { // from class: com.facebook.react.devsupport.perfmonitor.b
    ...
    public static final WindowInsetsCompat createAnchoredDialog$lambda$16$lambda$15(float f2, Dialog dialog, View view, WindowInsetsCompat windowInsets) {
        Intrinsics.checkNotNullParameter(view, "view");
        Intrinsics.checkNotNullParameter(windowInsets, "windowInsets");
        Insets insetsF = windowInsets.f1605a.f(519);
        Intrinsics.checkNotNullExpressionValue(insetsF, "getInsets(...)");
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        Intrinsics.checkNotNull(layoutParams, "null cannot be cast to non-null type android.view.WindowManager.LayoutParams");
        WindowManager.LayoutParams layoutParams2 = (WindowManager.LayoutParams) layoutParams;
        layoutParams2.y = insetsF.f1557b + ((int) f2);
        Window window = dialog.getWindow();
        if (window != null) {
    ...
    private final Dialog createToolbarDialog() {
        ...
        if (drawable != null) {
            float f7 = ISSUE_ICON_SIZE;
            drawable.setBounds(0, 1, (int) dpToPx(f7), ((int) dpToPx(f7)) + 1);
        } else {
            drawable = null;
        }
        ...
        linearLayoutCreateInnerLayout.setOnClickListener(new com.discord.chat.presentation.list.delegate.b(3, this));
    ...
    public final float dpToPx(float dp2) {
        return PixelUtil.toPixelFromDIP(dp2);
    }
    ...
    public final void updateRecordingState(@NotNull TracingState state) {
