...
public final class PausedInDebuggerOverlayDialogManager implements PausedInDebuggerOverlayManager {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void showPausedInDebuggerOverlay$lambda$3(PausedInDebuggerOverlayDialogManager pausedInDebuggerOverlayDialogManager, String str, DevSupportManager.PausedInDebuggerOverlayCommandListener pausedInDebuggerOverlayCommandListener) {
        Dialog dialog = pausedInDebuggerOverlayDialogManager.pausedInDebuggerDialog;
        if (dialog != null) {
            dialog.dismiss();
        }
        ...
        viewInflate.findViewById(R.id.button).setOnClickListener(new b(1, pausedInDebuggerOverlayCommandListener));
    ...
    public void hidePausedInDebuggerOverlay() {
        UiThreadUtil.runOnUiThread(new f(2, this));
    }
    ...
    public void showPausedInDebuggerOverlay(@NotNull String message, @NotNull DevSupportManager.PausedInDebuggerOverlayCommandListener listener) {
        ...
        UiThreadUtil.runOnUiThread(new ac.a(this, message, listener, 11));
    }
}
