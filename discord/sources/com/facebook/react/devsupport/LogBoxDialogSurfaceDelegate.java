...
public final class LogBoxDialogSurfaceDelegate implements SurfaceDelegate {
    ...
    public static final void show$lambda$1$lambda$0(LogBoxDialogSurfaceDelegate logBoxDialogSurfaceDelegate, DialogInterface dialogInterface) {
        ReactContext currentReactContext = logBoxDialogSurfaceDelegate.devSupportManager.getCurrentReactContext();
        if (currentReactContext != null) {
            currentReactContext.emitDeviceEvent("hardwareBackPress");
        }
    }
    ...
    public void createContentView(@NotNull String appKey) {
        ...
        io.sentry.config.a.e(Intrinsics.areEqual(appKey, "LogBox"), "This surface manager can only create LogBox React application");
    ...
    public void show() {
        ...
        if (isContentViewReady()) {
            ...
            logBoxDialog.setCancelable(true);
            logBoxDialog.setCanceledOnTouchOutside(false);
            logBoxDialog.setOnCancelListener(new p(1, this));
            logBoxDialog.show();
        }
    }
}
