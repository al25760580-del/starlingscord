...
public interface IViewGroupManager<T extends View> extends IViewManagerWithChildren {
    void addView(@NotNull T parent, @NotNull View child, int index);

    View getChildAt(@NotNull T parent, int index);

    int getChildCount(@NotNull T parent);
    ...
    void removeViewAt(@NotNull T parent, int index);
}
