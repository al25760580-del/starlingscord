...
public final class ReactStylesDiffMap {
    ...
    public final boolean getBoolean(@NotNull String name, boolean z5) {
        Intrinsics.checkNotNullParameter(name, "name");
        return this.backingMap.isNull(name) ? z5 : this.backingMap.getBoolean(name);
    }

    public final double getDouble(@NotNull String name, double d6) {
        Intrinsics.checkNotNullParameter(name, "name");
        return this.backingMap.isNull(name) ? d6 : this.backingMap.getDouble(name);
    }
    ...
    public final float getFloat(@NotNull String name, float f2) {
        Intrinsics.checkNotNullParameter(name, "name");
        return this.backingMap.isNull(name) ? f2 : (float) this.backingMap.getDouble(name);
    }

    public final int getInt(@NotNull String name, int i7) {
        Intrinsics.checkNotNullParameter(name, "name");
        return this.backingMap.isNull(name) ? i7 : this.backingMap.getInt(name);
    }
    ...
    public String toString() {
        return "{ ReactStylesDiffMap: " + this.backingMap + " }";
    }
}
