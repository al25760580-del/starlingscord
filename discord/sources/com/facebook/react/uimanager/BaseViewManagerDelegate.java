...
public abstract class BaseViewManagerDelegate<T extends View, U extends BaseViewManager<T, ? extends LayoutShadowNode>> implements ViewManagerDelegate<T> {
    ...
    public void kotlinCompat$setProperty(@NotNull T view, @NotNull String propName, Object value) {
        Intrinsics.checkNotNullParameter(view, "view");
        ...
        switch (propName.hashCode()) {
            ...
            case -1721943862:
                if (propName.equals(ViewProps.TRANSLATE_X)) {
                    ...
                    this.mViewManager.setTranslateX(view, d6 != null ? (float) d6.doubleValue() : 0.0f);
                    break;
                }
                break;
            case -1721943861:
                if (propName.equals(ViewProps.TRANSLATE_Y)) {
                    ...
                    this.mViewManager.setTranslateY(view, d7 != null ? (float) d7.doubleValue() : 0.0f);
                    break;
                }
                break;
            case -1589741021:
                if (propName.equals(ViewProps.SHADOW_COLOR)) {
                    ...
                    u5.setShadowColor(view, ColorPropConverter.getColor(value, context, 0));
                    break;
                }
                break;
            case -1489432511:
            ...
            case -1471148380:
                if (propName.equals(ViewProps.OUTLINE_WIDTH)) {
                    ...
                    this.mViewManager.setOutlineWidth(view, d8 != null ? (float) d8.doubleValue() : Float.NaN);
                    break;
                }
                break;
            case -1351902487:
            ...
            case -1267206133:
                if (propName.equals(ViewProps.OPACITY)) {
                    ...
                    this.mViewManager.setOpacity(view, d9 != null ? (float) d9.doubleValue() : 1.0f);
                    break;
                }
                break;
            case -1247970794:
            ...
            case -1228066334:
                if (propName.equals("borderTopLeftRadius")) {
                    ...
                    this.mViewManager.setBorderTopLeftRadius(view, d10 != null ? (float) d10.doubleValue() : Float.NaN);
                    break;
                }
                break;
            case -1219666915:
            ...
            case -908189618:
                if (propName.equals(ViewProps.SCALE_X)) {
                    ...
                    this.mViewManager.setScaleX(view, d11 != null ? (float) d11.doubleValue() : 1.0f);
                    break;
                }
                break;
            case -908189617:
                if (propName.equals(ViewProps.SCALE_Y)) {
                    ...
                    this.mViewManager.setScaleY(view, d12 != null ? (float) d12.doubleValue() : 1.0f);
                    break;
                }
                break;
            case -877170387:
            ...
            case -731417480:
                if (propName.equals(ViewProps.Z_INDEX)) {
                    ...
                    this.mViewManager.setZIndex(view, d13 != null ? (float) d13.doubleValue() : 0.0f);
                    break;
                }
                break;
            case -112141555:
            ...
            case -40300674:
                if (propName.equals(ViewProps.ROTATION)) {
                    ...
                    this.mViewManager.setRotation(view, d14 != null ? (float) d14.doubleValue() : 0.0f);
                    break;
                }
                break;
            case -4379043:
                if (propName.equals(ViewProps.ELEVATION)) {
                    ...
                    this.mViewManager.setElevation(view, d15 != null ? (float) d15.doubleValue() : 0.0f);
                    break;
                }
                break;
            case 3506294:
            ...
            case 333432965:
                if (propName.equals("borderTopRightRadius")) {
                    ...
                    this.mViewManager.setBorderTopRightRadius(view, d16 != null ? (float) d16.doubleValue() : Float.NaN);
                    break;
                }
                break;
            case 581268560:
                if (propName.equals("borderBottomLeftRadius")) {
                    ...
                    this.mViewManager.setBorderBottomLeftRadius(view, d17 != null ? (float) d17.doubleValue() : Float.NaN);
                    break;
                }
                break;
            case 588239831:
                if (propName.equals("borderBottomRightRadius")) {
                    ...
                    this.mViewManager.setBorderBottomRightRadius(view, d18 != null ? (float) d18.doubleValue() : Float.NaN);
                    break;
                }
                break;
            case 743055051:
            ...
            case 1287124693:
                if (propName.equals(ViewProps.BACKGROUND_COLOR)) {
                    ...
                    u7.setBackgroundColor(view, ColorPropConverter.getColor(value, context2, 0));
                    break;
                }
                break;
            case 1349188574:
                if (propName.equals("borderRadius")) {
                    ...
                    this.mViewManager.setBorderRadius(view, d19 != null ? (float) d19.doubleValue() : Float.NaN);
                    break;
                }
                break;
            case 1407295349:
                if (propName.equals(ViewProps.OUTLINE_OFFSET)) {
                    ...
                    this.mViewManager.setOutlineOffset(view, d20 != null ? (float) d20.doubleValue() : Float.NaN);
                    break;
                }
                break;
            case 1505602511:
