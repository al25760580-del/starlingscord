...
public final class BackgroundDrawable extends Drawable {
    ...
    public /* synthetic */ BackgroundDrawable(Context context, BorderRadiusStyle borderRadiusStyle, BorderInsets borderInsets, int i7, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final void updatePath() {
        ...
        if (this.needUpdatePath) {
            ...
            if (z5 && (borderRadiusStyle = this.borderRadius) != null && borderRadiusStyle.hasRoundedBorders()) {
                RectF rectF5 = this.backgroundRect;
                float f2 = rectF5.left;
                float f7 = this.pathAdjustment;
                rectF5.left = f2 + f7;
                rectF5.top += f7;
                rectF5.right -= f7;
                rectF5.bottom -= f7;
    ...
    public void setAlpha(int alpha) {
        this.backgroundPaint.setAlpha(c.b((Color.alpha(this.backgroundColor) / 255.0f) * (alpha / 255.0f) * 255.0f));
        invalidateSelf();
    }
