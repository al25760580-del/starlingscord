...
public final class OutlineDrawable extends Drawable {
    ...
    public /* synthetic */ OutlineDrawable(Context context, BorderRadiusStyle borderRadiusStyle, int i7, float f2, OutlineStyle outlineStyle, float f7, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i10 & 2) != 0 ? null : borderRadiusStyle, i7, f2, outlineStyle, f7);
    }
    ...
    private final float calculateRadius(float radius, float outlineWidth, float outlineOffset) {
        ...
        return (outlineWidth * 0.5f) + radius + outlineOffset;
    }
    ...
    private final void updateOutlineRect() {
        ...
        float f10 = this.outlineOffset;
        float f11 = this.gapBetweenPaths;
        rectF.top = f2 - (((f7 * 0.5f) + f10) - f11);
        rectF.bottom = (((f7 * 0.5f) + f10) - f11) + rectF.bottom;
        rectF.left -= ((f7 * 0.5f) + f10) - f11;
        rectF.right = (((f7 * 0.5f) + f10) - f11) + rectF.right;
    }
    ...
    public void setAlpha(int alpha) {
        this.outlinePaint.setAlpha(c.b((Color.alpha(this.outlineColor) / 255.0f) * (alpha / 255.0f) * 255.0f));
        invalidateSelf();
    }
    ...
    public final void setOutlineColor(int i7) {
        if (i7 != this.outlineColor) {
            this.outlineColor = i7;
            this.outlinePaint.setColor(i7);
            invalidateSelf();
        }
    }

    public final void setOutlineOffset(float f2) {
        if (f2 == this.outlineOffset) {
            return;
        }
    ...
    public final void setOutlineWidth(float f2) {
        if (f2 == this.outlineWidth) {
            return;
        }
        this.outlineWidth = f2;
        this.outlinePaint.setStrokeWidth(f2);
        this.outlinePaint.setPathEffect(getPathEffect(this.outlineStyle, f2));
        invalidateSelf();
    }

    public OutlineDrawable(@NotNull Context context, BorderRadiusStyle borderRadiusStyle, int i7, float f2, @NotNull OutlineStyle outlineStyle, float f7) {
        ...
        paint.setPathEffect(getPathEffect(outlineStyle, f7));
