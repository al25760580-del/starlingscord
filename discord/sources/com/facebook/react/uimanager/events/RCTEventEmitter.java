...
public interface RCTEventEmitter extends JavaScriptModule {
    @d
    void receiveEvent(int targetTag, @NotNull String eventName, WritableMap params);

    @d
    default void receiveTouches(@NotNull String eventName, @NotNull WritableArray touches, @NotNull WritableArray changedIndices) {
