...
public final class UIManagerModuleConstantsHelper {
    ...
    public static final Map<String, Object> getDefaultExportableEventTypes() {
        return w0.g(new Pair(BUBBLING_EVENTS_KEY, UIManagerModuleConstants.bubblingEventTypeConstants), new Pair(DIRECT_EVENTS_KEY, UIManagerModuleConstants.directEventTypeConstants));
    }
    ...
    public static final Map<String, Object> internal_createConstants(@NotNull ViewManagerResolver resolver) {
        ...
        return w0.i(UIManagerModuleConstants.constants, w0.g(new Pair("ViewManagerNames", new ArrayList(resolver.getViewManagerNames())), new Pair("LazyViewManagersEnabled", Boolean.TRUE)));
    }

    @NotNull
    public static final Map<String, Object> internal_createConstantsForViewManager(@NotNull ViewManager viewManager, Map<String, Object> defaultBubblingEvents, Map<String, Object> defaultDirectEvents, Map<String, Object> cumulativeBubblingEventTypes, Map<String, Object> cumulativeDirectEventTypes) {
    ...
    private final void validateDirectEventNames(String viewManagerName, Map<String, Object> directEvents) {
        ...
        for (Map.Entry<String, Object> entry : directEvents.entrySet()) {
            String key = entry.getKey();
            Object value = entry.getValue();
            if (TypeIntrinsics.isMutableMap(value) && (str = (String) ((Map) value).get("registrationName")) != null && x.o(key, ViewProps.TOP, false) && x.o(str, ViewProps.ON, false)) {
                ...
                if (!Intrinsics.areEqual(strSubstring, strSubstring2)) {
                    StringBuilder sbU = e.u("Direct event name for '", viewManagerName, "' doesn't correspond to the naming convention, expected 'topEventName'->'onEventName', got '", key, "'->'");
                    sbU.append(str);
                    sbU.append("'");
                    o8.a.g(TAG, sbU.toString());
                }
            }
        }
    }
    ...
    public final Map<String, Object> normalizeEventTypes$ReactAndroid_release(@NotNull Map<String, Object> eventsToNormalize) {
        ...
        for (String str : eventsToNormalize.keySet()) {
            if (!x.o(str, ViewProps.TOP, false)) {
                hashSet.add(str);
            }
        }
        ...
        for (String str2 : hashSet) {
            ...
            if (x.o(str2, ViewProps.ON, false)) {
    ...
    @NotNull
    public static final Map<String, Object> internal_createConstants(@NotNull List<? extends ViewManager> viewManagers, Map<String, Object> allBubblingEventTypes, Map<String, Object> allDirectEventTypes) {
        Intrinsics.checkNotNullParameter(viewManagers, "viewManagers");
        LinkedHashMap linkedHashMapN = w0.n(UIManagerModuleConstants.constants);
        ...
        for (ViewManager viewManager : viewManagers) {
            ...
            if (!mapInternal_createConstantsForViewManager.isEmpty()) {
                linkedHashMapN.put(name, mapInternal_createConstantsForViewManager);
            }
        }
        linkedHashMapN.put("genericBubblingEventTypes", map);
        linkedHashMapN.put("genericDirectEventTypes", map2);
        return linkedHashMapN;
    }
}
