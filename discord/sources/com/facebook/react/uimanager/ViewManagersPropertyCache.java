...
class ViewManagersPropertyCache {
    ...
    public static class ArrayPropSetter extends PropSetter {
        public ArrayPropSetter(ReactProp reactProp, Method method) {
            super(reactProp, "Array", method, 0);
        }
    ...
    public static class BooleanPropSetter extends PropSetter {
        ...
        public BooleanPropSetter(ReactProp reactProp, Method method, boolean z5) {
            super(reactProp, "boolean", method, 0);
    ...
    public static class BoxedColorPropSetter extends PropSetter {
        public BoxedColorPropSetter(ReactProp reactProp, Method method) {
            super(reactProp, "mixed", method, 0);
        }
        ...
        public BoxedColorPropSetter(ReactPropGroup reactPropGroup, Method method, int i7) {
            super(reactPropGroup, "mixed", method, i7, 0);
        }
    }

    public static class BoxedIntPropSetter extends PropSetter {
        public BoxedIntPropSetter(ReactProp reactProp, Method method) {
            super(reactProp, "number", method, 0);
        }
        ...
        public BoxedIntPropSetter(ReactPropGroup reactPropGroup, Method method, int i7) {
            super(reactPropGroup, "number", method, i7, 0);
        }
    }
    ...
    public static class ColorPropSetter extends PropSetter {
        ...
        public ColorPropSetter(ReactProp reactProp, Method method, int i7) {
            super(reactProp, "mixed", method, 0);
            this.mDefaultValue = i7;
        }

        public ColorPropSetter(ReactPropGroup reactPropGroup, Method method, int i7, int i10) {
            super(reactPropGroup, "mixed", method, i7, 0);
    ...
    public static class DynamicPropSetter extends PropSetter {
        ...
        public DynamicPropSetter(ReactPropGroup reactPropGroup, Method method, int i7) {
            super(reactPropGroup, "mixed", method, i7, 0);
        }
    }
    ...
    public static abstract class PropSetter {
        ...
        public /* synthetic */ PropSetter(ReactProp reactProp, String str, Method method, int i7) {
        ...
        public void updateShadowNodeProp(ReactShadowNode reactShadowNode, Object obj) {
            ...
            try {
                ...
                o8.a.e(ViewManager.class, "Error while updating prop " + this.mPropName, th2);
        ...
        public /* synthetic */ PropSetter(ReactPropGroup reactPropGroup, String str, Method method, int i7, int i10) {
            this(reactPropGroup, str, method, i7);
        }
    ...
    private static void createPropSetters(ReactPropGroup reactPropGroup, Method method, Class<?> cls, Map<String, PropSetter> map) {
        ...
        int i7 = 0;
        if (cls == Dynamic.class) {
            while (i7 < strArrNames.length) {
                map.put(strArrNames[i7], new DynamicPropSetter(reactPropGroup, method, i7));
                i7++;
            }
            return;
        }
        if (cls == Integer.TYPE) {
            while (i7 < strArrNames.length) {
                if ("Color".equals(reactPropGroup.customType())) {
                    map.put(strArrNames[i7], new ColorPropSetter(reactPropGroup, method, i7, reactPropGroup.defaultInt()));
                } else {
                    map.put(strArrNames[i7], new IntPropSetter(reactPropGroup, method, i7, reactPropGroup.defaultInt()));
                }
                i7++;
            }
            return;
        ...
        if (cls == Float.TYPE) {
            while (i7 < strArrNames.length) {
                map.put(strArrNames[i7], new FloatPropSetter(reactPropGroup, method, i7, reactPropGroup.defaultFloat()));
                i7++;
            }
            return;
        }
        if (cls == Double.TYPE) {
            for (int i10 = 0; i10 < strArrNames.length; i10++) {
                map.put(strArrNames[i10], new DoublePropSetter(reactPropGroup, method, i10, reactPropGroup.defaultDouble()));
            }
            return;
        }
        if (cls == Integer.class) {
            while (i7 < strArrNames.length) {
                if ("Color".equals(reactPropGroup.customType())) {
                    map.put(strArrNames[i7], new BoxedColorPropSetter(reactPropGroup, method, i7));
                } else {
                    map.put(strArrNames[i7], new BoxedIntPropSetter(reactPropGroup, method, i7));
                }
                i7++;
            }
            return;
    ...
    public static ThreadLocal<Object[]> createThreadLocalArray(final int i7) {
        if (i7 <= 0) {
            return null;
        }
    ...
    public static class DoublePropSetter extends PropSetter {
        ...
        public DoublePropSetter(ReactProp reactProp, Method method, double d6) {
            super(reactProp, "number", method, 0);
        ...
        public DoublePropSetter(ReactPropGroup reactPropGroup, Method method, int i7, double d6) {
            super(reactPropGroup, "number", method, i7, 0);
            this.mDefaultValue = d6;
        }
    }
    ...
    public static class FloatPropSetter extends PropSetter {
        ...
        public FloatPropSetter(ReactPropGroup reactPropGroup, Method method, int i7, float f2) {
            super(reactPropGroup, "number", method, i7, 0);
            this.mDefaultValue = f2;
        }
    }
    ...
    public static class IntPropSetter extends PropSetter {
        ...
        public IntPropSetter(ReactProp reactProp, Method method, int i7) {
            super(reactProp, "number", method, 0);
            this.mDefaultValue = i7;
        }
        ...
        public IntPropSetter(ReactPropGroup reactPropGroup, Method method, int i7, int i10) {
            super(reactPropGroup, "number", method, i7, 0);
            this.mDefaultValue = i10;
        }
    }
