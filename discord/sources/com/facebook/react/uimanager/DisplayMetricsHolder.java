...
public final class DisplayMetricsHolder {
    ...
    public static final long getEncodedScreenSizeWithoutVerticalInsets(Activity activity) {
        ...
        Insets insetsF = windowInsetsCompatA.f1605a.f(131);
        Intrinsics.checkNotNullExpressionValue(insetsF, "getInsets(...)");
        int i7 = insetsF.f1557b + insetsF.f1559d;
        DisplayMetricsHolder displayMetricsHolder = INSTANCE;
        ...
        if (displayMetrics2 != null) {
            return displayMetricsHolder.encodeFloatsToLong$ReactAndroid_release(fPxToDp, pixelUtil.pxToDp(displayMetrics2.heightPixels - i7));
        }
        throw new IllegalStateException("Required value was null.");
    }
    ...
    public final int getStatusBarHeightPx$ReactAndroid_release(Activity activity) {
        ...
        return windowInsetsCompatA.f1605a.f(131).f1557b;
    }
}
