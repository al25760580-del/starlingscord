...
public final class ReactAxOrderHelper {
    ...
    public static final void cleanUpAxOrder(@NotNull View view) {
    ...
    public static final void restoreFocusability(@NotNull View view) {
        Intrinsics.checkNotNullParameter(view, "view");
        Boolean bool = (Boolean) view.getTag(R.id.original_focusability);
        if (bool != null) {
            view.setFocusable(bool.booleanValue());
    ...
    public final void buildAxOrderList(@NotNull View view, @NotNull View parent, @NotNull List<?> axOrderList, @NotNull View[] result) {
        Intrinsics.checkNotNullParameter(view, "view");
        ...
        if (CollectionsKt.E(axOrderList, tag)) {
            Intrinsics.checkNotNullParameter(axOrderList, "<this>");
            int iIndexOf = axOrderList.indexOf(tag);
            if (iIndexOf != -1) {
    ...
    public final void disableFocusForSubtree(@NotNull View view, @NotNull List<?> axOrderList) {
        Intrinsics.checkNotNullParameter(view, "view");
        Intrinsics.checkNotNullParameter(axOrderList, "axOrderList");
        if (!CollectionsKt.E(axOrderList, view.getTag(R.id.view_tag_native_id))) {
