...
public final class FloatUtil {
    ...
    public static final boolean floatsEqual(float f2, float f7) {
        if (Float.isNaN(f2) || Float.isNaN(f7)) {
            return Float.isNaN(f2) && Float.isNaN(f7);
        }
        return Math.abs(f7 - f2) < EPSILON;
    }
    ...
    public static final boolean floatsEqual(Float f2, Float f7) {
        ...
        return floatsEqual(f2.floatValue(), f7.floatValue());
    }
}
