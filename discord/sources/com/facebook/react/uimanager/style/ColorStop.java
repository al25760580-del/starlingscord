...
public final class ColorStop {
    ...
    public /* synthetic */ ColorStop(Integer num, LengthPercentage lengthPercentage, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? null : num, (i7 & 2) != 0 ? null : lengthPercentage);
    }
}
