...
public enum LogicalEdge {
    ...
    public static final class Companion {
        ...
        public final LogicalEdge fromSpacingType(int spacingType) {
            switch (spacingType) {
                ...
                default:
                    throw new IllegalArgumentException(kk.b.h(spacingType, "Unknown spacing type: "));
            }
        }
    ...
    @NotNull
    public static final LogicalEdge fromSpacingType(int i7) {
        return INSTANCE.fromSpacingType(i7);
    }
