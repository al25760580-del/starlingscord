...
public final /* data */ class CornerRadii {
    ...
    public static /* synthetic */ CornerRadii copy$default(CornerRadii cornerRadii, float f2, float f7, int i7, Object obj) {
        if ((i7 & 1) != 0) {
            f2 = cornerRadii.horizontal;
        }
        if ((i7 & 2) != 0) {
            f7 = cornerRadii.vertical;
        }
        return cornerRadii.copy(f2, f7);
    }
    ...
    public CornerRadii(float f2, float f7) {
        this.horizontal = f2;
        this.vertical = f7;
    }

    public /* synthetic */ CornerRadii(float f2, float f7, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? 0.0f : f2, (i7 & 2) != 0 ? 0.0f : f7);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public CornerRadii(@NotNull LengthPercentage length, float f2, float f7) {
        this(length.resolve(f2), length.resolve(f7));
