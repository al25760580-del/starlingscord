...
public final class ProcessedColorStop {
    ...
    public ProcessedColorStop(Integer num, Float f2) {
        this.color = num;
        this.position = f2;
    }

    public /* synthetic */ ProcessedColorStop(Integer num, Float f2, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? null : num, (i7 & 2) != 0 ? null : f2);
    }
}
