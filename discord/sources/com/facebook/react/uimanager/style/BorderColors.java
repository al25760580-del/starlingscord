...
public final class BorderColors {
    ...
    public static final /* synthetic */ BorderColors m1233boximpl(Integer[] numArr) {
        return new BorderColors(numArr);
    }

    @NotNull
    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static Integer[] m1234constructorimpl(@NotNull Integer[] edgeColors) {
        Intrinsics.checkNotNullParameter(edgeColors, "edgeColors");
        return edgeColors;
    }

    /* JADX INFO: renamed from: constructor-impl$default, reason: not valid java name */
    public static /* synthetic */ Integer[] m1235constructorimpl$default(Integer[] numArr, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i7 & 1) != 0) {
            numArr = new Integer[LogicalEdge.values().length];
        }
        return m1234constructorimpl(numArr);
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1236equalsimpl(Integer[] numArr, Object obj) {
        return (obj instanceof BorderColors) && Intrinsics.areEqual(numArr, ((BorderColors) obj).m1241unboximpl());
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1237equalsimpl0(Integer[] numArr, Integer[] numArr2) {
        return Intrinsics.areEqual(numArr, numArr2);
    }

    /* JADX INFO: renamed from: hashCode-impl, reason: not valid java name */
    public static int m1238hashCodeimpl(Integer[] numArr) {
        return Arrays.hashCode(numArr);
    }

    @NotNull
    /* JADX INFO: renamed from: resolve-impl, reason: not valid java name */
    public static final ColorEdges m1239resolveimpl(Integer[] numArr, int i7, @NotNull Context context) {
    ...
    public static String m1240toStringimpl(Integer[] numArr) {
        return g.e("BorderColors(edgeColors=", Arrays.toString(numArr), ")");
    }

    public boolean equals(Object obj) {
        return m1236equalsimpl(this.edgeColors, obj);
    }
    ...
    public int hashCode() {
        return m1238hashCodeimpl(this.edgeColors);
    }

    public String toString() {
        return m1240toStringimpl(this.edgeColors);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ Integer[] m1241unboximpl() {
        return this.edgeColors;
    }
}
