...
public final /* data */ class BorderRadiusStyle {
    ...
    public static /* synthetic */ BorderRadiusStyle copy$default(BorderRadiusStyle borderRadiusStyle, LengthPercentage lengthPercentage, LengthPercentage lengthPercentage2, LengthPercentage lengthPercentage3, LengthPercentage lengthPercentage4, LengthPercentage lengthPercentage5, LengthPercentage lengthPercentage6, LengthPercentage lengthPercentage7, LengthPercentage lengthPercentage8, LengthPercentage lengthPercentage9, LengthPercentage lengthPercentage10, LengthPercentage lengthPercentage11, LengthPercentage lengthPercentage12, LengthPercentage lengthPercentage13, int i7, Object obj) {
        if ((i7 & 1) != 0) {
            lengthPercentage = borderRadiusStyle.uniform;
        }
        return borderRadiusStyle.copy(lengthPercentage, (i7 & 2) != 0 ? borderRadiusStyle.topLeft : lengthPercentage2, (i7 & 4) != 0 ? borderRadiusStyle.topRight : lengthPercentage3, (i7 & 8) != 0 ? borderRadiusStyle.bottomLeft : lengthPercentage4, (i7 & 16) != 0 ? borderRadiusStyle.bottomRight : lengthPercentage5, (i7 & 32) != 0 ? borderRadiusStyle.topStart : lengthPercentage6, (i7 & 64) != 0 ? borderRadiusStyle.topEnd : lengthPercentage7, (i7 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT) != 0 ? borderRadiusStyle.bottomStart : lengthPercentage8, (i7 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER) != 0 ? borderRadiusStyle.bottomEnd : lengthPercentage9, (i7 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING) != 0 ? borderRadiusStyle.startStart : lengthPercentage10, (i7 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_OVERFLOW_INSET) != 0 ? borderRadiusStyle.startEnd : lengthPercentage11, (i7 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? borderRadiusStyle.endStart : lengthPercentage12, (i7 & RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? borderRadiusStyle.endEnd : lengthPercentage13);
    }
    ...
    private final ComputedBorderRadius ensureNoOverlap(CornerRadii topLeft, CornerRadii topRight, CornerRadii bottomLeft, CornerRadii bottomRight, float width, float height) {
        float vertical = bottomLeft.getVertical() + topLeft.getVertical();
        float horizontal = topRight.getHorizontal() + topLeft.getHorizontal();
        float vertical2 = bottomRight.getVertical() + topRight.getVertical();
        float horizontal2 = bottomRight.getHorizontal() + bottomLeft.getHorizontal();
        ...
        return new ComputedBorderRadius(new CornerRadii(Math.min(fMin2, fMin) * topLeft.getHorizontal(), Math.min(fMin2, fMin) * topLeft.getVertical()), new CornerRadii(Math.min(fMin3, fMin2) * topRight.getHorizontal(), Math.min(fMin3, fMin2) * topRight.getVertical()), new CornerRadii(Math.min(fMin4, fMin) * bottomLeft.getHorizontal(), Math.min(fMin4, fMin) * bottomLeft.getVertical()), new CornerRadii(Math.min(fMin4, fMin3) * bottomRight.getHorizontal(), Math.min(fMin4, fMin3) * bottomRight.getVertical()));
    }
    ...
    public final void set(@NotNull BorderRadiusProp property, LengthPercentage value) {
        Intrinsics.checkNotNullParameter(property, "property");
        switch (WhenMappings.$EnumSwitchMapping$0[property.ordinal()]) {
            case 1:
                this.uniform = value;
    ...
    public /* synthetic */ BorderRadiusStyle(LengthPercentage lengthPercentage, LengthPercentage lengthPercentage2, LengthPercentage lengthPercentage3, LengthPercentage lengthPercentage4, LengthPercentage lengthPercentage5, LengthPercentage lengthPercentage6, LengthPercentage lengthPercentage7, LengthPercentage lengthPercentage8, LengthPercentage lengthPercentage9, LengthPercentage lengthPercentage10, LengthPercentage lengthPercentage11, LengthPercentage lengthPercentage12, LengthPercentage lengthPercentage13, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? null : lengthPercentage, (i7 & 2) != 0 ? null : lengthPercentage2, (i7 & 4) != 0 ? null : lengthPercentage3, (i7 & 8) != 0 ? null : lengthPercentage4, (i7 & 16) != 0 ? null : lengthPercentage5, (i7 & 32) != 0 ? null : lengthPercentage6, (i7 & 64) != 0 ? null : lengthPercentage7, (i7 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT) != 0 ? null : lengthPercentage8, (i7 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER) != 0 ? null : lengthPercentage9, (i7 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING) != 0 ? null : lengthPercentage10, (i7 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_OVERFLOW_INSET) != 0 ? null : lengthPercentage11, (i7 & RecyclerView.ItemAnimator.FLAG_MOVED) != 0 ? null : lengthPercentage12, (i7 & RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT) != 0 ? null : lengthPercentage13);
    }
    ...
    public BorderRadiusStyle(@NotNull List<? extends Pair<? extends BorderRadiusProp, LengthPercentage>> properties) {
        ...
        while (it.hasNext()) {
            ...
            set((BorderRadiusProp) pair.f14612d, (LengthPercentage) pair.f14613e);
        }
    }
}
