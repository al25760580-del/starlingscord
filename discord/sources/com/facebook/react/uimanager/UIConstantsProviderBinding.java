...
public final class UIConstantsProviderBinding {
    ...
    public interface ConstantsForViewManagerProvider {
        NativeMap getConstantsForViewManager(@NotNull String viewManagerName);
    }
    ...
    public static final native void install(@NotNull RuntimeExecutor runtimeExecutor, @NotNull DefaultEventTypesProvider defaultEventTypesProvider, @NotNull ConstantsForViewManagerProvider viewManagerConstantsProvider, @NotNull ConstantsProvider constantsProvider);
}
