...
public final class ShadowNodeRegistry {
    ...
    public final class SingleThreadAsserter {
        ...
        public final void assertNow() {
            ...
            io.sentry.config.a.d(Intrinsics.areEqual(this.thread, threadCurrentThread));
        }
    }
    ...
    public final void removeNode(int tag) {
        ...
        if (this.rootTags.get(tag)) {
            throw new IllegalViewOperationException(g.d(tag, "Trying to remove root node ", " without using removeRootNode!"));
        }
    ...
    public final void removeRootNode(int tag) {
        ...
        if (!this.rootTags.get(tag)) {
            throw new IllegalViewOperationException(g.d(tag, "View with tag ", " is not registered as a root view"));
        }
        this.tagsToCSSNodes.remove(tag);
