...
public final class JavaOnlyArray implements ReadableArray, WritableArray {
        ...
        public final JavaOnlyArray deepClone(ReadableArray array) {
            ...
            if (array != null) {
                ...
                for (int i7 = 0; i7 < size; i7++) {
                    switch (WhenMappings.$EnumSwitchMapping$0[array.getType(i7).ordinal()]) {
                        case 1:
                            javaOnlyArray.pushNull();
                            break;
                        case 2:
                            javaOnlyArray.pushBoolean(array.getBoolean(i7));
                            break;
                        case 3:
                            javaOnlyArray.pushDouble(array.getDouble(i7));
                            break;
                        case 4:
                            javaOnlyArray.pushString(array.getString(i7));
                            break;
                        case 5:
                            javaOnlyArray.pushMap(JavaOnlyMap.INSTANCE.deepClone(array.getMap(i7)));
                            break;
                        case 6:
                            javaOnlyArray.pushArray(JavaOnlyArray.INSTANCE.deepClone(array.getArray(i7)));
                            break;
                        default:
                            throw new n();
                    }
    ...
    private JavaOnlyArray(Object... objArr) {
        this.backingList = d0.i(Arrays.copyOf(objArr, objArr.length));
    }
