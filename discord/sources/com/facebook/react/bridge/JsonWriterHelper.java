...
public final class JsonWriterHelper {
    ...
    public static final void readableArrayValue(@NotNull JsonWriter writer, @NotNull ReadableArray value) throws IOException {
        ...
        try {
            ...
            for (int i7 = 0; i7 < size; i7++) {
                switch (WhenMappings.$EnumSwitchMapping$0[value.getType(i7).ordinal()]) {
                    case 1:
                        writer.nullValue();
                        break;
                    case 2:
                        writer.value(value.getBoolean(i7));
                        break;
                    case 3:
                        writer.value(value.getDouble(i7));
                        break;
                    case 4:
                        writer.value(value.getString(i7));
                        break;
                    case 5:
                        ...
                        break;
                    case 6:
                        ReadableArray array = value.getArray(i7);
                        if (array == null) {
                            throw new IllegalStateException("Required value was null.");
                        }
    ...
    public static final void value(@NotNull JsonWriter writer, Object value) throws IOException {
        Intrinsics.checkNotNullParameter(writer, "writer");
