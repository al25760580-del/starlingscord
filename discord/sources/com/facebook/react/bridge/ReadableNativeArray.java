...
public class ReadableNativeArray extends NativeArray implements ReadableArray {
    ...
    public ArrayList<Object> toArrayList() {
        ...
        for (int i7 = 0; i7 < size; i7++) {
            switch (WhenMappings.$EnumSwitchMapping$0[getType(i7).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
                    arrayList.add(Boolean.valueOf(getBoolean(i7)));
                    break;
                case 3:
                    arrayList.add(Double.valueOf(getDouble(i7)));
                    break;
                case 4:
                    arrayList.add(getString(i7));
                    break;
                case 5:
                    ReadableNativeMap map = getMap(i7);
                    arrayList.add(map != null ? map.toHashMap() : null);
                    break;
                case 6:
                    ReadableNativeArray array = getArray(i7);
