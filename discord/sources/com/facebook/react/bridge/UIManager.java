...
public interface UIManager extends PerformanceCounter {
    @d
    <T extends View> int addRootView(@NotNull T rootView, WritableMap initialProps);
    ...
    void dispatchCommand(int reactTag, @NotNull String commandId, ReadableArray commandArgs);
    ...
    void markViewAsInTransition(int surfaceId, int reactTag, boolean isTransitioning);

    void receiveEvent(int surfaceId, int reactTag, @NotNull String eventName, WritableMap event);

    @d
    void receiveEvent(int reactTag, @NotNull String eventName, WritableMap event);
    ...
    <T extends View> int startSurface(T rootView, @NotNull String moduleName, WritableMap initialProps, int widthMeasureSpec, int heightMeasureSpec);
