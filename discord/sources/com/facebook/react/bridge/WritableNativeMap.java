...
public final class WritableNativeMap extends ReadableNativeMap implements WritableMap {
    ...
    public void merge(@NotNull ReadableMap source) {
        ...
        io.sentry.config.a.e(source instanceof ReadableNativeMap, "Illegal type provided");
        mergeNativeMap((ReadableNativeMap) source);
    }

    @Override // com.facebook.react.bridge.WritableMap
    public void putArray(@NotNull String key, ReadableArray value) {
        Intrinsics.checkNotNullParameter(key, "key");
        io.sentry.config.a.e(value == null || (value instanceof ReadableNativeArray), "Illegal type provided");
    ...
    @Override // com.facebook.react.bridge.WritableMap
    public void putMap(@NotNull String key, ReadableMap value) {
        Intrinsics.checkNotNullParameter(key, "key");
        io.sentry.config.a.e(value == null || (value instanceof ReadableNativeMap), "Illegal type provided");
    ...
    @Override // com.facebook.react.bridge.WritableMap
    public native void putString(@NotNull String key, String value);
}
