...
public interface Promise {
    ...
    void reject(String code, @NotNull WritableMap userInfo);

    void reject(String code, String message);

    void reject(String code, String message, @NotNull WritableMap userInfo);
    ...
    void reject(String code, Throwable throwable, @NotNull WritableMap userInfo);
