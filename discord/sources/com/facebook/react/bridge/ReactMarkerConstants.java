...
jadx.core.utils.exceptions.JadxRuntimeException: Init of enum field 'CREATE_REACT_CONTEXT_START' uses external variables
...
public final class ReactMarkerConstants {
    ...
    static {
        ...
        boolean z5 = false;
        CREATE_REACT_CONTEXT_START = new ReactMarkerConstants("CREATE_REACT_CONTEXT_START", 2, z5, i7, defaultConstructorMarker);
        PROCESS_PACKAGES_START = new ReactMarkerConstants("PROCESS_PACKAGES_START", 6, z5, i7, defaultConstructorMarker);
        ...
        boolean z6 = false;
        DESTROY_CATALYST_INSTANCE_END = new ReactMarkerConstants("DESTROY_CATALYST_INSTANCE_END", 13, z6, i10, defaultConstructorMarker3);
        NATIVE_MODULE_INITIALIZE_START = new ReactMarkerConstants("NATIVE_MODULE_INITIALIZE_START", 16, z6, i10, defaultConstructorMarker3);
        ...
        ReactMarkerConstants[] reactMarkerConstantsArr$values = $values();
        $VALUES = reactMarkerConstantsArr$values;
        $ENTRIES = b.l(reactMarkerConstantsArr$values);
    }

    private ReactMarkerConstants(String str, int i7, boolean z5) {
        super(str, i7);
        this.hasMatchingNameMarker = z5;
    }
    ...
    public /* synthetic */ ReactMarkerConstants(String str, int i7, boolean z5, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, i7, (i10 & 1) != 0 ? false : z5);
    }
}
