...
public final class ReactMarker {
    ...
    public interface FabricMarkerListener {
        void logFabricMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey, long timestamp);

        default void logFabricMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey, long timestamp, int counter) {
    ...
    public interface MarkerListener {
        void logMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey);
    }
    ...
    @a
    public static final void logFabricMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey, long timestamp, int counter) {
        Intrinsics.checkNotNullParameter(name, "name");
    ...
    @a
    public static final void logFabricMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey, long timestamp) {
        Intrinsics.checkNotNullParameter(name, "name");
        Iterator<FabricMarkerListener> it = fabricMarkerListeners.iterator();
        while (it.hasNext()) {
    ...
    @a
    public static final void logMarker(@NotNull String name, String tag) {
        Intrinsics.checkNotNullParameter(name, "name");
        logMarker(name, tag, 0);
    }

    @a
    public static final void logMarker(@NotNull String name, String tag, int instanceKey) {
        Intrinsics.checkNotNullParameter(name, "name");
        logMarker(ReactMarkerConstants.valueOf(name), tag, instanceKey);
    }

    @a
    public static final void logFabricMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey) {
        Intrinsics.checkNotNullParameter(name, "name");
    ...
    @a
    public static final void logMarker(@NotNull ReactMarkerConstants name, String tag) {
        Intrinsics.checkNotNullParameter(name, "name");
        logMarker(name, tag, 0);
    }
    ...
    @a
    public static final void logMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey) {
        Intrinsics.checkNotNullParameter(name, "name");
        logMarker(name, tag, instanceKey, null);
    }

    @a
    public static final void logMarker(@NotNull ReactMarkerConstants name, String tag, int instanceKey, Long time) {
        Intrinsics.checkNotNullParameter(name, "name");
