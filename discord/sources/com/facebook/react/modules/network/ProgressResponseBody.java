...
public final class ProgressResponseBody extends ResponseBody {
    ...
    public BufferedSource source() {
        if (this.bufferedSource == null) {
            ...
            this.bufferedSource = v.d(source);
        }
    ...
    private final Source source(Source source) {
        return new g(source) { // from class: com.facebook.react.modules.network.ProgressResponseBody.source.1
            ...
            public long read(Buffer sink, long byteCount) {
                ...
                progressResponseBody.progressListener.onProgress(progressResponseBody.totalBytesRead, progressResponseBody.responseBody.contentLength(), j == -1);
                return j;
            }
        };
    }
