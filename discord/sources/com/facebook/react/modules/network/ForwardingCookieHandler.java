...
public final class ForwardingCookieHandler extends CookieHandler {
    ...
    public static final class Companion {
        ...
        public final boolean isCookieHeader(String name) {
            return x.i(name, ForwardingCookieHandler.VERSION_ZERO_HEADER, true) || x.i(name, ForwardingCookieHandler.VERSION_ONE_HEADER, true);
        }
    ...
    public Map<String, List<String>> get(@NotNull URI uri, @NotNull Map<String, ? extends List<String>> headers) {
        ...
        return (cookie == null || cookie.length() == 0) ? w0.d() : v0.b(new Pair(COOKIE_HEADER, c0.c(cookie)));
    }
