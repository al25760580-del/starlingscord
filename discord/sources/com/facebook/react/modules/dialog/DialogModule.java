...
public final class DialogModule extends NativeDialogManagerAndroidSpec implements LifecycleEventListener {
    ...
    @NotNull
    private static final Map<String, Object> CONSTANTS = w0.g(new Pair(ACTION_BUTTON_CLICKED, ACTION_BUTTON_CLICKED), new Pair(ACTION_DISMISSED, ACTION_DISMISSED), new Pair(KEY_BUTTON_POSITIVE, -1), new Pair(KEY_BUTTON_NEGATIVE, -2), new Pair(KEY_BUTTON_NEUTRAL, -3));
    ...
    public final class FragmentManagerHelper {
        ...
        public final void dismissExisting() {
            ...
            if (this.this$0.isInForeground && (alertFragment = (AlertFragment) this.fragmentManager.E(DialogModule.FRAGMENT_TAG)) != null && alertFragment.isResumed()) {
                alertFragment.dismiss();
            }
        }

        public final void showNewAlert(@NotNull Bundle arguments, Callback actionCallback) {
            ...
            if (!this.this$0.isInForeground || this.fragmentManager.Q()) {
    ...
    public void onHostResume() {
        ...
        if (fragmentManagerHelper != null) {
            ...
            o8.a.r(DialogModule.class, "onHostResume called but no FragmentManager found");
        }
    }
