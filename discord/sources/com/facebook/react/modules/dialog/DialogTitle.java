...
public final class DialogTitle extends TextView {
    ...
    public DialogTitle(@NotNull Context context, @NotNull AttributeSet attrs, int i7, int i10) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DialogTitle(@NotNull Context context, @NotNull AttributeSet attrs, int i7) {
