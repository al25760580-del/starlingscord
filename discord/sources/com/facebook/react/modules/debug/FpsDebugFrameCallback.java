...
public final class FpsDebugFrameCallback implements Choreographer.FrameCallback {
    ...
    public static /* synthetic */ void start$default(FpsDebugFrameCallback fpsDebugFrameCallback, double d6, int i7, Object obj) {
        if ((i7 & 1) != 0) {
            d6 = fpsDebugFrameCallback.targetFps;
        }
        fpsDebugFrameCallback.start(d6);
    }
    ...
    public void doFrame(long l6) {
        if (this.firstFrameTime == -1) {
            this.firstFrameTime = l6;
        }
        this.lastFrameTime = l6;
    ...
    public final void start(double targetFps) {
        ...
        UiThreadUtil.runOnUiThread(new b(this, 0));
    }
}
