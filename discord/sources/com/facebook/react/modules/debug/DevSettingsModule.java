...
public final class DevSettingsModule extends NativeDevSettingsSpec {
    ...
    public void addMenuItem(@NotNull final String title) {
        ...
        this.devSupportManager.addCustomDevOption(title, new DevOptionHandler() { // from class: com.facebook.react.modules.debug.a
            @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
            public final void onOptionSelected() {
                DevSettingsModule.addMenuItem$lambda$2(this.f5255a, title);
            }
        });
    }
    ...
    public void reload() {
        if (this.devSupportManager.getIsDevSupportEnabled()) {
            UiThreadUtil.runOnUiThread(new c(21, this));
        }
    }
