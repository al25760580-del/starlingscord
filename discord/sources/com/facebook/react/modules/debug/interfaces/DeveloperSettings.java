...
public interface DeveloperSettings {
    ...
    void setAnimationFpsDebugEnabled(boolean z5);

    void setDeviceDebugEnabled(boolean z5);

    void setElementInspectorEnabled(boolean z5);

    void setFpsDebugEnabled(boolean z5);

    void setHotModuleReplacementEnabled(boolean z5);

    void setJSDevModeEnabled(boolean z5);

    void setJSMinifyEnabled(boolean z5);
}
