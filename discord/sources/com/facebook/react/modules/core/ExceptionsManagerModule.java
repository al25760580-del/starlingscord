...
public class ExceptionsManagerModule extends NativeExceptionsManagerSpec {
    ...
    public void reportException(@NotNull ReadableMap data) {
        ...
        boolean z5 = data.hasKey(StackTraceHelper.IS_FATAL_KEY) ? data.getBoolean(StackTraceHelper.IS_FATAL_KEY) : false;
        ...
        o8.a.g(ReactConstants.TAG, JSStackTrace.format(string, array));
        if (extraDataAsJson != null) {
            o8.a.a(extraDataAsJson, ReactConstants.TAG, "extraData: %s");
        }
    }
