...
public final class ReactNetworkImageRequest extends ImageRequest {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ ReactNetworkImageRequest fromBuilderWithHeaders$default(Companion companion, ImageRequestBuilder imageRequestBuilder, ReadableMap readableMap, ImageCacheControl imageCacheControl, int i7, Object obj) {
            if ((i7 & 4) != 0) {
        ...
        @NotNull
        public final ReactNetworkImageRequest fromBuilderWithHeaders(@NotNull ImageRequestBuilder builder, ReadableMap headers, @NotNull ImageCacheControl cacheControl) {
            Intrinsics.checkNotNullParameter(builder, "builder");
