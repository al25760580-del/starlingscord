...
public final class I18nManagerModule extends NativeI18nManagerSpec {
    ...
    public Map<String, Object> getTypedExportedConstants() {
        ...
        return w0.g(new Pair("isRTL", Boolean.valueOf(companion.getInstance().isRTL(reactApplicationContext))), new Pair("doLeftAndRightSwapInRTL", Boolean.valueOf(companion.getInstance().doLeftAndRightSwapInRTL(reactApplicationContext))), new Pair("localeIdentifier", locale.toString()));
    }
