...
public final class I18nUtil {
    ...
    private final boolean isDevicePreferredLanguageRTL() {
        return TextUtils.getLayoutDirectionFromLocale(Locale.getAvailableLocales()[0]) == 1;
    }
    ...
    private final boolean isRTLForced(Context context) {
        return isPrefSet(context, KEY_FOR_PREFS_FORCERTL, false) || x.i(System.getProperty("FORCE_RTL_FOR_TESTING", "false"), "true", true);
    }
