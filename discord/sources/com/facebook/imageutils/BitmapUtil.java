...
public final class BitmapUtil {
    ...
    /* JADX INFO: renamed from: DECODE_BUFFERS$delegate, reason: from kotlin metadata */
    @NotNull
    private static final Lazy DECODE_BUFFERS = l.b(new c(5));
    ...
    private final ByteBuffer acquireByteBuffer() {
        ...
        hs.c cVar = a.f18629a;
        return (ByteBuffer) a.f18629a.get();
    }
    ...
    public static final int getSizeInByteForBitmap(int width, int height, Bitmap.Config bitmapConfig) {
        if (width <= 0) {
            throw new IllegalArgumentException(b.h(width, "width must be > 0, width is: ").toString());
        }
        if (height <= 0) {
            throw new IllegalArgumentException(b.h(height, "height must be > 0, height is: ").toString());
        }
        int pixelSizeForBitmapConfig = getPixelSizeForBitmapConfig(bitmapConfig);
        int i7 = width * height * pixelSizeForBitmapConfig;
        if (i7 > 0) {
            return i7;
        }
        StringBuilder sbR = e.r(i7, "size must be > 0: size: ", width, ", width: ", ", height: ");
        sbR.append(height);
        sbR.append(", pixelSize: ");
        sbR.append(pixelSizeForBitmapConfig);
