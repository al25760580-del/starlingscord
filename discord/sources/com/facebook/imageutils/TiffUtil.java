...
public final class TiffUtil {
    ...
    public static final class TiffHeader {
        ...
        /* JADX INFO: renamed from: isLittleEndian, reason: from getter */
        public final boolean getIsLittleEndian() {
            return this.isLittleEndian;
        }

        public final void setByteOrder(int i7) {
            this.byteOrder = i7;
        }

        public final void setFirstIfdOffset(int i7) {
            this.firstIfdOffset = i7;
        }

        public final void setLittleEndian(boolean z5) {
    ...
    private final int readTiffHeader(InputStream stream, int length, TiffHeader tiffHeader) {
        ...
        int i7 = length - 8;
        if (tiffHeader.getFirstIfdOffset() >= 8 && tiffHeader.getFirstIfdOffset() - 8 <= i7) {
            return i7;
        }
        a.d(TAG, "Invalid offset");
        return 0;
    }
}
