...
public final /* data */ class AFAdRevenueData {
    ...
    public static /* synthetic */ AFAdRevenueData copy$default(AFAdRevenueData aFAdRevenueData, String str, MediationNetwork mediationNetwork, String str2, double d6, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public final boolean areAllFieldsValid() {
        return !StringsKt.K(this.monetizationNetwork) && AFAdRevenueData();
    }
