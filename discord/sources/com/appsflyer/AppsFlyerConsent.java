...
public final /* data */ class AppsFlyerConsent {
    ...
    public static /* synthetic */ AppsFlyerConsent copy$default(AppsFlyerConsent appsFlyerConsent, Boolean bool, Boolean bool2, Boolean bool3, Boolean bool4, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    @NotNull
    @d
    public static final AppsFlyerConsent forGDPRUser(boolean z5, boolean z6) {
        return INSTANCE.forGDPRUser(z5, z6);
    }
    ...
    public /* synthetic */ AppsFlyerConsent(Boolean bool, Boolean bool2, Boolean bool3, Boolean bool4, int i7, DefaultConstructorMarker defaultConstructorMarker) {
