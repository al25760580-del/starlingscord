...
public class CrossPromotionHelper {
    ...
    @NonNull
    private static LinkGenerator AFAdRevenueData(@NonNull Context context, String str, String str2, Map<String, String> map, String str3) {
    ...
    private static void getMediationNetwork(@NonNull String str, @NonNull Context context, AFk1sSDK aFk1sSDK) {
        ...
        aFe1nSDKCopydefault.AFAdRevenueData.execute(aFe1nSDKCopydefault.new AnonymousClass3(aFe1cSDK));
    }
    ...
    public static void logAndOpenStore(@NonNull Context context, String str, String str2, Map<String, String> map) {
        LinkGenerator linkGeneratorAFAdRevenueData = AFAdRevenueData(context, str, str2, map, String.format(AFk1uSDK.getMediationNetwork, AppsFlyerLib.getInstance().getHostPrefix(), AFa1uSDK.getMonetizationNetwork().getHostName()));
        ...
        getMediationNetwork(linkGeneratorAFAdRevenueData.generateLink(), context, new AFk1sSDK(context));
    }
