...
public abstract class AppsFlyerLib {
    public static AppsFlyerLib getInstance() {
        return AFa1uSDK.getMonetizationNetwork();
    }

    public abstract void addPushNotificationDeepLinkPath(String... strArr);

    public abstract void anonymizeUser(boolean z5);
    ...
    public abstract void enableFacebookDeferredApplinks(boolean z5);

    public abstract void enableTCFDataCollection(boolean z5);
    ...
    public abstract void logLocation(Context context, double d6, double d7);
    ...
    public abstract void setCollectAndroidID(boolean z5);

    public abstract void setCollectIMEI(boolean z5);

    @Deprecated
    public abstract void setCollectOaid(boolean z5);
    ...
    public abstract void setDebugLog(boolean z5);

    public abstract void setDisableAdvertisingIdentifiers(boolean z5);

    public abstract void setDisableNetworkData(boolean z5);
    ...
    public abstract void setIsUpdate(boolean z5);

    public abstract void setLogLevel(AFLogger.LogLevel logLevel);

    public abstract void setMinTimeBetweenSessions(int i7);
    ...
    public abstract void stop(boolean z5, Context context);
    ...
    public abstract void waitForCustomerUserId(boolean z5);
}
