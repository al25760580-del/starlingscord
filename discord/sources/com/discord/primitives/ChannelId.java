...
public final class ChannelId implements SnowflakePrimitive {
    ...
    public static final class Creator implements Parcelable.Creator<ChannelId> {
        ...
        public /* bridge */ /* synthetic */ ChannelId createFromParcel(Parcel parcel) {
            return ChannelId.m1130boximpl(m1142createFromParcel18flms(parcel));
        }

        /* JADX INFO: renamed from: createFromParcel-18-flms, reason: not valid java name */
        public final long m1142createFromParcel18flms(Parcel parcel) {
            Intrinsics.checkNotNullParameter(parcel, "parcel");
            return ChannelId.m1131constructorimpl(parcel.readLong());
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final ChannelId[] newArray(int i7) {
            return new ChannelId[i7];
        }
    }

    private /* synthetic */ ChannelId(long j) {
        this.snowflake = j;
    }

    /* JADX INFO: renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ ChannelId m1130boximpl(long j) {
        return new ChannelId(j);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m1131constructorimpl(long j) {
        return j;
    }

    /* JADX INFO: renamed from: describeContents-impl, reason: not valid java name */
    public static final int m1132describeContentsimpl(long j) {
        return 0;
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m1133equalsimpl(long j, Object obj) {
        return (obj instanceof ChannelId) && j == ((ChannelId) obj).m1139unboximpl();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m1134equalsimpl0(long j, long j5) {
        return j == j5;
    }
    ...
    public static boolean m1136isValidimpl(long j) {
        return j > 0;
    }
    ...
    public static final void m1138writeToParcelimpl(long j, @NotNull Parcel dest, int i7) {
    ...
    public final int describeContents() {
        return m1132describeContentsimpl(this.snowflake);
    }

    public boolean equals(Object obj) {
        return m1133equalsimpl(this.snowflake, obj);
    }
    ...
    public int hashCode() {
        return m1135hashCodeimpl(this.snowflake);
    }

    @Override // com.discord.snowflake.SnowflakePrimitive
    public boolean isValid() {
        return m1136isValidimpl(this.snowflake);
    }

    @NotNull
    public String toString() {
        return m1137toStringimpl(this.snowflake);
    }

    /* JADX INFO: renamed from: unbox-impl, reason: not valid java name */
    public final /* synthetic */ long m1139unboximpl() {
        return this.snowflake;
    }
    ...
    public final void writeToParcel(@NotNull Parcel dest, int i7) {
        Intrinsics.checkNotNullParameter(dest, "dest");
        m1138writeToParcelimpl(this.snowflake, dest, i7);
    }
}
