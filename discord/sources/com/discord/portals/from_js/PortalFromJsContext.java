...
public interface PortalFromJsContext {
    int getPortalViewIndex(@NotNull View portalView);

    void onPortalFromJsAdded(@NotNull String portalId, @NotNull View portalView);

    void onPortalFromJsRemoved(@NotNull String portalId, @NotNull View portalView);
}
