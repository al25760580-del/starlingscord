...
public final class FastestListViewHolderItem extends FastestListViewHolder {
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FastestListViewHolderItem(@NotNull ViewGroup parent, @NotNull Function2<? super FastestListSections.Entry, ? super Integer, Unit> onUnexpectedItemSize) {
