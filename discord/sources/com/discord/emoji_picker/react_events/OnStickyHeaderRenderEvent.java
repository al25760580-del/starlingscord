...
public final /* data */ class OnStickyHeaderRenderEvent implements ReactEvent {
    ...
    public /* synthetic */ OnStickyHeaderRenderEvent(int i7, int i10, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (i7 & 1)) {
            this.index = i10;
        } else {
            e1.l(i7, 1, OnStickyHeaderRenderEvent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    public static /* synthetic */ OnStickyHeaderRenderEvent copy$default(OnStickyHeaderRenderEvent onStickyHeaderRenderEvent, int i7, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            i7 = onStickyHeaderRenderEvent.index;
        }
        return onStickyHeaderRenderEvent.copy(i7);
    }
    ...
    @NotNull
    public final OnStickyHeaderRenderEvent copy(int index) {
        return new OnStickyHeaderRenderEvent(index);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof OnStickyHeaderRenderEvent) && this.index == ((OnStickyHeaderRenderEvent) other).index;
    }
    ...
    public String toString() {
        return g.d(this.index, "OnStickyHeaderRenderEvent(index=", ")");
    }

    public OnStickyHeaderRenderEvent(int i7) {
        this.index = i7;
    }
}
