...
public final /* data */ class OnLongPressEmojiEvent implements ReactEvent {
    ...
    public /* synthetic */ OnLongPressEmojiEvent(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 != (i7 & 1)) {
            e1.l(i7, 1, OnLongPressEmojiEvent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.emojiName = str;
        if ((i7 & 2) == 0) {
    ...
    public static /* synthetic */ OnLongPressEmojiEvent copy$default(OnLongPressEmojiEvent onLongPressEmojiEvent, String str, String str2, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$emoji_picker_release(OnLongPressEmojiEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        output.q(serialDesc, 0, self.emojiName);
        if (!output.u(serialDesc, 1) && self.emojiId == null) {
            return;
        }
        output.r(serialDesc, 1, s1.f17602a, self.emojiId);
    }
    ...
    @NotNull
    public final OnLongPressEmojiEvent copy(@NotNull String emojiName, String emojiId) {
        Intrinsics.checkNotNullParameter(emojiName, "emojiName");
        return new OnLongPressEmojiEvent(emojiName, emojiId);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof OnLongPressEmojiEvent)) {
            return false;
        }
        OnLongPressEmojiEvent onLongPressEmojiEvent = (OnLongPressEmojiEvent) other;
    ...
    public int hashCode() {
        int iHashCode = this.emojiName.hashCode() * 31;
    ...
    public String toString() {
        return g.f("OnLongPressEmojiEvent(emojiName=", this.emojiName, ", emojiId=", this.emojiId, ")");
    }
    ...
    public /* synthetic */ OnLongPressEmojiEvent(String str, String str2, int i7, DefaultConstructorMarker defaultConstructorMarker) {
