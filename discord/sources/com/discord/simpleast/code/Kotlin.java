...
public final class Kotlin {
            ...
            public final <RC, S> Rule<RC, Node<RC>, S> createFieldRule(@NotNull final CodeStyleProviders<RC> codeStyleProviders) {
                ...
                return new Rule<RC, Node<RC>, S>(PATTERN_KOTLIN_FIELD) { // from class: com.discord.simpleast.code.Kotlin$FieldNode$Companion$createFieldRule$1
                    ...
                    public ParseSpec<RC, S> parse(@NotNull Matcher matcher, @NotNull Parser<RC, ? super Node<RC>, S> parser, S state) {
                        ...
                        return companion.createTerminal(new Kotlin.FieldNode(strGroup, strGroup2, codeStyleProviders), state);
                    }
                };
            }
    ...
    public static final class FunctionNode<RC> extends Node.Parent<RC> {
        ...
        /* JADX INFO: renamed from: Companion, reason: from kotlin metadata */
        public static final Companion INSTANCE = new Companion(null);
        private static final Pattern PATTERN_KOTLIN_FUNC = new Regex("^(fun)( *<.*>)?( \\w+)( *\\(.*?\\))", p.DOT_MATCHES_ALL).f14706d;
            ...
            public final <RC, S> Rule<RC, Node<RC>, S> createFunctionRule(@NotNull final CodeStyleProviders<RC> codeStyleProviders) {
                ...
                return new Rule<RC, Node<RC>, S>(pattern) { // from class: com.discord.simpleast.code.Kotlin$FunctionNode$Companion$createFunctionRule$1
                    ...
                    public ParseSpec<RC, S> parse(@NotNull Matcher matcher, @NotNull Parser<RC, ? super Node<RC>, S> parser, S state) {
                        ...
                        return companion.createTerminal(new Kotlin.FunctionNode(strGroup, strGroup2, strGroup3, strGroup4, codeStyleProviders), state);
                    }
                };
            }
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public FunctionNode(@NotNull String pre, String str, @NotNull String signature, @NotNull String params, @NotNull CodeStyleProviders<RC> codeStyleProviders) {
            super(new StyleNode.TextStyledNode(pre, codeStyleProviders.getKeywordStyleProvider()), str != null ? new StyleNode.TextStyledNode(str, codeStyleProviders.getGenericsStyleProvider()) : null, new StyleNode.TextStyledNode(signature, codeStyleProviders.getIdentifierStyleProvider()), new StyleNode.TextStyledNode(params, codeStyleProviders.getParamsStyleProvider()));
    ...
    public final <RC, S> List<Rule<RC, Node<RC>, S>> createKotlinCodeRules$simpleast_core_release(@NotNull CodeStyleProviders<RC> codeStyleProviders) {
        ...
        return d0.g(matchGroupRule$default, matchGroupRule$default2, CodeRules.toMatchGroupRule$default(codeRules, PATTERN_KOTLIN_ANNOTATION2, 0, codeStyleProviders.getGenericsStyleProvider(), 1, null), FieldNode.INSTANCE.createFieldRule(codeStyleProviders), FunctionNode.INSTANCE.createFunctionRule(codeStyleProviders));
    }
