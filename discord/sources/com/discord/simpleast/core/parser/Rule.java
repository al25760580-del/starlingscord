...
public abstract class Rule<R, T extends Node<R>, S> {
    ...
    public static abstract class BlockRule<R, T extends Node<R>, S> extends Rule<R, T, S> {
        ...
        public BlockRule(@NotNull Pattern pattern) {
            super(pattern);
            Intrinsics.checkNotNullParameter(pattern, "pattern");
        }

        @Override // com.discord.simpleast.core.parser.Rule
        public Matcher match(@NotNull CharSequence inspectionSource, String lastCapture, S state) {
            Intrinsics.checkNotNullParameter(inspectionSource, "inspectionSource");
            if (lastCapture == null || StringsKt.G(lastCapture, '\n')) {
    ...
    public Rule(@NotNull Matcher matcher) {
    ...
    @NotNull
    public abstract ParseSpec<R, S> parse(@NotNull Matcher matcher, @NotNull Parser<R, ? super T, S> parser, S state);

    /* JADX WARN: Illegal instructions before constructor call */
    public Rule(@NotNull Pattern pattern) {
        Intrinsics.checkNotNullParameter(pattern, "pattern");
