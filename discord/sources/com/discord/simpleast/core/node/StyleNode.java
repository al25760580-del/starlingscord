...
public class StyleNode<RC, T> extends Node.Parent<RC> {
    ...
    public static final class Companion {
        ...
        @NotNull
        public final <RC, T> StyleNode<RC, T> wrapText(@NotNull String content, @NotNull List<? extends T> styles) {
    ...
    public static final class TextStyledNode<RC> extends TextNode<RC> {
        ...
        public TextStyledNode(@NotNull String content, @NotNull SpanProvider<RC> stylesProvider) {
            super(content);
            Intrinsics.checkNotNullParameter(content, "content");
        ...
        public void render(@NotNull SpannableStringBuilder builder, RC renderContext) {
            ...
            Iterator<?> it = this.stylesProvider.get(renderContext).iterator();
            while (it.hasNext()) {
    ...
    public StyleNode(@NotNull List<? extends T> styles) {
        super(new Node[0]);
        Intrinsics.checkNotNullParameter(styles, "styles");
        this.styles = styles;
    }
    ...
    @NotNull
    public static final <RC, T> StyleNode<RC, T> wrapText(@NotNull String str, @NotNull List<? extends T> list) {
        return INSTANCE.wrapText(str, list);
    }
