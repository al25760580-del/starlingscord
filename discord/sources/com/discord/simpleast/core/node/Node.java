...
public class Node<R> {
    ...
    public static class Parent<R> extends Node<R> {
        public Parent(@NotNull Node<R>... children) {
            ...
            super(CollectionsKt.j0(arrayList));
        }
        ...
        public String toString() {
            ...
            sb2.append(" >\n");
            Collection<Node<R>> children = getChildren();
            sb2.append(children != null ? CollectionsKt.O(children, "\n->", ">>", "\n>|", new Function1<Node<R>, CharSequence>() { // from class: com.discord.simpleast.core.node.Node$Parent$toString$1
                @Override // kotlin.jvm.functions.Function1
                @NotNull
                public final CharSequence invoke(@NotNull Node<R> it) {
    ...
    public final void addChild(@NotNull Node<R> child) {
    ...
    public /* synthetic */ Node(Collection collection, int i7, DefaultConstructorMarker defaultConstructorMarker) {
        this((i7 & 1) != 0 ? null : collection);
    }
}
