...
public final /* data */ class AudioOutputDeviceDescription {
    ...
    public static /* synthetic */ AudioOutputDeviceDescription copy$default(AudioOutputDeviceDescription audioOutputDeviceDescription, String str, String str2, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public String toString() {
        return g.f("AudioOutputDeviceDescription(name=", this.name, ", guid=", this.guid, ")");
    }
}
