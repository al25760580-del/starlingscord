...
public final /* data */ class ThreadEmbedMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ ThreadEmbedMessageAccessory m708copyntcYbpo$default(ThreadEmbedMessageAccessory threadEmbedMessageAccessory, String str, ThreadEmbed threadEmbed, int i7, Object obj) {
        if ((i7 & 1) != 0) {
        ...
        return threadEmbedMessageAccessory.m710copyntcYbpo(str, threadEmbed);
    }
    ...
    public final ThreadEmbedMessageAccessory m710copyntcYbpo(@NotNull String messageId, @NotNull ThreadEmbed threadEmbed) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ThreadEmbedMessageAccessory)) {
            return false;
        }
        ThreadEmbedMessageAccessory threadEmbedMessageAccessory = (ThreadEmbedMessageAccessory) other;
        return MessageId.m1160equalsimpl0(this.messageId, threadEmbedMessageAccessory.messageId) && Intrinsics.areEqual(this.threadEmbed, threadEmbedMessageAccessory.threadEmbed);
    }
    ...
    public int hashCode() {
        return this.threadEmbed.hashCode() + (MessageId.m1161hashCodeimpl(this.messageId) * 31);
    }

    @NotNull
    public String toString() {
        return "ThreadEmbedMessageAccessory(messageId=" + MessageId.m1163toStringimpl(this.messageId) + ", threadEmbed=" + this.threadEmbed + ")";
    }
