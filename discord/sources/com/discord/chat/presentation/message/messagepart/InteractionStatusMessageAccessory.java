...
public final /* data */ class InteractionStatusMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ InteractionStatusMessageAccessory m654copyntcYbpo$default(InteractionStatusMessageAccessory interactionStatusMessageAccessory, String str, InteractionStatus interactionStatus, int i7, Object obj) {
        if ((i7 & 1) != 0) {
        ...
        return interactionStatusMessageAccessory.m656copyntcYbpo(str, interactionStatus);
    }
    ...
    public final InteractionStatusMessageAccessory m656copyntcYbpo(@NotNull String messageId, @NotNull InteractionStatus interactionStatus) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof InteractionStatusMessageAccessory)) {
            return false;
        }
        InteractionStatusMessageAccessory interactionStatusMessageAccessory = (InteractionStatusMessageAccessory) other;
        return MessageId.m1160equalsimpl0(this.messageId, interactionStatusMessageAccessory.messageId) && Intrinsics.areEqual(this.interactionStatus, interactionStatusMessageAccessory.interactionStatus);
    }
    ...
    public int hashCode() {
        return this.interactionStatus.hashCode() + (MessageId.m1161hashCodeimpl(this.messageId) * 31);
    }

    @NotNull
    public String toString() {
        return "InteractionStatusMessageAccessory(messageId=" + MessageId.m1163toStringimpl(this.messageId) + ", interactionStatus=" + this.interactionStatus + ")";
    }
