...
public final /* data */ class FlaggedMessageActionBarAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ FlaggedMessageActionBarAccessory m611copyu7_MRrM$default(FlaggedMessageActionBarAccessory flaggedMessageActionBarAccessory, String str, Message message, AutoModerationContext autoModerationContext, int i7, Object obj) {
        if ((i7 & 1) != 0) {
        ...
        return flaggedMessageActionBarAccessory.m613copyu7_MRrM(str, message, autoModerationContext);
    }
    ...
    public final FlaggedMessageActionBarAccessory m613copyu7_MRrM(@NotNull String messageId, @NotNull Message message, @NotNull AutoModerationContext autoModerationContext) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof FlaggedMessageActionBarAccessory)) {
            return false;
        }
        FlaggedMessageActionBarAccessory flaggedMessageActionBarAccessory = (FlaggedMessageActionBarAccessory) other;
        return MessageId.m1160equalsimpl0(this.messageId, flaggedMessageActionBarAccessory.messageId) && Intrinsics.areEqual(this.message, flaggedMessageActionBarAccessory.message) && Intrinsics.areEqual(this.autoModerationContext, flaggedMessageActionBarAccessory.autoModerationContext);
    }
    ...
    public int hashCode() {
        return this.autoModerationContext.hashCode() + ((this.message.hashCode() + (MessageId.m1161hashCodeimpl(this.messageId) * 31)) * 31);
    }

    @NotNull
    public String toString() {
        return "FlaggedMessageActionBarAccessory(messageId=" + MessageId.m1163toStringimpl(this.messageId) + ", message=" + this.message + ", autoModerationContext=" + this.autoModerationContext + ")";
    }
