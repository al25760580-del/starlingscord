...
public final /* data */ class GiftMessageAccessory extends MessageAccessory {
    ...
    public /* synthetic */ GiftMessageAccessory(String str, int i7, GiftEmbed giftEmbed, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, i7, giftEmbed);
    }

    /* JADX INFO: renamed from: copy-u7_MRrM$default, reason: not valid java name */
    public static /* synthetic */ GiftMessageAccessory m631copyu7_MRrM$default(GiftMessageAccessory giftMessageAccessory, String str, int i7, GiftEmbed giftEmbed, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            str = giftMessageAccessory.messageId;
        }
        if ((i10 & 2) != 0) {
            i7 = giftMessageAccessory.index;
        }
        if ((i10 & 4) != 0) {
            giftEmbed = giftMessageAccessory.gift;
        }
        return giftMessageAccessory.m633copyu7_MRrM(str, i7, giftEmbed);
    }
    ...
    public final GiftMessageAccessory m633copyu7_MRrM(@NotNull String messageId, int index, @NotNull GiftEmbed gift) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        Intrinsics.checkNotNullParameter(gift, "gift");
        return new GiftMessageAccessory(messageId, index, gift, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GiftMessageAccessory)) {
            return false;
        }
        GiftMessageAccessory giftMessageAccessory = (GiftMessageAccessory) other;
        return MessageId.m1160equalsimpl0(this.messageId, giftMessageAccessory.messageId) && this.index == giftMessageAccessory.index && Intrinsics.areEqual(this.gift, giftMessageAccessory.gift);
    }
    ...
    public int hashCode() {
        return this.gift.hashCode() + a.u(this.index, MessageId.m1161hashCodeimpl(this.messageId) * 31, 31);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbT = e.t("GiftMessageAccessory(messageId=", strM1163toStringimpl, ", index=", i7, ", gift=");
        sbT.append(giftEmbed);
        sbT.append(")");
        return sbT.toString();
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    private GiftMessageAccessory(String messageId, int i7, GiftEmbed gift) {
        super(messageId, "gift " + i7, false, 4, null);
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        Intrinsics.checkNotNullParameter(gift, "gift");
