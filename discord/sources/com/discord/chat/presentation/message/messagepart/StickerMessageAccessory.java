...
public final /* data */ class StickerMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ StickerMessageAccessory m702copyntcYbpo$default(StickerMessageAccessory stickerMessageAccessory, String str, Sticker sticker, int i7, Object obj) {
        if ((i7 & 1) != 0) {
        ...
        return stickerMessageAccessory.m704copyntcYbpo(str, sticker);
    }
    ...
    public final StickerMessageAccessory m704copyntcYbpo(@NotNull String messageId, @NotNull Sticker sticker) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof StickerMessageAccessory)) {
            return false;
        }
        StickerMessageAccessory stickerMessageAccessory = (StickerMessageAccessory) other;
        return MessageId.m1160equalsimpl0(this.messageId, stickerMessageAccessory.messageId) && Intrinsics.areEqual(this.sticker, stickerMessageAccessory.sticker);
    }
    ...
    public String toString() {
        return "StickerMessageAccessory(messageId=" + MessageId.m1163toStringimpl(this.messageId) + ", sticker=" + this.sticker + ")";
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    private StickerMessageAccessory(String messageId, Sticker sticker) {
        super(messageId, b.i(sticker.getId(), "sticker-"), false, 4, null);
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        Intrinsics.checkNotNullParameter(sticker, "sticker");
