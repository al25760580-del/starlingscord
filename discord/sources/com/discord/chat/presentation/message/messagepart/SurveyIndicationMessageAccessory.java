...
public final /* data */ class SurveyIndicationMessageAccessory extends MessageAccessory {
    ...
    public static /* synthetic */ SurveyIndicationMessageAccessory m705copyntcYbpo$default(SurveyIndicationMessageAccessory surveyIndicationMessageAccessory, String str, SurveyIndication surveyIndication, int i7, Object obj) {
        if ((i7 & 1) != 0) {
        ...
        return surveyIndicationMessageAccessory.m707copyntcYbpo(str, surveyIndication);
    }
    ...
    public final SurveyIndicationMessageAccessory m707copyntcYbpo(@NotNull String messageId, @NotNull SurveyIndication surveyIndication) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SurveyIndicationMessageAccessory)) {
            return false;
        }
        SurveyIndicationMessageAccessory surveyIndicationMessageAccessory = (SurveyIndicationMessageAccessory) other;
        return MessageId.m1160equalsimpl0(this.messageId, surveyIndicationMessageAccessory.messageId) && Intrinsics.areEqual(this.surveyIndication, surveyIndicationMessageAccessory.surveyIndication);
    }
    ...
    public int hashCode() {
        return this.surveyIndication.hashCode() + (MessageId.m1161hashCodeimpl(this.messageId) * 31);
    }

    @NotNull
    public String toString() {
        return "SurveyIndicationMessageAccessory(messageId=" + MessageId.m1163toStringimpl(this.messageId) + ", surveyIndication=" + this.surveyIndication + ")";
    }
