...
public final /* data */ class WelcomeStickerAccessory extends MessageAccessory {
    ...
    public WelcomeStickerAccessory(@NotNull Message message, @NotNull Sticker sticker) {
        super(message.m267getId3Eiw7ao(), b.i(sticker.getId(), "welcome sticker "), false, 4, null);
    ...
    public static /* synthetic */ WelcomeStickerAccessory copy$default(WelcomeStickerAccessory welcomeStickerAccessory, Message message, Sticker sticker, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof WelcomeStickerAccessory)) {
            return false;
        }
        WelcomeStickerAccessory welcomeStickerAccessory = (WelcomeStickerAccessory) other;
    ...
    public int hashCode() {
        return this.sticker.hashCode() + (this.message.hashCode() * 31);
    }

    @NotNull
    public String toString() {
        return "WelcomeStickerAccessory(message=" + this.message + ", sticker=" + this.sticker + ")";
    }
}
