...
public final /* data */ class ChannelPromptActionsAccessory extends MessageAccessory {
    ...
    public ChannelPromptActionsAccessory(@NotNull Message message) {
        super(message.m267getId3Eiw7ao(), "channel deadchat prompt actions", false, 4, null);
        Intrinsics.checkNotNullParameter(message, "message");
        this.message = message;
    }

    public static /* synthetic */ ChannelPromptActionsAccessory copy$default(ChannelPromptActionsAccessory channelPromptActionsAccessory, Message message, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ChannelPromptActionsAccessory) && Intrinsics.areEqual(this.message, ((ChannelPromptActionsAccessory) other).message);
    }
    ...
    public String toString() {
        return "ChannelPromptActionsAccessory(message=" + this.message + ")";
    }
}
