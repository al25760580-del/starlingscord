...
public final class SeparatorDisplayComponentView extends LinearLayout implements ComponentView<SeparatorDisplayComponent> {
    ...
    public void configure(@NotNull SeparatorDisplayComponent component, @NotNull ComponentProvider componentProvider, @NotNull ComponentContext componentContext) {
        ...
        int i7 = WhenMappings.$EnumSwitchMapping$0[component.getSpacing().ordinal()];
        int dpToPx = 0;
        if (i7 != 1) {
            if (i7 == 2) {
    ...
    public /* synthetic */ SeparatorDisplayComponentView(Context context, AttributeSet attributeSet, int i7, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i10 & 2) != 0 ? null : attributeSet, (i10 & 4) != 0 ? 0 : i7);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SeparatorDisplayComponentView(@NotNull Context context, AttributeSet attributeSet, int i7) {
        super(context, attributeSet, i7);
        Intrinsics.checkNotNullParameter(context, "context");
        MessageComponentSeparatorDisplayViewBinding messageComponentSeparatorDisplayViewBindingInflate = MessageComponentSeparatorDisplayViewBinding.inflate(LayoutInflater.from(context), this);
        Intrinsics.checkNotNullExpressionValue(messageComponentSeparatorDisplayViewBindingInflate, "inflate(...)");
        this.binding = messageComponentSeparatorDisplayViewBindingInflate;
