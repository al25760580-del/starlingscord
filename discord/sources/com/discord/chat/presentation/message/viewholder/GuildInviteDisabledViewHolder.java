...
public final class GuildInviteDisabledViewHolder extends MessagePartViewHolder {
    ...
    public static final Unit bind$lambda$1$lambda$0(GuildInviteDisabledViewHolder guildInviteDisabledViewHolder, GuildInviteDisabledMessageAccessory guildInviteDisabledMessageAccessory, String it) {
        ...
        ChatEventHandler.DefaultImpls.m522onLinkClickedu7_MRrM$default(guildInviteDisabledViewHolder.eventHandler, guildInviteDisabledMessageAccessory.getMessageId(), it, null, 4, null);
        return Unit.f14616a;
    }

    public final void bind(@NotNull GuildInviteDisabledMessageAccessory inviteAccessory) {
        ...
        guildInviteDisabledView.setHelpIcon(invite.getHelpCenterArticleLabel(), invite.getHelpCenterArticleURL(), new b7.a(18, this, inviteAccessory));
