...
public final /* data */ class TapReactionOverflow implements ReactEvent {
    ...
    public /* synthetic */ TapReactionOverflow(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i7 & 3)) {
            e1.l(i7, 3, TapReactionOverflow$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.messageId = str;
        this.channelId = str2;
    ...
    public static /* synthetic */ TapReactionOverflow copy$default(TapReactionOverflow tapReactionOverflow, String str, String str2, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapReactionOverflow self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapReactionOverflow)) {
            return false;
        }
        TapReactionOverflow tapReactionOverflow = (TapReactionOverflow) other;
    ...
    public String toString() {
        return g.f("TapReactionOverflow(messageId=", this.messageId, ", channelId=", this.channelId, ")");
    }
