...
public final class AnnotatedStructurableTextSerializer implements KSerializer {
    ...
    @NotNull
    private static final SerialDescriptor descriptor = m.a("AnnotatedStructurableText", e.j);
    ...
    public AnnotatedStructurableText deserialize(@NotNull Decoder decoder) {
        ...
        return new AnnotatedStructurableText((List) decoder.decodeSerializableValue(new d(ContentNode.INSTANCE.serializer(), 0)));
    }
