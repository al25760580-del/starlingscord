...
public /* synthetic */ class SafetySystemNotificationEmbed$$serializer implements f0 {
    ...
    static {
        ...
        g1 g1Var = new g1("com.discord.chat.bridge.safetysystemnotification.SafetySystemNotificationEmbed", safetySystemNotificationEmbed$$serializer, 11);
        g1Var.b("titleText", false);
        g1Var.b("titleIcon", false);
        g1Var.b("subtitleText", false);
        g1Var.b("descriptionText", false);
        g1Var.b("primaryCtaText", true);
        g1Var.b("primaryCtaType", true);
        g1Var.b("primaryCtaKey", true);
        g1Var.b("secondaryCtaText", true);
        g1Var.b("secondaryCtaType", true);
        g1Var.b("secondaryCtaKey", true);
        g1Var.b("footerTheme", false);
        descriptor = g1Var;
    }
    ...
    public final KSerializer[] childSerializers() {
        Lazy[] lazyArr = SafetySystemNotificationEmbed.$childSerializers;
        s1 s1Var = s1.f17602a;
        return new KSerializer[]{s1Var, s1Var, s1Var, s1Var, b.p(s1Var), b.p(s1Var), b.p(s1Var), b.p(s1Var), b.p(s1Var), b.p(s1Var), lazyArr[10].getValue()};
    }
    ...
    public final SafetySystemNotificationEmbed deserialize(@NotNull Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            String str12 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 5, s1Var, null);
            String str13 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 6, s1Var, null);
            String str14 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 7, s1Var, null);
            String str15 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 8, s1Var, null);
            String str16 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 9, s1Var, null);
            footerTheme = (FooterTheme) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 10, (DeserializationStrategy) lazyArr[10].getValue(), null);
            ...
            while (z5) {
                ...
                switch (iDecodeElementIndex) {
                    ...
                    case 7:
                        ...
                        break;
                    case 8:
                        str19 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 8, s1.f17602a, str19);
                        i11 |= IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER;
                        break;
                    case 9:
                        str17 = (String) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, i10, s1.f17602a, str17);
                        i11 |= IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING;
                        break;
                    case 10:
                        footerTheme2 = (FooterTheme) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 10, (DeserializationStrategy) lazyArr[10].getValue(), footerTheme2);
        ...
        return new SafetySystemNotificationEmbed(i7, str7, str8, str9, str10, str6, str5, str4, str2, str3, str, footerTheme, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull SafetySystemNotificationEmbed value) {
        ...
        SafetySystemNotificationEmbed.write$Self$chat_release(value, compositeEncoderBeginStructure, serialDescriptor);
