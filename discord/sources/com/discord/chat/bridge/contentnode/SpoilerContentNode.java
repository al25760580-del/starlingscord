...
public final /* data */ class SpoilerContentNode extends ContentNode implements SpoilerableData {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {l.a(m.f19486e, new a(14)), null, null};
    ...
    public /* synthetic */ SpoilerContentNode(int i7, List list, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (1 != (i7 & 1)) {
            e1.l(i7, 1, SpoilerContentNode$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    ...
    public static /* synthetic */ SpoilerContentNode copy$default(SpoilerContentNode spoilerContentNode, List list, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(SpoilerContentNode self, CompositeEncoder output, SerialDescriptor serialDesc) {
        output.g(serialDesc, 0, (KSerializer) $childSerializers[0].getValue(), self.content);
        if (output.u(serialDesc, 1) || !Intrinsics.areEqual(self.getSpoilerOrNull(), "")) {
            output.q(serialDesc, 1, self.getSpoilerOrNull());
        }
        if (!output.u(serialDesc, 2) && Intrinsics.areEqual(self.getObscureOrNull(), "")) {
            return;
        }
        output.q(serialDesc, 2, self.getObscureOrNull());
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof SpoilerContentNode) && Intrinsics.areEqual(this.content, ((SpoilerContentNode) other).content);
    }
    ...
    public String toString() {
        return "SpoilerContentNode(content=" + this.content + ")";
    }
