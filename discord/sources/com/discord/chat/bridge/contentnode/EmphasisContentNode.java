...
public final /* data */ class EmphasisContentNode extends ContentNode {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {l.a(m.f19486e, new a(6))};
    ...
    public /* synthetic */ EmphasisContentNode(int i7, List list, SerializationConstructorMarker serializationConstructorMarker) {
        DefaultConstructorMarker defaultConstructorMarker = null;
        if (1 != (i7 & 1)) {
            e1.l(i7, 1, EmphasisContentNode$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    ...
    public static /* synthetic */ EmphasisContentNode copy$default(EmphasisContentNode emphasisContentNode, List list, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof EmphasisContentNode) && Intrinsics.areEqual(this.content, ((EmphasisContentNode) other).content);
    }
    ...
    public String toString() {
        return "EmphasisContentNode(content=" + this.content + ")";
    }
