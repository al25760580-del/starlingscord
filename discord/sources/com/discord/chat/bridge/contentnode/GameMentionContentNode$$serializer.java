...
@d
public /* synthetic */ class GameMentionContentNode$$serializer implements f0 {

    @NotNull
    public static final GameMentionContentNode$$serializer INSTANCE;

    @NotNull
    private static final SerialDescriptor descriptor;

    static {
        GameMentionContentNode$$serializer gameMentionContentNode$$serializer = new GameMentionContentNode$$serializer();
        INSTANCE = gameMentionContentNode$$serializer;
        g1 g1Var = new g1("gameMention", gameMentionContentNode$$serializer, 5);
    ...
    private GameMentionContentNode$$serializer() {
    }
    ...
    public final KSerializer[] childSerializers() {
        Lazy[] lazyArr = GameMentionContentNode.$childSerializers;
        s1 s1Var = s1.f17602a;
        return new KSerializer[]{ChannelId$$serializer.INSTANCE, b.p(s1Var), s1Var, b.p(s1Var), lazyArr[4].getValue()};
    }

    @Override // kotlinx.serialization.DeserializationStrategy
    @NotNull
    public final GameMentionContentNode deserialize(@NotNull Decoder decoder) {
        int i7;
        ChannelId channelId;
        String str;
        String str2;
        ...
        return new GameMentionContentNode(i7, channelId, str, str2, str3, list, null, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull GameMentionContentNode value) {
        ...
        GameMentionContentNode.write$Self$chat_release(value, compositeEncoderBeginStructure, serialDescriptor);
