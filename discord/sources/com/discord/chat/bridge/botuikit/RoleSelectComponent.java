...
public final /* data */ class RoleSelectComponent extends SearchableSelectComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, l.a(m.f19486e, new a(20))};
    ...
    public /* synthetic */ RoleSelectComponent(int i7, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z5, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(i7, serializationConstructorMarker);
        if (719 != (i7 & 719)) {
            e1.l(i7, 719, RoleSelectComponent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.type = i10;
        this.id = str;
    ...
    public static /* synthetic */ RoleSelectComponent copy$default(RoleSelectComponent roleSelectComponent, int i7, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i10, int i11, boolean z5, List list, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            i7 = roleSelectComponent.type;
        }
        if ((i12 & 2) != 0) {
            str = roleSelectComponent.id;
        }
        if ((i12 & 4) != 0) {
        ...
        String str5 = str3;
        String str6 = str4;
        return roleSelectComponent.copy(i7, str, actionComponentState, str2, str5, str6, i13, i14, z6, list2);
    }

    public static final /* synthetic */ void write$Self$chat_release(RoleSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    @NotNull
    public final RoleSelectComponent copy(int type, @NotNull String id2, @NotNull ActionComponentState state, @NotNull String customId, String placeholder, String accessibilityLabel, int minValues, int maxValues, boolean disabled, @NotNull List<SearchableSelectItem> selectedOptions) {
        Intrinsics.checkNotNullParameter(id2, "id");
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(customId, "customId");
        Intrinsics.checkNotNullParameter(selectedOptions, "selectedOptions");
        return new RoleSelectComponent(type, id2, state, customId, placeholder, accessibilityLabel, minValues, maxValues, disabled, selectedOptions);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbO = com.discord.chat.presentation.list.a.o("RoleSelectComponent(type=", ", id=", str, i7, ", state=");
    ...
    public /* synthetic */ RoleSelectComponent(int i7, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i10, int i11, boolean z5, List list, int i12, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RoleSelectComponent(int i7, @NotNull String id2, @NotNull ActionComponentState state, @NotNull String customId, String str, String str2, int i10, int i11, boolean z5, @NotNull List<SearchableSelectItem> selectedOptions) {
        super(null);
        Intrinsics.checkNotNullParameter(id2, "id");
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(customId, "customId");
