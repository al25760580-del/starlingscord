...
public /* synthetic */ class CheckpointEmoji$$serializer implements f0 {
    ...
    static {
        ...
        g1 g1Var = new g1("com.discord.chat.bridge.botuikit.CheckpointEmoji", checkpointEmoji$$serializer, 3);
        g1Var.b("emojiId", true);
        g1Var.b("emojiName", false);
        g1Var.b("emojiSurrogateName", true);
        descriptor = g1Var;
    }
    ...
    public final KSerializer[] childSerializers() {
        ...
        s1 s1Var = s1.f17602a;
        return new KSerializer[]{kSerializerP, s1Var, b.p(s1Var)};
    }
    ...
    public final CheckpointEmoji deserialize(@NotNull Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            Long l10 = (Long) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 0, r0.f17595a, null);
            ...
            while (z5) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    l7 = (Long) compositeDecoderBeginStructure.decodeNullableSerializableElement(serialDescriptor, 0, r0.f17595a, l7);
                    i10 |= 1;
        ...
        return new CheckpointEmoji(i7, l6, str, str2, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull CheckpointEmoji value) {
        ...
        CheckpointEmoji.write$Self$chat_release(value, compositeEncoderBeginStructure, serialDescriptor);
