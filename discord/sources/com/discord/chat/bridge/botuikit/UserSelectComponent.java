...
public final /* data */ class UserSelectComponent extends SearchableSelectComponent {
    ...
    @NotNull
    private static final Lazy[] $childSerializers = {null, null, null, null, null, null, null, null, null, l.a(m.f19486e, new a(27))};

    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00060\u0005¨\u0006\u0007"}, d2 = {"Lcom/discord/chat/bridge/botuikit/UserSelectComponent$Companion;", "", "<init>", "()V", "serializer", "Lkotlinx/serialization/KSerializer;", "Lcom/discord/chat/bridge/botuikit/UserSelectComponent;", "chat_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
    ...
    public /* synthetic */ UserSelectComponent(int i7, int i10, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i11, int i12, boolean z5, List list, SerializationConstructorMarker serializationConstructorMarker) {
        super(i7, serializationConstructorMarker);
        if (719 != (i7 & 719)) {
            e1.l(i7, 719, UserSelectComponent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.type = i10;
        this.id = str;
    ...
    public static /* synthetic */ UserSelectComponent copy$default(UserSelectComponent userSelectComponent, int i7, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i10, int i11, boolean z5, List list, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            i7 = userSelectComponent.type;
        }
        if ((i12 & 2) != 0) {
            str = userSelectComponent.id;
        }
        if ((i12 & 4) != 0) {
            actionComponentState = userSelectComponent.state;
        }
        if ((i12 & 8) != 0) {
            str2 = userSelectComponent.customId;
        }
        if ((i12 & 16) != 0) {
            str3 = userSelectComponent.placeholder;
        }
        if ((i12 & 32) != 0) {
            str4 = userSelectComponent.accessibilityLabel;
        }
        if ((i12 & 64) != 0) {
            i10 = userSelectComponent.minValues;
        }
        if ((i12 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_LAYOUT) != 0) {
            i11 = userSelectComponent.maxValues;
        }
        if ((i12 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_EVENT_EMITTER) != 0) {
            z5 = userSelectComponent.disabled;
        }
        if ((i12 & IntBufferBatchMountItem.INSTRUCTION_UPDATE_PADDING) != 0) {
            list = userSelectComponent.selectedOptions;
        }
        boolean z6 = z5;
        List list2 = list;
        int i13 = i10;
        ...
        String str5 = str3;
        String str6 = str4;
        return userSelectComponent.copy(i7, str, actionComponentState, str2, str5, str6, i13, i14, z6, list2);
    }

    public static final /* synthetic */ void write$Self$chat_release(UserSelectComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    @NotNull
    public final UserSelectComponent copy(int type, @NotNull String id2, @NotNull ActionComponentState state, @NotNull String customId, String placeholder, String accessibilityLabel, int minValues, int maxValues, boolean disabled, @NotNull List<SearchableSelectItem> selectedOptions) {
        Intrinsics.checkNotNullParameter(id2, "id");
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(customId, "customId");
        Intrinsics.checkNotNullParameter(selectedOptions, "selectedOptions");
        return new UserSelectComponent(type, id2, state, customId, placeholder, accessibilityLabel, minValues, maxValues, disabled, selectedOptions);
    }
    ...
    public String toString() {
        ...
        StringBuilder sbO = com.discord.chat.presentation.list.a.o("UserSelectComponent(type=", ", id=", str, i7, ", state=");
    ...
    public /* synthetic */ UserSelectComponent(int i7, String str, ActionComponentState actionComponentState, String str2, String str3, String str4, int i10, int i11, boolean z5, List list, int i12, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UserSelectComponent(int i7, @NotNull String id2, @NotNull ActionComponentState state, @NotNull String customId, String str, String str2, int i10, int i11, boolean z5, @NotNull List<SearchableSelectItem> selectedOptions) {
        super(null);
        Intrinsics.checkNotNullParameter(id2, "id");
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(customId, "customId");
