...
public final /* data */ class CheckpointCardClickable {
    ...
    public /* synthetic */ CheckpointCardClickable(int i7, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (i7 & 1)) {
            this.ariaDescription = str;
        } else {
            e1.l(i7, 1, CheckpointCardClickable$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    public static /* synthetic */ CheckpointCardClickable copy$default(CheckpointCardClickable checkpointCardClickable, String str, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof CheckpointCardClickable) && Intrinsics.areEqual(this.ariaDescription, ((CheckpointCardClickable) other).ariaDescription);
    }
    ...
    public String toString() {
        return g.e("CheckpointCardClickable(ariaDescription=", this.ariaDescription, ")");
    }
