...
public final /* data */ class ErrorMessage extends MessageBase {
    ...
    public /* synthetic */ ErrorMessage(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i7, str, str2, serializationConstructorMarker);
    }

    /* JADX INFO: renamed from: copy-ntcYbpo$default, reason: not valid java name */
    public static /* synthetic */ ErrorMessage m251copyntcYbpo$default(ErrorMessage errorMessage, String str, String str2, int i7, Object obj) {
        if ((i7 & 1) != 0) {
            str = errorMessage.id;
        }
        if ((i7 & 2) != 0) {
        ...
        return errorMessage.m253copyntcYbpo(str, str2);
    }

    public static final /* synthetic */ void write$Self$chat_release(ErrorMessage self, CompositeEncoder output, SerialDescriptor serialDesc) {
        ...
        output.q(serialDesc, 1, self.stackTrace);
    }
    ...
    public final ErrorMessage m253copyntcYbpo(@NotNull String id2, @NotNull String stackTrace) {
    ...
    public boolean equals(Object other) {
        ...
        return MessageId.m1160equalsimpl0(this.id, errorMessage.id) && Intrinsics.areEqual(this.stackTrace, errorMessage.stackTrace);
    }

    @NotNull
    /* JADX INFO: renamed from: getId-3Eiw7ao, reason: not valid java name */
    public final String m254getId3Eiw7ao() {
        return this.id;
    }
    ...
    public int hashCode() {
        return this.stackTrace.hashCode() + (MessageId.m1161hashCodeimpl(this.id) * 31);
    }

    @NotNull
    public String toString() {
        return g.f("ErrorMessage(id=", MessageId.m1163toStringimpl(this.id), ", stackTrace=", this.stackTrace, ")");
    }
    ...
    private /* synthetic */ ErrorMessage(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        super(i7, serializationConstructorMarker);
        if (3 != (i7 & 3)) {
            e1.l(i7, 3, ErrorMessage$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.id = str;
