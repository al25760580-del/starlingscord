...
public final /* data */ class BlockedGroupContent {
    ...
    public /* synthetic */ BlockedGroupContent(int i7, MessageBase messageBase, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (i7 & 1)) {
            this.message = messageBase;
        } else {
            e1.l(i7, 1, BlockedGroupContent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    public static /* synthetic */ BlockedGroupContent copy$default(BlockedGroupContent blockedGroupContent, MessageBase messageBase, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BlockedGroupContent) && Intrinsics.areEqual(this.message, ((BlockedGroupContent) other).message);
    }
    ...
    public String toString() {
        return "BlockedGroupContent(message=" + this.message + ")";
    }
