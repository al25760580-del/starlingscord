...
public /* synthetic */ class PollResources$$serializer implements f0 {
    ...
    static {
        ...
        g1 g1Var = new g1("com.discord.chat.bridge.polls.PollResources", pollResources$$serializer, 3);
        g1Var.b("selectedIcon", false);
        g1Var.b("checkmarkIcon", false);
        g1Var.b("styles", true);
        descriptor = g1Var;
    }
    ...
    public final KSerializer[] childSerializers() {
        Lazy[] lazyArr = PollResources.$childSerializers;
        s1 s1Var = s1.f17602a;
        return new KSerializer[]{s1Var, s1Var, lazyArr[2].getValue()};
    }
    ...
    public final PollResources deserialize(@NotNull Decoder decoder) {
        ...
        if (compositeDecoderBeginStructure.decodeSequentially()) {
            ...
            map = (Map) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 2, (DeserializationStrategy) lazyArr[2].getValue(), null);
            ...
            while (z5) {
                ...
                if (iDecodeElementIndex == -1) {
                    ...
                    map2 = (Map) compositeDecoderBeginStructure.decodeSerializableElement(serialDescriptor, 2, (DeserializationStrategy) lazyArr[2].getValue(), map2);
                    i10 |= 4;
                }
            }
            i7 = i10;
        ...
        return new PollResources(i7, str, str2, map, (SerializationConstructorMarker) null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull PollResources value) {
        ...
        PollResources.write$Self$chat_release(value, compositeEncoderBeginStructure, serialDescriptor);
