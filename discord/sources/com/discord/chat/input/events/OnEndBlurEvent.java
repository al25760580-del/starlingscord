...
public final /* data */ class OnEndBlurEvent implements ReactEvent {
    ...
    public /* synthetic */ OnEndBlurEvent(int i7, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (i7 & 1)) {
            this.text = str;
        } else {
            e1.l(i7, 1, OnEndBlurEvent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    public static /* synthetic */ OnEndBlurEvent copy$default(OnEndBlurEvent onEndBlurEvent, String str, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof OnEndBlurEvent) && Intrinsics.areEqual(this.text, ((OnEndBlurEvent) other).text);
    }
    ...
    public String toString() {
        return g.e("OnEndBlurEvent(text=", this.text, ")");
    }
