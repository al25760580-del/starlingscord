...
public final /* data */ class TapSummaryJumpData implements ReactEvent {
    ...
    public /* synthetic */ TapSummaryJumpData(int i7, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i7 & 7)) {
            e1.l(i7, 7, TapSummaryJumpData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.channelId = str;
        this.messageId = str2;
    ...
    public static /* synthetic */ TapSummaryJumpData copy$default(TapSummaryJumpData tapSummaryJumpData, String str, String str2, String str3, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapSummaryJumpData self, CompositeEncoder output, SerialDescriptor serialDesc) {
        output.q(serialDesc, 0, self.channelId);
        output.q(serialDesc, 1, self.messageId);
        output.q(serialDesc, 2, self.summaryId);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapSummaryJumpData)) {
            return false;
        }
        TapSummaryJumpData tapSummaryJumpData = (TapSummaryJumpData) other;
    ...
    public int hashCode() {
        return this.summaryId.hashCode() + e.d(this.channelId.hashCode() * 31, 31, this.messageId);
    }
    ...
    public String toString() {
        ...
        return a.k(e.u("TapSummaryJumpData(channelId=", str, ", messageId=", str2, ", summaryId="), this.summaryId, ")");
    }
