...
public final /* data */ class TapPollAnswer implements ReactEvent {
    ...
    public /* synthetic */ TapPollAnswer(int i7, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i7 & 7)) {
            e1.l(i7, 7, TapPollAnswer$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.channelId = str;
        this.messageId = str2;
    ...
    public static /* synthetic */ TapPollAnswer copy$default(TapPollAnswer tapPollAnswer, String str, String str2, String str3, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapPollAnswer self, CompositeEncoder output, SerialDescriptor serialDesc) {
        output.q(serialDesc, 0, self.channelId);
        output.q(serialDesc, 1, self.messageId);
        output.q(serialDesc, 2, self.answerId);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapPollAnswer)) {
            return false;
        }
        TapPollAnswer tapPollAnswer = (TapPollAnswer) other;
    ...
    public int hashCode() {
        return this.answerId.hashCode() + e.d(this.channelId.hashCode() * 31, 31, this.messageId);
    }
    ...
    public String toString() {
        ...
        return a.k(e.u("TapPollAnswer(channelId=", str, ", messageId=", str2, ", answerId="), this.answerId, ")");
    }
