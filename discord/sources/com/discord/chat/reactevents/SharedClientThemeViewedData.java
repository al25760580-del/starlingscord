...
public final /* data */ class SharedClientThemeViewedData implements ReactEvent {
    ...
    public /* synthetic */ SharedClientThemeViewedData(int i7, String str, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i7, str, serializationConstructorMarker);
    }

    /* JADX INFO: renamed from: copy-tEk1XsE$default, reason: not valid java name */
    public static /* synthetic */ SharedClientThemeViewedData m849copytEk1XsE$default(SharedClientThemeViewedData sharedClientThemeViewedData, String str, int i7, Object obj) {
        if ((i7 & 1) != 0) {
            str = sharedClientThemeViewedData.messageId;
        }
        return sharedClientThemeViewedData.m851copytEk1XsE(str);
    }

    public static final /* synthetic */ void write$Self$chat_release(SharedClientThemeViewedData self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public final SharedClientThemeViewedData m851copytEk1XsE(String messageId) {
        return new SharedClientThemeViewedData(messageId, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SharedClientThemeViewedData)) {
            return false;
        }
        String str = this.messageId;
        String str2 = ((SharedClientThemeViewedData) other).messageId;
        if (str == null) {
            if (str2 == null) {
    ...
    public final String m852getMessageIdN_6c4I0() {
        return this.messageId;
    }
    ...
    public String toString() {
        String str = this.messageId;
        return g.e("SharedClientThemeViewedData(messageId=", str == null ? "null" : MessageId.m1163toStringimpl(str), ")");
    }
    ...
    private /* synthetic */ SharedClientThemeViewedData(int i7, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if ((i7 & 1) == 0) {
            this.messageId = null;
        } else {
            this.messageId = str;
    ...
    public /* synthetic */ SharedClientThemeViewedData(String str, int i7, DefaultConstructorMarker defaultConstructorMarker) {
