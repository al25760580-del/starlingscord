...
public final /* data */ class TapAutoModerationFeedbackData implements ReactEvent {
    ...
    public /* synthetic */ TapAutoModerationFeedbackData(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i7 & 3)) {
            e1.l(i7, 3, TapAutoModerationFeedbackData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.messageId = str;
        this.channelId = str2;
    ...
    public static /* synthetic */ TapAutoModerationFeedbackData copy$default(TapAutoModerationFeedbackData tapAutoModerationFeedbackData, String str, String str2, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapAutoModerationFeedbackData self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapAutoModerationFeedbackData)) {
            return false;
        }
        TapAutoModerationFeedbackData tapAutoModerationFeedbackData = (TapAutoModerationFeedbackData) other;
    ...
    public String toString() {
        return g.f("TapAutoModerationFeedbackData(messageId=", this.messageId, ", channelId=", this.channelId, ")");
    }
