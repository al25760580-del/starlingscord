...
public final /* data */ class LongPressLinkData implements ReactEvent {
    ...
    public /* synthetic */ LongPressLinkData(int i7, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (i7 & 1)) {
            this.url = str;
        } else {
            e1.l(i7, 1, LongPressLinkData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    public static /* synthetic */ LongPressLinkData copy$default(LongPressLinkData longPressLinkData, String str, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    @NotNull
    public final LongPressLinkData copy(String url) {
        return new LongPressLinkData(url);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof LongPressLinkData) && Intrinsics.areEqual(this.url, ((LongPressLinkData) other).url);
    }
    ...
    public String toString() {
        return g.e("LongPressLinkData(url=", this.url, ")");
    }
