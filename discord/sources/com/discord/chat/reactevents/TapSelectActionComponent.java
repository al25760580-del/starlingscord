...
public final /* data */ class TapSelectActionComponent implements ReactEvent {
    ...
    public /* synthetic */ TapSelectActionComponent(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
        this(i7, str, str2, serializationConstructorMarker);
    }

    /* JADX INFO: renamed from: copy-ntcYbpo$default, reason: not valid java name */
    public static /* synthetic */ TapSelectActionComponent m903copyntcYbpo$default(TapSelectActionComponent tapSelectActionComponent, String str, String str2, int i7, Object obj) {
        if ((i7 & 1) != 0) {
        ...
        return tapSelectActionComponent.m905copyntcYbpo(str, str2);
    }

    public static final /* synthetic */ void write$Self$chat_release(TapSelectActionComponent self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public final TapSelectActionComponent m905copyntcYbpo(@NotNull String messageId, @NotNull String componentId) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapSelectActionComponent)) {
            return false;
        }
        TapSelectActionComponent tapSelectActionComponent = (TapSelectActionComponent) other;
        return MessageId.m1160equalsimpl0(this.messageId, tapSelectActionComponent.messageId) && Intrinsics.areEqual(this.componentId, tapSelectActionComponent.componentId);
    }
    ...
    public final String m906getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public String toString() {
        return g.f("TapSelectActionComponent(messageId=", MessageId.m1163toStringimpl(this.messageId), ", componentId=", this.componentId, ")");
    }
    ...
    private /* synthetic */ TapSelectActionComponent(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i7 & 3)) {
            e1.l(i7, 3, TapSelectActionComponent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.messageId = str;
