...
public /* synthetic */ class TapCommandData$$serializer implements f0 {
    ...
    static {
        ...
        g1 g1Var = new g1("com.discord.chat.reactevents.TapCommandData", tapCommandData$$serializer, 4);
    ...
    public final TapCommandData deserialize(@NotNull Decoder decoder) {
        ...
        return new TapCommandData(i7, str3, str2, str, strDecodeStringElement2, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull TapCommandData value) {
        ...
        TapCommandData.write$Self$chat_release(value, compositeEncoderBeginStructure, serialDescriptor);
