...
public final /* data */ class InitiateThreadData implements ReactEvent {
    ...
    public /* synthetic */ InitiateThreadData(int i7, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static /* synthetic */ InitiateThreadData m813copypfaIj0E$default(InitiateThreadData initiateThreadData, String str, long j, int i7, Object obj) {
        if ((i7 & 1) != 0) {
            str = initiateThreadData.messageId;
        }
        if ((i7 & 2) != 0) {
            j = initiateThreadData.channelId;
        }
        return initiateThreadData.m816copypfaIj0E(str, j);
    }

    public static final /* synthetic */ void write$Self$chat_release(InitiateThreadData self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public final InitiateThreadData m816copypfaIj0E(@NotNull String messageId, long channelId) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        return new InitiateThreadData(messageId, channelId, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof InitiateThreadData)) {
            return false;
        }
        InitiateThreadData initiateThreadData = (InitiateThreadData) other;
        return MessageId.m1160equalsimpl0(this.messageId, initiateThreadData.messageId) && ChannelId.m1134equalsimpl0(this.channelId, initiateThreadData.channelId);
    }

    /* JADX INFO: renamed from: getChannelId-o4g7jtM, reason: not valid java name */
    public final long m817getChannelIdo4g7jtM() {
        return this.channelId;
    }

    @NotNull
    /* JADX INFO: renamed from: getMessageId-3Eiw7ao, reason: not valid java name */
    public final String m818getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public String toString() {
        return g.f("InitiateThreadData(messageId=", MessageId.m1163toStringimpl(this.messageId), ", channelId=", ChannelId.m1137toStringimpl(this.channelId), ")");
    }

    public /* synthetic */ InitiateThreadData(String str, long j, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, j);
    }

    private /* synthetic */ InitiateThreadData(int i7, String str, ChannelId channelId, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i7 & 3)) {
            e1.l(i7, 3, InitiateThreadData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.messageId = str;
    ...
    private InitiateThreadData(String messageId, long j) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
