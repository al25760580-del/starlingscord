...
public final /* data */ class TapGiftCodeEmbedData implements ReactEvent {
    ...
    public /* synthetic */ TapGiftCodeEmbedData(int i7, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (i7 & 1)) {
            this.giftCode = str;
        } else {
            e1.l(i7, 1, TapGiftCodeEmbedData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    public static /* synthetic */ TapGiftCodeEmbedData copy$default(TapGiftCodeEmbedData tapGiftCodeEmbedData, String str, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TapGiftCodeEmbedData) && Intrinsics.areEqual(this.giftCode, ((TapGiftCodeEmbedData) other).giftCode);
    }
    ...
    public String toString() {
        return g.e("TapGiftCodeEmbedData(giftCode=", this.giftCode, ")");
    }
