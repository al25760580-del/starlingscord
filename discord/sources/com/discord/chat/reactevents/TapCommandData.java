...
public final /* data */ class TapCommandData implements ReactEvent {
    ...
    public /* synthetic */ TapCommandData(int i7, String str, String str2, String str3, String str4, SerializationConstructorMarker serializationConstructorMarker) {
        if (15 != (i7 & 15)) {
            e1.l(i7, 15, TapCommandData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.channelId = str;
        this.commandId = str2;
    ...
    public static /* synthetic */ TapCommandData copy$default(TapCommandData tapCommandData, String str, String str2, String str3, String str4, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapCommandData self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapCommandData)) {
            return false;
        }
        TapCommandData tapCommandData = (TapCommandData) other;
    ...
    public String toString() {
        ...
        return a.l(e.u("TapCommandData(channelId=", str, ", commandId=", str2, ", commandName="), this.commandName, ", commandKey=", this.commandKey, ")");
    }
