...
public final /* data */ class TapShareForumPost implements ReactEvent {
    ...
    public /* synthetic */ TapShareForumPost(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i7 & 3)) {
            e1.l(i7, 3, TapShareForumPost$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.channelId = str;
        this.guildId = str2;
    ...
    public static /* synthetic */ TapShareForumPost copy$default(TapShareForumPost tapShareForumPost, String str, String str2, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapShareForumPost self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapShareForumPost)) {
            return false;
        }
        TapShareForumPost tapShareForumPost = (TapShareForumPost) other;
    ...
    public int hashCode() {
        return this.guildId.hashCode() + (this.channelId.hashCode() * 31);
    }
    ...
    public String toString() {
        return g.f("TapShareForumPost(channelId=", this.channelId, ", guildId=", this.guildId, ")");
    }
