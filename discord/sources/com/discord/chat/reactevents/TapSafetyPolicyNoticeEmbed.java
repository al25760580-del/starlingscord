...
public final /* data */ class TapSafetyPolicyNoticeEmbed implements ReactEvent {
    ...
    public /* synthetic */ TapSafetyPolicyNoticeEmbed(int i7, String str, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (i7 & 1)) {
            this.classificationId = str;
        } else {
            e1.l(i7, 1, TapSafetyPolicyNoticeEmbed$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    public static /* synthetic */ TapSafetyPolicyNoticeEmbed copy$default(TapSafetyPolicyNoticeEmbed tapSafetyPolicyNoticeEmbed, String str, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof TapSafetyPolicyNoticeEmbed) && Intrinsics.areEqual(this.classificationId, ((TapSafetyPolicyNoticeEmbed) other).classificationId);
    }
    ...
    public String toString() {
        return g.e("TapSafetyPolicyNoticeEmbed(classificationId=", this.classificationId, ")");
    }
