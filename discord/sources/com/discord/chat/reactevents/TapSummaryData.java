...
public final /* data */ class TapSummaryData implements ReactEvent {
    ...
    public /* synthetic */ TapSummaryData(int i7, String str, String str2, String str3, SerializationConstructorMarker serializationConstructorMarker) {
        if (7 != (i7 & 7)) {
            e1.l(i7, 7, TapSummaryData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.channelId = str;
        this.messageId = str2;
    ...
    public static /* synthetic */ TapSummaryData copy$default(TapSummaryData tapSummaryData, String str, String str2, String str3, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapSummaryData self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapSummaryData)) {
            return false;
        }
        TapSummaryData tapSummaryData = (TapSummaryData) other;
    ...
    public String toString() {
        ...
        return a.k(e.u("TapSummaryData(channelId=", str, ", messageId=", str2, ", summaryId="), this.summaryId, ")");
    }
