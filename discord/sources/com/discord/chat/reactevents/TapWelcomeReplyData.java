...
public final /* data */ class TapWelcomeReplyData implements ReactEvent {
    ...
    public static /* synthetic */ TapWelcomeReplyData m921copyAyv7vGE$default(TapWelcomeReplyData tapWelcomeReplyData, long j, String str, int i7, Object obj) {
        if ((i7 & 1) != 0) {
        ...
        return tapWelcomeReplyData.m923copyAyv7vGE(j, str);
    }
    ...
    public final TapWelcomeReplyData m923copyAyv7vGE(long stickerId, @NotNull String messageId) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        return new TapWelcomeReplyData(stickerId, messageId, null);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapWelcomeReplyData)) {
            return false;
        }
        TapWelcomeReplyData tapWelcomeReplyData = (TapWelcomeReplyData) other;
        return this.stickerId == tapWelcomeReplyData.stickerId && MessageId.m1160equalsimpl0(this.messageId, tapWelcomeReplyData.messageId);
    }

    @NotNull
    /* JADX INFO: renamed from: getMessageId-3Eiw7ao, reason: not valid java name */
    public final String m924getMessageId3Eiw7ao() {
        return this.messageId;
    }
    ...
    public int hashCode() {
        return MessageId.m1161hashCodeimpl(this.messageId) + (Long.hashCode(this.stickerId) * 31);
    }
    ...
    public WritableMap getData() {
        return NativeMapExtensionsKt.nativeMapOf(new Pair("messageId", MessageId.m1163toStringimpl(this.messageId)), new Pair("stickerId", String.valueOf(this.stickerId)));
    }

    @NotNull
    public String toString() {
        return "TapWelcomeReplyData(stickerId=" + this.stickerId + ", messageId=" + MessageId.m1163toStringimpl(this.messageId) + ")";
    }

    private TapWelcomeReplyData(long j, String messageId) {
        Intrinsics.checkNotNullParameter(messageId, "messageId");
        this.stickerId = j;
