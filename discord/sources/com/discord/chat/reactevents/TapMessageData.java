...
public final /* data */ class TapMessageData implements ReactEvent {
    ...
    public /* synthetic */ TapMessageData(int i7, String str, String str2, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i7 & 3)) {
            e1.l(i7, 3, TapMessageData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.messageId = str;
        this.channelId = str2;
    ...
    public static /* synthetic */ TapMessageData copy$default(TapMessageData tapMessageData, String str, String str2, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public static final /* synthetic */ void write$Self$chat_release(TapMessageData self, CompositeEncoder output, SerialDescriptor serialDesc) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof TapMessageData)) {
            return false;
        }
        TapMessageData tapMessageData = (TapMessageData) other;
    ...
    public String toString() {
        return g.f("TapMessageData(messageId=", this.messageId, ", channelId=", this.channelId, ")");
    }
