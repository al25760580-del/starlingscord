...
public final /* data */ class IntervalEvent implements ReactEvent {
    ...
    public /* synthetic */ IntervalEvent(int i7, int i10, SerializationConstructorMarker serializationConstructorMarker) {
        if (1 == (i7 & 1)) {
            this.id = i10;
        } else {
            e1.l(i7, 1, IntervalEvent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
    }

    public static /* synthetic */ IntervalEvent copy$default(IntervalEvent intervalEvent, int i7, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            i7 = intervalEvent.id;
        }
        return intervalEvent.copy(i7);
    }
    ...
    @NotNull
    public final IntervalEvent copy(int id2) {
        return new IntervalEvent(id2);
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof IntervalEvent) && this.id == ((IntervalEvent) other).id;
    }
    ...
    public String toString() {
        return g.d(this.id, "IntervalEvent(id=", ")");
    }

    public IntervalEvent(int i7) {
        this.id = i7;
    }
}
