...
public /* synthetic */ class NoInputCallbackEvent$$serializer implements f0 {
    ...
    static {
        ...
        g1 g1Var = new g1("com.discord.media.engine.video.events.NoInputCallbackEvent", noInputCallbackEvent$$serializer, 1);
        g1Var.b("input", false);
        descriptor = g1Var;
    }
    ...
    public final NoInputCallbackEvent deserialize(@NotNull Decoder decoder) {
        ...
        return new NoInputCallbackEvent(i7, zDecodeBooleanElement, null);
    }
    ...
    public final void serialize(@NotNull Encoder encoder, @NotNull NoInputCallbackEvent value) {
        ...
        compositeEncoderBeginStructure.p(serialDescriptor, 0, value.input);
