...
public final class OnReadyEvent implements ReactEvent {
    ...
    public static final /* synthetic */ void write$Self$media_engine_release(OnReadyEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
    }

    public /* synthetic */ OnReadyEvent(int i7, SerializationConstructorMarker serializationConstructorMarker) {
    }
