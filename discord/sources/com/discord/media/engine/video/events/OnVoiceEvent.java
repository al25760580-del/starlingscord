...
public final /* data */ class OnVoiceEvent implements ReactEvent {
    ...
    public /* synthetic */ OnVoiceEvent(int i7, float f2, int i10, SerializationConstructorMarker serializationConstructorMarker) {
        if (3 != (i7 & 3)) {
            e1.l(i7, 3, OnVoiceEvent$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.level = f2;
        this.speaking = i10;
    ...
    public static /* synthetic */ OnVoiceEvent copy$default(OnVoiceEvent onVoiceEvent, float f2, int i7, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            f2 = onVoiceEvent.level;
        }
        if ((i10 & 2) != 0) {
            i7 = onVoiceEvent.speaking;
        }
        return onVoiceEvent.copy(f2, i7);
    }

    public static final /* synthetic */ void write$Self$media_engine_release(OnVoiceEvent self, CompositeEncoder output, SerialDescriptor serialDesc) {
        output.j(serialDesc, 0, self.level);
        output.l(1, self.speaking, serialDesc);
    }
    ...
    @NotNull
    public final OnVoiceEvent copy(float level, int speaking) {
        return new OnVoiceEvent(level, speaking);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof OnVoiceEvent)) {
            return false;
        }
        OnVoiceEvent onVoiceEvent = (OnVoiceEvent) other;
    ...
    public int hashCode() {
        return Integer.hashCode(this.speaking) + (Float.hashCode(this.level) * 31);
    }
    ...
    public String toString() {
        return "OnVoiceEvent(level=" + this.level + ", speaking=" + this.speaking + ")";
    }

    public OnVoiceEvent(float f2, int i7) {
        this.level = f2;
        this.speaking = i7;
    }
}
