...
public final /* data */ class UserSearchQueryClearData extends UserSearchData {
    ...
    public /* synthetic */ UserSearchQueryClearData(int i7, String str, SerializationConstructorMarker serializationConstructorMarker) {
        super(null);
        if (1 != (i7 & 1)) {
            e1.l(i7, 1, UserSearchQueryClearData$$serializer.INSTANCE.getDescriptor());
            throw null;
        }
        this.uuid = str;
    }

    public static /* synthetic */ UserSearchQueryClearData copy$default(UserSearchQueryClearData userSearchQueryClearData, String str, int i7, Object obj) {
        if ((i7 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof UserSearchQueryClearData) && Intrinsics.areEqual(this.uuid, ((UserSearchQueryClearData) other).uuid);
    }
    ...
    public String toString() {
        return g.e("UserSearchQueryClearData(uuid=", this.uuid, ")");
    }
