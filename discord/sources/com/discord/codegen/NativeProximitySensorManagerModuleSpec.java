...
public abstract class NativeProximitySensorManagerModuleSpec extends ReactContextBaseJavaModule implements TurboModule {
    ...
    public NativeProximitySensorManagerModuleSpec(ReactApplicationContext reactApplicationContext) {
    ...
    @a
    @ReactMethod
    public abstract void setProximityMonitoringEnabled(boolean z5);
}
