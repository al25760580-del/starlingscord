...
@Metadata(d1 = {"\u0000~\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\b\u0001\u0018\u00002\u00020\u0001B1\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004\u0012\u0006\u0010\u0007\u001a\u00020\u0006\u0012\u0006\u0010\t\u001a\u00020\b\u0012\u0006\u0010\u000b\u001a\u00020\n¢\u0006\u0004\b\f\u0010\rJ\u001b\u0010\u0012\u001a\u00020\u0011*\u00020\u000e2\u0006\u0010\u0010\u001a\u00020\u000fH\u0002¢\u0006\u0004\b\u0012\u0010\u0013J\u0017\u0010\u0017\u001a\u00020\u00162\u0006\u0010\u0015\u001a\u00020\u0014H\u0017¢\u0006\u0004\b\u0017\u0010\u0018J\u000f\u0010\u0019\u001a\u00020\u0016H\u0016¢\u0006\u0004\b\u0019\u0010\u001aJ\u000f\u0010\u001c\u001a\u00020\u001bH\u0016¢\u0006\u0004\b\u001c\u0010\u001dJ\u000f\u0010\u001e\u001a\u00020\u0016H\u0016¢\u0006\u0004\b\u001e\u0010\u001aJ\u000f\u0010\u001f\u001a\u00020\u0016H\u0016¢\u0006\u0004\b\u001f\u0010\u001aR\u0016\u0010\u0005\u001a\u0004\u0018\u00010\u00048\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0005\u0010 R\u0014\u0010\u0007\u001a\u00020\u00068\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0007\u0010!R\u0014\u0010\t\u001a\u00020\b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\t\u0010\"R\u0014\u0010\u000b\u001a\u00020\n8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000b\u0010#R\u0014\u0010%\u001a\u00020$8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b%\u0010&R\u0014\u0010(\u001a\u00020'8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b(\u0010)R\u001b\u0010.\u001a\u00020\u000e8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b*\u0010+\u001a\u0004\b,\u0010-R\u0014\u0010/\u001a\u00020\u000e8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b/\u00100R\u001b\u00105\u001a\u0002018BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b2\u0010+\u001a\u0004\b3\u00104R\u001b\u0010:\u001a\u0002068BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b7\u0010+\u001a\u0004\b8\u00109R\u0014\u0010\u001c\u001a\u00020;8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u001c\u0010<R\u001b\u0010A\u001a\u00020=8BX\u0082\u0084\u0002¢\u0006\f\n\u0004\b>\u0010+\u001a\u0004\b?\u0010@R\u0014\u0010B\u001a\u00020;8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\bB\u0010<R\u0014\u0010C\u001a\u00020;8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\bC\u0010<¨\u0006D"}, d2 = {"Lio/sentry/android/replay/screenshot/PixelCopyStrategy;", "Lio/sentry/android/replay/screenshot/ScreenshotStrategy;", "Lio/sentry/android/replay/ExecutorProvider;", "executorProvider", "Lio/sentry/android/replay/ScreenshotRecorderCallback;", "screenshotRecorderCallback", "Lio/sentry/w5;", "options", "Lio/sentry/android/replay/ScreenshotRecorderConfig;", "config", "Lio/sentry/android/replay/util/DebugOverlayDrawable;", "debugOverlayDrawable", "<init>", "(Lio/sentry/android/replay/ExecutorProvider;Lio/sentry/android/replay/ScreenshotRecorderCallback;Lio/sentry/w5;Lio/sentry/android/replay/ScreenshotRecorderConfig;Lio/sentry/android/replay/util/DebugOverlayDrawable;)V", "Landroid/graphics/Bitmap;", "Landroid/graphics/Rect;", "rect", "", "dominantColorForRect", "(Landroid/graphics/Bitmap;Landroid/graphics/Rect;)I", "Landroid/view/View;", "root", "", "capture", "(Landroid/view/View;)V", "onContentChanged", "()V", "", "lastCaptureSuccessful", "()Z", "emitLastScreenshot", "close", "Lio/sentry/android/replay/ScreenshotRecorderCallback;", "Lio/sentry/w5;", "Lio/sentry/android/replay/ScreenshotRecorderConfig;", "Lio/sentry/android/replay/util/DebugOverlayDrawable;", "Ljava/util/concurrent/ScheduledExecutorService;", "executor", "Ljava/util/concurrent/ScheduledExecutorService;", "Lio/sentry/android/replay/util/MainLooperHandler;", "mainLooperHandler", "Lio/sentry/android/replay/util/MainLooperHandler;", "singlePixelBitmap$delegate", "Lkotlin/Lazy;", "getSinglePixelBitmap", "()Landroid/graphics/Bitmap;", "singlePixelBitmap", "screenshot", "Landroid/graphics/Bitmap;", "Landroid/graphics/Canvas;", "singlePixelBitmapCanvas$delegate", "getSinglePixelBitmapCanvas", "()Landroid/graphics/Canvas;", "singlePixelBitmapCanvas", "Landroid/graphics/Matrix;", "prescaledMatrix$delegate", "getPrescaledMatrix", "()Landroid/graphics/Matrix;", "prescaledMatrix", "Ljava/util/concurrent/atomic/AtomicBoolean;", "Ljava/util/concurrent/atomic/AtomicBoolean;", "Landroid/graphics/Paint;", "maskingPaint$delegate", "getMaskingPaint", "()Landroid/graphics/Paint;", "maskingPaint", "contentChanged", "isClosed", "sentry-android-replay_release"}, k = 1, mv = {1, 9, 0}, xi = 48)
@SuppressLint({"UseKtx"})
public final class PixelCopyStrategy implements ScreenshotStrategy {
    ...
    public PixelCopyStrategy(@NotNull ExecutorProvider executorProvider, ScreenshotRecorderCallback screenshotRecorderCallback, @NotNull w5 options, @NotNull ScreenshotRecorderConfig config, @NotNull DebugOverlayDrawable debugOverlayDrawable) {
        ...
        m mVar = m.f19487i;
        this.singlePixelBitmap = l.a(mVar, new Function0<Bitmap>() { // from class: io.sentry.android.replay.screenshot.PixelCopyStrategy$singlePixelBitmap$2
        ...
        this.singlePixelBitmapCanvas = l.a(mVar, new Function0<Canvas>() { // from class: io.sentry.android.replay.screenshot.PixelCopyStrategy$singlePixelBitmapCanvas$2
            {
                super(0);
            }
        ...
        this.prescaledMatrix = l.a(mVar, new Function0<Matrix>() { // from class: io.sentry.android.replay.screenshot.PixelCopyStrategy$prescaledMatrix$2
            {
                super(0);
            }
        ...
        this.maskingPaint = l.a(mVar, new Function0<Paint>() { // from class: io.sentry.android.replay.screenshot.PixelCopyStrategy$maskingPaint$2
            @Override // kotlin.jvm.functions.Function0
    ...
    public static final void capture$lambda$2(PixelCopyStrategy pixelCopyStrategy, View view, int i7) {
        if (pixelCopyStrategy.isClosed.get()) {
            pixelCopyStrategy.options.getLogger().q(SentryLevel.DEBUG, "PixelCopyStrategy is closed, ignoring capture result", new Object[0]);
            return;
        }
        if (i7 != 0) {
            pixelCopyStrategy.options.getLogger().q(SentryLevel.INFO, "Failed to capture replay recording: %d", Integer.valueOf(i7));
            pixelCopyStrategy.lastCaptureSuccessful.set(false);
        } else if (pixelCopyStrategy.contentChanged.get()) {
            pixelCopyStrategy.options.getLogger().q(SentryLevel.INFO, "Failed to determine view hierarchy, not capturing", new Object[0]);
            pixelCopyStrategy.lastCaptureSuccessful.set(false);
        } else {
            ViewHierarchyNode viewHierarchyNodeFromView = ViewHierarchyNode.INSTANCE.fromView(view, null, 0, pixelCopyStrategy.options);
            ViewsKt.traverse(view, viewHierarchyNodeFromView, pixelCopyStrategy.options);
            pixelCopyStrategy.executor.submit(new ReplayRunnable("screenshot_recorder.mask", new ac.a(pixelCopyStrategy, viewHierarchyNodeFromView, view, 20)));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void capture$lambda$2$lambda$1(final PixelCopyStrategy pixelCopyStrategy, ViewHierarchyNode viewHierarchyNode, View view) {
        if (pixelCopyStrategy.isClosed.get() || pixelCopyStrategy.screenshot.isRecycled()) {
            pixelCopyStrategy.options.getLogger().q(SentryLevel.DEBUG, "PixelCopyStrategy is closed, skipping masking", new Object[0]);
            return;
        }
            ...
            public final Boolean invoke(ViewHierarchyNode node) {
                ...
                if (node.getShouldMask() && node.getWidth() > 0 && node.getHeight() > 0) {
                    ...
                    if (node instanceof ViewHierarchyNode.ImageViewHierarchyNode) {
                        List listC = c0.c(node.getVisibleRect());
                        PixelCopyStrategy pixelCopyStrategy2 = this.this$0;
                        pair = new Pair(listC, Integer.valueOf(pixelCopyStrategy2.dominantColorForRect(pixelCopyStrategy2.screenshot, node.getVisibleRect())));
                    } else {
                        if (node instanceof ViewHierarchyNode.TextViewHierarchyNode) {
                            ...
                            pair = new Pair(c0.c(node.getVisibleRect()), -16777216);
                        }
                    }
                    List list = (List) pair.f14612d;
                    this.this$0.getMaskingPaint().setColor(((Number) pair.f14613e).intValue());
                    Canvas canvas2 = canvas;
                    PixelCopyStrategy pixelCopyStrategy3 = this.this$0;
                    Iterator it = list.iterator();
                    while (it.hasNext()) {
                        canvas2.drawRoundRect(new RectF((Rect) it.next()), 10.0f, 10.0f, pixelCopyStrategy3.getMaskingPaint());
                    }
                    if (this.this$0.options.getReplayController().getDebugMaskingEnabled()) {
        ...
        if (pixelCopyStrategy.options.getReplayController().getDebugMaskingEnabled()) {
            pixelCopyStrategy.mainLooperHandler.post(new ac.a(pixelCopyStrategy, view, arrayList, 21));
        }
    ...
    public void capture(@NotNull View root) {
        ...
        if (this.isClosed.get()) {
            this.options.getLogger().q(SentryLevel.DEBUG, "PixelCopyStrategy is closed, not capturing screenshot", new Object[0]);
            return;
        }
        try {
            this.contentChanged.set(false);
            PixelCopy.request(phoneWindow, this.screenshot, new j(1, this, root), this.mainLooperHandler.getHandler());
        } catch (Throwable th2) {
    ...
    public void close() {
        ...
        this.executor.submit(new ReplayRunnable("PixelCopyStrategy.close", new p(6, this)));
    }
