...
public final class RNSentryMapConverter {
    ...
    private static final ILogger logger = new m0(NAME);
    ...
    private static void addValueToWritableArray(WritableArray writableArray, Object obj) {
        ...
        logger.q(SentryLevel.ERROR, "Could not convert object: " + obj, new Object[0]);
    }
    ...
    public static Object convertToWritable(Object obj) {
        ...
        if (obj instanceof Map) {
            ...
            for (Map.Entry entry : ((Map) obj).entrySet()) {
                ...
                if (key instanceof String) {
                    ...
                    logger.q(SentryLevel.ERROR, "Only String keys are supported in Map.", key);
                }
            }
        ...
        logger.q(SentryLevel.ERROR, "Supplied serialized value could not be converted." + obj, new Object[0]);
        return null;
    }
}
