...
@Deprecated
@d
public abstract class FunctionImpl implements Function, Serializable, Function0, Function1, Function2, Function3, Function4, Function5, Function6, n, Function8, o, a, b, c, go.d, e, f, g, h, i, j, k, l, m {
    private void checkArity(int i7) {
        if (getArity() != i7) {
            throwWrongArity(i7);
        }
    }

    private void throwWrongArity(int i7) {
        StringBuilder sbS = a3.e.s(i7, "Wrong function arity, expected: ", ", actual: ");
        sbS.append(getArity());
